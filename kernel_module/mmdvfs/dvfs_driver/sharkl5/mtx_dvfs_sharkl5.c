...
{
	{0, REG_MM_DVFS_AHB_MM_MTX_INDEX0_MAP,	VOLT70,   MTX_CLK768,	MTX_CLK_INDEX_768,   0, 0, 0,	0},
	{1, REG_MM_DVFS_AHB_MM_MTX_INDEX1_MAP,	VOLT70,   MTX_CLK1280,	MTX_CLK_INDEX_1280, 0, 0, 0,	0},
	{2, REG_MM_DVFS_AHB_MM_MTX_INDEX2_MAP,	VOLT70,   MTX_CLK2560,	MTX_CLK_INDEX_2560, 0, 0, 0,	0},
	{3, REG_MM_DVFS_AHB_MM_MTX_INDEX3_MAP,	VOLT70,   MTX_CLK3072,	MTX_CLK_INDEX_3072, 0, 0, 0,	0},
	{4, REG_MM_DVFS_AHB_MM_MTX_INDEX4_MAP,	VOLT75,   MTX_CLK3840,	MTX_CLK_INDEX_3840, 0, 0, 0,	0},
	{5, REG_MM_DVFS_AHB_MM_MTX_INDEX5_MAP,	VOLT75,   MTX_CLK4680,	MTX_CLK_INDEX_4680, 0, 0, 0,	0},
	{6, REG_MM_DVFS_AHB_MM_MTX_INDEX6_MAP,	VOLT80,   MTX_CLK4680,	MTX_CLK_INDEX_4680, 0, 0, 0,	0},
	{7, REG_MM_DVFS_AHB_MM_MTX_INDEX7_MAP,	VOLT80,   MTX_CLK4680,	MTX_CLK_INDEX_4680, 0, 0, 0,	0},
};
...
static int  set_ip_dvfs_table(struct devfreq *devfreq,
		struct ip_dvfs_map_cfg *dvfs_table)
{
	memcpy(mtx_dvfs_config_table, dvfs_table, sizeof(struct
		ip_dvfs_map_cfg));
	pr_info("dvfs ops: %s\n", __func__);
	return 1;
}
	...
	ip_status)
{
	...
	ip_status->current_sys_volt = ((volt_reg >> SHFT_BITS_MM_MTX_VOLTAGE)
					& MASK_BITS_MM_MTX_VOLTAGE);
	...
	unsigned long freq, unsigned int eb_sysgov)
{
	...
	/*debug interface */
static  int set_fix_dvfs_value(struct devfreq *devfreq,
