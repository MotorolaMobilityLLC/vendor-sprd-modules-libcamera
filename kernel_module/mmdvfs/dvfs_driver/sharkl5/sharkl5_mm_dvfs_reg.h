...
#define BITS_MM_DVFS_UP_WINDOW(_X_)     ((_X_) << 10 & (BIT(10)|BIT(11)| \
BIT(12)|BIT(13)|BIT(14)|BIT(15)|BIT(16)|BIT(17)|BIT(18)|BIT(19)))
...
#define BITS_DCAM_IF_VOTE_AXI_INDEX0(_X_)    ((_X_) << 13 & \
    (BIT(13)|BIT(14)|BIT(15)))
#define BITS_DCAM_IF_VOL_INDEX0(_X_)    ((_X_) << 10 & \
(BIT(10)|BIT(11)|BIT(12)))
#define BITS_CGM_DCAM_IF_FDIV_DENOM_INDEX0(_X_) ((_X_) << 6  & \
(BIT(6)|BIT(7)|BIT(8)|BIT(9)))
#define BITS_CGM_DCAM_IF_FDIV_NUM_INDEX0(_X_) ((_X_) << 2  & \
...
#define BITS_DCAM_IF_VOL_INDEX1(_X_)    ((_X_) << 10 & \
(BIT(10)|BIT(11)|BIT(12)))
#define BITS_CGM_DCAM_IF_FDIV_DENOM_INDEX1(_X_) ((_X_) << 6  & \
(BIT(6)|BIT(7)|BIT(8)|BIT(9)))
#define BITS_CGM_DCAM_IF_FDIV_NUM_INDEX1(_X_) ((_X_) << 2  & \
(BIT(2)|BIT(3)|BIT(4)|BIT(5)))
#define BITS_CGM_DCAM_IF_SEL_INDEX1(_X_) ((_X_) << 0  & (BIT(0)|BIT(1)))

/* REG_MM_DVFS_AHB_DCAM_IF_INDEX2_MAP, 0x62600118 */
#define BITS_DCAM_IF_VOL_INDEX2(_X_)    ((_X_) << 10 & \
(BIT(10)|BIT(11)|BIT(12)))
#define BITS_CGM_DCAM_IF_FDIV_DENOM_INDEX2(_X_) ((_X_) << 6  & \
(BIT(6)|BIT(7)|BIT(8)|BIT(9)))
#define BITS_CGM_DCAM_IF_FDIV_NUM_INDEX2(_X_) ((_X_) << 2  & \
(BIT(2)|BIT(3)|BIT(4)|BIT(5)))
#define BITS_CGM_DCAM_IF_SEL_INDEX2(_X_) ((_X_) << 0  & (BIT(0)|BIT(1)))

/*  REG_MM_DVFS_AHB_DCAM_IF_INDEX3_MAP, 0x6260011C */
#define BITS_DCAM_IF_VOL_INDEX3(_X_)    ((_X_) << 10 & \
(BIT(10)|BIT(11)|BIT(12)))
#define BITS_CGM_DCAM_IF_FDIV_DENOM_INDEX3(_X_) ((_X_) << 6  & \
(BIT(6)|BIT(7)|BIT(8)|BIT(9)))
#define BITS_CGM_DCAM_IF_FDIV_NUM_INDEX3(_X_) ((_X_) << 2  & \
(BIT(2)|BIT(3)|BIT(4)|BIT(5)))
#define BITS_CGM_DCAM_IF_SEL_INDEX3(_X_) ((_X_) << 0  & \
(BIT(0)|BIT(1)))

/* REG_MM_DVFS_AHB_DCAM_IF_INDEX4_MAP, 0x62600120 */
#define BITS_DCAM_IF_VOL_INDEX4(_X_)    ((_X_) << 10 & \
(BIT(10)|BIT(11)|BIT(12)))
#define BITS_CGM_DCAM_IF_FDIV_DENOM_INDEX4(_X_) ((_X_) << 6  & \
(BIT(6)|BIT(7)|BIT(8)|BIT(9)))
#define BITS_CGM_DCAM_IF_FDIV_NUM_INDEX4(_X_) ((_X_) << 2  & \
(BIT(2)|BIT(3)|BIT(4)|BIT(5)))
#define BITS_CGM_DCAM_IF_SEL_INDEX4(_X_) ((_X_) << 0  & \
(BIT(0)|BIT(1)))

/*REG_MM_DVFS_AHB_DCAM_IF_INDEX5_MAP, 0x62600124 */
#define BITS_DCAM_IF_VOL_INDEX5(_X_)    ((_X_) << 10 & \
(BIT(10)|BIT(11)|BIT(12)))
#define BITS_CGM_DCAM_IF_FDIV_DENOM_INDEX5(_X_) ((_X_) << 6  & \
(BIT(6)|BIT(7)|BIT(8)|BIT(9)))
#define BITS_CGM_DCAM_IF_FDIV_NUM_INDEX5(_X_) ((_X_) << 2  & \
(BIT(2)|BIT(3)|BIT(4)|BIT(5)))
#define BITS_CGM_DCAM_IF_SEL_INDEX5(_X_) ((_X_) << 0  & (BIT(0)|BIT(1)))

/*REG_MM_DVFS_AHB_DCAM_IF_INDEX6_MAP, 0x62600128 */
#define BITS_DCAM_IF_VOL_INDEX6(_X_)    ((_X_) << 10 & \
(BIT(10)|BIT(11)|BIT(12)))
#define BITS_CGM_DCAM_IF_FDIV_DENOM_INDEX6(_X_) ((_X_) << 6  & \
(BIT(6)|BIT(7)|BIT(8)|BIT(9)))
#define BITS_CGM_DCAM_IF_FDIV_NUM_INDEX6(_X_) ((_X_) << 2  & \
(BIT(2)|BIT(3)|BIT(4)|BIT(5)))
#define BITS_CGM_DCAM_IF_SEL_INDEX6(_X_) ((_X_) << 0  & (BIT(0)|BIT(1)))

/* REG_MM_DVFS_AHB_DCAM_IF_INDEX7_MAP, 0x6260012C */
#define BITS_DCAM_IF_VOL_INDEX7(_X_)    ((_X_) << 10 & \
(BIT(10)|BIT(11)|BIT(12)))
#define BITS_CGM_DCAM_IF_FDIV_DENOM_INDEX7(_X_) ((_X_) << 6  & \
(BIT(6)|BIT(7)|BIT(8)|BIT(9)))
#define BITS_CGM_DCAM_IF_FDIV_NUM_INDEX7(_X_) ((_X_) << 2  & \
(BIT(2)|BIT(3)|BIT(4)|BIT(5)))
