...
typedef enum
{
	...
	JPG_CLK_INDEX_1920 = 2, //256
	JPG_CLK_INDEX_2560 = 3, //256
} jpg_clock_level;
...
typedef enum
{
	DCAM_CLK_INDEX_1920 = 0, //384
	DCAM_CLK_INDEX_2560 , //468
	DCAM_CLK_INDEX_3072 , //384
	DCAM_CLK_INDEX_3840 , //468
} dcam_clock_level;


typedef enum
{
	DCAMAXI_CLK_INDEX_1920 = 0, //76.8
	DCAMAXI_CLK_INDEX_2560 = 1, //307.2
	DCAMAXI_CLK_INDEX_3072 = 2, //384
	DCAMAXI_CLK_INDEX_3840 = 3, //384
} dcamaxi_clock_level;
