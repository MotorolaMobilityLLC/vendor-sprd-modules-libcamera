...
{
	{0, REG_MM_DVFS_AHB_DCAM_IF_INDEX0_MAP,	VOLT70,   DCAM_CLK1920,	DCAM_CLK_INDEX_1920, 	0, 0,	DCAMAXI_CLK_INDEX_2560, 0	},
	{1, REG_MM_DVFS_AHB_DCAM_IF_INDEX1_MAP,	VOLT70,   DCAM_CLK1920,	DCAM_CLK_INDEX_1920,	0, 0, 	DCAMAXI_CLK_INDEX_2560, 0	},
	{2, REG_MM_DVFS_AHB_DCAM_IF_INDEX2_MAP,	VOLT70,   DCAM_CLK2560,	DCAM_CLK_INDEX_2560,	0, 0, 	DCAMAXI_CLK_INDEX_3072, 0	},
	{3, REG_MM_DVFS_AHB_DCAM_IF_INDEX3_MAP,	VOLT70,   DCAM_CLK2560,	DCAM_CLK_INDEX_2560,	0, 0,   DCAMAXI_CLK_INDEX_3072, 0	},
	{4, REG_MM_DVFS_AHB_DCAM_IF_INDEX4_MAP,	VOLT70,   DCAM_CLK3072,	DCAM_CLK_INDEX_3072,	0, 0, 	DCAMAXI_CLK_INDEX_3072, 0	},
	{5, REG_MM_DVFS_AHB_DCAM_IF_INDEX5_MAP,	VOLT70,   DCAM_CLK3072,	DCAM_CLK_INDEX_3072,	0, 0, 	DCAMAXI_CLK_INDEX_3072, 0	},
	{6, REG_MM_DVFS_AHB_DCAM_IF_INDEX6_MAP,	VOLT75,   DCAM_CLK3840,	DCAM_CLK_INDEX_3840,	0, 0,	DCAMAXI_CLK_INDEX_3840, 0	},
	{7, REG_MM_DVFS_AHB_DCAM_IF_INDEX7_MAP,	VOLT80,   DCAM_CLK4680,	DCAM_CLK_INDEX_4680,	0, 0, 	DCAMAXI_CLK_INDEX_4680, 0	},
};
...
static int  set_ip_dvfs_table(struct devfreq *devfreq,
		struct ip_dvfs_map_cfg  *dvfs_table)
{
		memcpy(dcam_dvfs_config_table, dvfs_table, sizeof(struct
			ip_dvfs_map_cfg));
	pr_info("dvfs ops: %s\n", __func__);
	return 1;
}
...
static int  set_work_freq(struct devfreq *devfreq, unsigned long work_freq)
{
	...
	get_ip_index_from_table(dcam_dvfs_config_table,  work_freq, &
		index);
...
static int  set_idle_freq(struct devfreq *devfreq, unsigned long  idle_freq)
{
	...
	get_ip_index_from_table(dcam_dvfs_config_table,  idle_freq, &
		index);
	...
	struct ip_dvfs_status *ip_status)
{
	...
	for (i = 0; i < 8; i++){
		...
		ip_status->current_sys_volt = ((volt_reg >>
			SHFT_BITS_DCAM_IF_VOLTAGE)
					& MASK_BITS_DCAM_IF_VOLTAGE);
	pr_info("dvfs ops: %s\n", __func__);
	return 1;
}
...
static void dcam_dvfs_map_cfg(void)
{
	...
	{  
		...
		BITS_CGM_DCAM_IF_FDIV_DENOM_INDEX0(dcam_dvfs_config_table[i].fdiv_denom) |     \
		BITS_CGM_DCAM_IF_FDIV_NUM_INDEX0(dcam_dvfs_config_table[i].fdiv_num) |     \
