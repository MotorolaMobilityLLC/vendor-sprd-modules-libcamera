...
{
	{	0, REG_MM_DVFS_AHB_CPP_INDEX0_MAP,	VOLT70,   CPP_CLK768,	CPP_CLK_INDEX_768,	0, 0, 0,	MTX_CLK_INDEX_768	},
	{	1, REG_MM_DVFS_AHB_CPP_INDEX1_MAP,	VOLT70,   CPP_CLK1280,	CPP_CLK_INDEX_1280,	0, 0, 0,	MTX_CLK_INDEX_1280	},
	{	2, REG_MM_DVFS_AHB_CPP_INDEX2_MAP,	VOLT70,   CPP_CLK2560,	CPP_CLK_INDEX_2560,	0, 0, 0,	MTX_CLK_INDEX_2560	},
	{	3, REG_MM_DVFS_AHB_CPP_INDEX3_MAP,	VOLT75,   CPP_CLK3840,	CPP_CLK_INDEX_3072,	0, 0, 0,	MTX_CLK_INDEX_3840	},
	{	4, REG_MM_DVFS_AHB_CPP_INDEX4_MAP,	VOLT75,   CPP_CLK3840,	CPP_CLK_INDEX_3072,	0, 0, 0,	MTX_CLK_INDEX_4680	},
	{	5, REG_MM_DVFS_AHB_CPP_INDEX5_MAP,	VOLT80,   CPP_CLK3840,	CPP_CLK_INDEX_3072,	0, 0, 0,	MTX_CLK_INDEX_5120	},
	{	6, REG_MM_DVFS_AHB_CPP_INDEX6_MAP,	VOLT80,   CPP_CLK3840,	CPP_CLK_INDEX_3072,	0, 0, 0,	MTX_CLK_INDEX_5120	},
	{	7, REG_MM_DVFS_AHB_CPP_INDEX7_MAP,	VOLT80,   CPP_CLK3840,	CPP_CLK_INDEX_3072,	0, 0, 0,	MTX_CLK_INDEX_5120	},
...
static int  set_ip_dvfs_table(struct devfreq *devfreq,
		struct ip_dvfs_map_cfg *dvfs_table)
{
	memcpy(cpp_dvfs_config_table, dvfs_table, sizeof(struct
		ip_dvfs_map_cfg));
	pr_info("dvfs ops: %s\n", __func__);
	return 1;
}
	...
	ip_status)
{
	...
	ip_status->current_ip_clk = (clk_reg >>SHFT_BITS_CGM_CPP_SEL_DVFS) &
...
static int  ip_dvfs_init(struct devfreq *devfreq)
{
	...
	pr_info("dvfs : cpp %d\n", CPP_FREQ_UPD_EN_BYP);
	pr_info("dvfs : cpp %d\n", CPP_FREQ_UPD_DELAY_EN);
	pr_info("dvfs : cpp %d\n", CPP_FREQ_UPD_HDSK_EN);
	pr_info("dvfs : cpp %d\n", CPP_GFREE_WAIT_DELAY);
	pr_info("dvfs : cpp %d\n", CPP_SW_TRIG_EN);
	pr_info("dvfs : cpp %d\n", CPP_WORK_INDEX_DEF);
	pr_info("dvfs : cpp %d\n", CPP_IDLE_INDEX_DEF);
	pr_info("dvfs : cpp %d\n", CPP_AUTO_TUNE);
...
#if 0
	set_ip_freq_upd_en_byp(cpp->cpp_dvfs_para.ip_coffe.freq_upd_en_byp);
	set_ip_freq_upd_delay_en(cpp->cpp_dvfs_para.ip_coffe.freq_upd_delay_en);
	set_ip_freq_upd_hdsk_en(cpp->cpp_dvfs_para.ip_coffe.freq_upd_hdsk_en);
	set_ip_gfree_wait_delay(cpp->cpp_dvfs_para.ip_coffe.gfree_wait_delay);
	set_ip_dvfs_swtrig_en(cpp->cpp_dvfs_para.ip_coffe.sw_trig_en);
#else
	cpp->cpp_dvfs_para.ip_coffe.idle_index_def =0;  
