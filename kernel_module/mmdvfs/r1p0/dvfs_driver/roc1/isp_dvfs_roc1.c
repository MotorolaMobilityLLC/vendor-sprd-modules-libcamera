...
struct ip_dvfs_map_cfg  isp_dvfs_config_table[] =
	{
	{0, REG_MM_DVFS_AHB_ISP_INDEX0_MAP,	VOLT70,   ISP_CLK2560, ISP_CLK_INDEX_2560, 	0, 0, 0,	MTX_CLK_INDEX_2560},
	{1, REG_MM_DVFS_AHB_ISP_INDEX1_MAP,	VOLT70,   ISP_CLK3072, ISP_CLK_INDEX_3072, 	0, 0, 0,	MTX_CLK_INDEX_3072},
	{2, REG_MM_DVFS_AHB_ISP_INDEX2_MAP,	VOLT75,   ISP_CLK3840, ISP_CLK_INDEX_3840, 	0, 0, 0,	MTX_CLK_INDEX_3840},
	{3, REG_MM_DVFS_AHB_ISP_INDEX3_MAP,	VOLT75,   ISP_CLK4680, ISP_CLK_INDEX_4680, 	0, 0, 0,	MTX_CLK_INDEX_4680},
	{4, REG_MM_DVFS_AHB_ISP_INDEX4_MAP,	VOLT80,   ISP_CLK5120, ISP_CLK_INDEX_5120, 	0, 0, 0,	MTX_CLK_INDEX_5120},
	{5, REG_MM_DVFS_AHB_ISP_INDEX5_MAP,	VOLT80,   ISP_CLK5120, ISP_CLK_INDEX_5120, 	0, 0, 0,	MTX_CLK_INDEX_5120},
	{6, REG_MM_DVFS_AHB_ISP_INDEX6_MAP,	VOLT80,   ISP_CLK5120, ISP_CLK_INDEX_5120, 	0, 0, 0,	MTX_CLK_INDEX_5120},
	{7, REG_MM_DVFS_AHB_ISP_INDEX7_MAP,	VOLT80,   ISP_CLK5120, ISP_CLK_INDEX_5120, 	0, 0, 0,	MTX_CLK_INDEX_5120},
};
...
static int  set_ip_dvfs_table(struct devfreq *devfreq,
		struct ip_dvfs_map_cfg *dvfs_table)
{
	memcpy(isp_dvfs_config_table, dvfs_table, sizeof(struct
		ip_dvfs_map_cfg));
	pr_info("dvfs ops: %s\n", __func__);
	return 1;
}
	...
	ip_status)
{
	...
	clk_reg = DVFS_REG_RD(REG_MM_DVFS_AHB_MM_DVFS_CGM_CFG_DBG);
		...
		ip_status->current_ip_clk = (clk_reg >>
			SHFT_BITS_CGM_ISP_SEL_DVFS) &
			MASK_BITS_CGM_ISP_SEL_DVFS;
