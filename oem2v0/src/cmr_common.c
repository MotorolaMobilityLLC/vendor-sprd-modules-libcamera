...
cmr_int camera_save_yuv_to_file(cmr_u32 index, cmr_u32 img_fmt,
...
cmr_int camera_save_jpg_to_file(cmr_u32 index, cmr_u32 img_fmt,
				       cmr_u32 width, cmr_u32 height,
...
void camera_snapshot_step_statisic(struct img_size *image_size)
{
	...
	ALOGI("*********************Take picture statistic*******Start****%4d*%4d*****",
		  image_size->width,
		  image_size->height);
	...
	ALOGI("*********************Take picture statistic********End*******************");
}
