...
cmr_int camera_init(cmr_u32 camera_id, camera_cb_of_type callback, void *client_data,
		cmr_uint is_autotest, cmr_handle *camera_handle,
...

{
	...
	ret = camera_local_redisplay_data(camera_handle, output_fd, output_addr, output_width, output_height,
		                              input_fd, input_addr_y, input_addr_uv, input_width, input_height);
	if (ret) {
...
cmr_int camera_set_preview_buffer(cmr_handle camera_handle, cmr_uint src_phy_addr, cmr_uint src_vir_addr, cmr_s32 fd)
{
	...
	ret = camera_local_set_preview_buffer(camera_handle, src_phy_addr, src_vir_addr, fd);
	if (ret) {
		CMR_LOGE("failed %ld", ret);
	}
exit:
...
//       camera_safe_scale_th,
	...
	camera_get_sn_trim,
	camera_set_mem_func,
	camera_get_redisplay_data,
	camera_is_change_size,
	camera_pre_capture_get_buffer_id,
	camera_get_reserve_buffer_size,
	camera_pre_capture_get_buffer_size,
	camera_get_preview_rect,
	camera_get_zsl_capability,
	//camera_get_sensor_info_for_raw,
	NULL,
	camera_get_sensor_trim,
	//camera_get_sensor_trim2
	NULL,
	camera_get_preview_rot_angle,
	camera_fd_enable,
	camera_flip_enable,
	camera_fd_start,
	camera_is_need_stop_preview,
	camera_takepicture_process,
	camera_get_size_align_page,
	camera_fast_ctrl,
	...
	camera_set_zsl_buffer,
	camera_set_video_snapshot_buffer,
	camera_set_zsl_snapshot_buffer,
	camera_zsl_snapshot_need_pause,
	camera_get_isp_handle,
	camera_lls_enable,
	camera_is_lls_enabled,
	camera_vendor_hdr_enable,
	camera_is_vendor_hdr,
	camera_set_lls_shot_mode,
	camera_get_lls_shot_mode,
	camera_get_isp_info,
	camera_start_burst_notice,
	camera_end_burst_notice,
	camera_transfer_caf_to_af,
	camera_transfer_af_to_caf,
	//dump_jpeg_file,
	NULL,
...
#ifdef CONFIG_MEM_OPTIMIZATION
	//camera_start_scaling,
	//camera_start_scaling_in_gsp,
	camera_notify_closing_gsp_hwc,
#endif
#endif

#if defined(CONFIG_ISP_2_1)
	//camera_get_focus_point
	NULL,
	//camera_isp_sw_check_buf
	NULL,
	//camera_isp_sw_proc
	NULL,
	//camera_raw_post_proc
	NULL,
