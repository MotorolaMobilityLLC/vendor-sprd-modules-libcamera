...
cmr_int sensor_set_exif_common(cmr_handle sns_module_handle,
...
cmr_int Sensor_WriteData(unsigned char *regPtr, cmr_u32 length);

cmr_int Sensor_WriteReg(unsigned short subaddr, unsigned short data);

cmr_u32 Sensor_ReadReg(unsigned short subaddr);  /*the return value need to be setted to uin32*/
...
cmr_int Sensor_WriteReg_8bits(unsigned short reg_addr, unsigned char value);

cmr_int Sensor_ReadReg_8bits(unsigned char reg_addr, unsigned char * reg_val);
...
cmr_int Sensor_WriteI2C(unsigned short slave_addr, unsigned char *cmd, unsigned short cmd_length);
#endif
