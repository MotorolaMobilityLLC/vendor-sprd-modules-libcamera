...
enum preview_lens_facing {
	PREVIEW_LENS_FACING_FRONT = 0,
	PREVIEW_LENS_FACING_BACK,
	PREVIEW_LENS_FACING_EXTERNAL
};
...
struct preview_md_ops {
	...
	cmr_int (*isp_set_flash)(cmr_handle oem_handle,cmr_u32 camera_id, cmr_u32 is_restart);
