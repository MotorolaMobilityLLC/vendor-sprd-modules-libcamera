...
#include "sensor_ov32a1q_raw_param_fdr_cap0.c"
...
static struct sensor_raw_info s_ov32a1q_mipi_raw_info=
{
	&s_ov32a1q_version_info,
	{
		...
		{NULL, 0},
		{s_ov32a1q_tune_info_fdr_cap0, sizeof(s_ov32a1q_tune_info_fdr_cap0)},
		{NULL, 0},
		{NULL, 0},
	},
	&s_ov32a1q_trim_info,
	...
	},
	{
		...
		{NULL, 0},
		{s_ov32a1q_fdr_cap0_tool_ui_input, sizeof(s_ov32a1q_fdr_cap0_tool_ui_input)},
		{NULL, 0},
		{NULL, 0},
	},
	{
