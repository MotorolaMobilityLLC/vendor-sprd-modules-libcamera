...
//	{ADDR_AND_LEN_OF_ARRAY(imx230_2672x2008_setting_new), 2672, 2008, EX_MCLK, SENSOR_IMAGE_FORMAT_RAW},
	{ADDR_AND_LEN_OF_ARRAY(imx230_4272x2404_setting), 4272, 2404, EX_MCLK, SENSOR_IMAGE_FORMAT_RAW},
	{ADDR_AND_LEN_OF_ARRAY(imx230_4160x3120_setting), 4160, 3120, EX_MCLK, SENSOR_IMAGE_FORMAT_RAW},
...
//	{0, 0, 2672, 2008, 11346, 1500, 2938, {0, 0, 2672, 2008}},
	...
	{0, 0, 4160, 3120, 10143, 1102, 4108, {0, 0, 4160, 3120}},
...
static unsigned long imx230_access_val(SENSOR_HW_HANDLE handle, unsigned long param)
{
	...
	SENSOR_LOGI("SENSOR_IMX230: _imx230_access_val E param_ptr = %p", param_ptr);
	if(!param_ptr){
		return rtn;
	}
