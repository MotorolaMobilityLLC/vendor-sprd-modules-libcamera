...
#include "sensor_ov5640_raw_param_v3.c"
#else
#include "sensor_ov5640_raw_param_v2.c"
#endif
...
SENSOR_INFO_T g_ov5640_mipi_raw_info = {
	...
	&s_ov5640_mipi_raw_info_ptr,		// information and table about Rawrgb sensor
...
LOCAL uint32_t Sensor_InitRawTuneInfo_ispv1(SENSOR_HW_HANDLE handle)
{
	...
	//bypass
	sensor_ptr->version_id=SENSOR_RAW_VERSION_ID;
...
LOCAL uint32_t Sensor_InitRawTuneInfo_ispv2(SENSOR_HW_HANDLE handle)
{
	...
	struct isp_mode_param* mode_prv0_ptr = (struct isp_mode_param*)raw_sensor_ptr->mode_ptr[1].addr;
	struct isp_mode_param* mode_cap0_ptr = (struct isp_mode_param*)raw_sensor_ptr->mode_ptr[5].addr;
