...
LOCAL cmr_uint _ov5640_PowerOn(cmr_uint power_on)
{
	...
	SENSOR_PRINT("dvdd_val %ld, dvdd_val %d, avdd_val %d, iovdd_val %d",
			power_on,
			dvdd_val,
			avdd_val,
			iovdd_val);
...
LOCAL cmr_uint _ov5640_set_work_mode(cmr_uint mode)
{
	...
	SENSOR_PRINT("SENSOR: _ov5640_set_work_mode: mode = %ld", mode);
	return 0;
}
