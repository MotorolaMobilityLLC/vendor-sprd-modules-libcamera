...
static cmr_int sensor_drv_check_cmei(cmr_u8 dual_flag) {
    ...
    case CALIBRATION_FLAG_BOKEH:
        ...
        if(bokeh_cmei_size == cmei_size) {
            ...
            //ret = SENSOR_SUCCESS;
            SENSOR_LOGI("xxx--cannot get bokeh module info, use golden data");
            return SENSOR_FAIL;
        }
        break;
    ...
    case CALIBRATION_FLAG_OZ1:
        ...
        if(oz1_cmei_size == cmei_size) {
            ...
            //ret = SENSOR_SUCCESS;
            SENSOR_LOGI("xxx--cannot get oz1 module info, use golden data");
            return SENSOR_FAIL;
        }
        break;
    ...
    case CALIBRATION_FLAG_OZ2:
        ...
        if(oz2_cmei_size == cmei_size) {
            ...
            //ret = SENSOR_SUCCESS;
            SENSOR_LOGI("xxx--cannot get oz2 module info, use golden data");
            return SENSOR_FAIL;
        }
        break;
