...
#include "sensor_ov8865_raw_param_v3.c"
#else
#include "sensor_ov8865_raw_param_v2.c"
#endif

#define ov8865_I2C_ADDR_W        (0x6c>>1)
#define ov8865_I2C_ADDR_R         (0x6d>>1)
