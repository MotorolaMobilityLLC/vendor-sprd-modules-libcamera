...
static cmr_uint _otp_parser_get_start_offset_v04(cmr_u8 * raw_data, cmr_int eeprom_num, cmr_int camera_id, cmr_int height, cmr_int width)
{
    ...
    if((OTP_EEPROM_SINGLE_CAM_DUAL == eeprom_num || OTP_EEPROM_DUAL_CAM_DUAL== eeprom_num)&&(0==camera_id || 1==camera_id)){
        ...
        camera_otp_info[camera_id].dualcam_info.data_size = 230;
    }else{
...
static cmr_int _otp_parser_af_v04(void * raw_data, cmr_uint start_offset, cmr_uint data_size, void *result)
{
    cmr_int rtn = OTP_PARSER_SUCCESS;
...
static cmr_int _otp_parser_awb_v04(void * raw_data, cmr_uint start_offset, cmr_uint data_size, void *result)
{
    cmr_int rtn = OTP_PARSER_SUCCESS;
...
static cmr_int _otp_parser_lsc_v04(void * raw_data, cmr_uint start_offset, cmr_uint data_size, cmr_uint height, cmr_uint width, void *result)
{
    cmr_int rtn = OTP_PARSER_SUCCESS;
...
static cmr_int _otp_parser_pdaf_sprd_v04(void * raw_data, cmr_uint start_offset, cmr_uint data_size, void *result)
{
    cmr_int rtn = OTP_PARSER_SUCCESS;
...
static cmr_int _otp_parser_pdaf_spc_vendor_v04(void * raw_data, cmr_uint start_offset, cmr_uint data_size, void *result)
{
    cmr_int rtn = OTP_PARSER_SUCCESS;
    struct otp_parser_pdaf_for_sprd_3rd * pdaf_data = (struct otp_parser_pdaf_for_sprd_3rd *)result;
    cmr_u32 pdaf_start_offset = start_offset;
...
static cmr_int _otp_parser_ae_v04(void * raw_data, cmr_uint start_offset, cmr_uint data_size, void *result)
{
    cmr_int rtn = OTP_PARSER_SUCCESS;
...
static cmr_int _otp_parser_dualcamera_v04(void * raw_data, cmr_uint start_offset, cmr_uint data_size, void *result)
{
    cmr_int rtn = OTP_PARSER_SUCCESS;
...
cmr_int otp_parser_map_v04(void * raw_data, enum otp_parser_cmd cmd, cmr_int eeprom_num, cmr_int camera_id, cmr_int raw_height, cmr_int raw_width, void *result)
{
    cmr_int rtn = OTP_PARSER_SUCCESS;
    ...
    rtn = _otp_parser_get_start_offset_v04((cmr_u8 *)raw_data, eeprom_num, camera_id, raw_height, raw_width);
    ...
    case OTP_PARSER_LSC:
            ...
            rtn = _otp_parser_lsc_v04(raw_data, start_offset, data_size, raw_height, raw_width, result);
            break;
    case OTP_PARSER_PDAF_SPRD:
            ...
            rtn = _otp_parser_pdaf_sprd_v04(raw_data, start_offset, data_size, result);
            break;
    case OTP_PARSER_AE:
    ...
    case OTP_PARSER_DUAL_CAMERA:
            ...
            rtn = _otp_parser_dualcamera_v04(raw_data, start_offset, data_size, result);
            break;
    default:
