...
= {
	...
	0x029E,	// gl_HX_OFS;
	0x0091,	// gl_HY_OFS;
	0x007D,	// gl_PSTXOF;		RHM_HT 2013.03.21	Change order to adjust EEP ROM map
	0x007F,	// gl_PSTYOF;		RHM_HT 2013.03.21	Change order to adjust EEP ROM map
	0x00A9,	// gl_GX_OFS;
	0x013E,	// gl_GY_OFS;

	0x2328,	// gl_KgxHG ;		RHM_HT 2013/11/25	Modified
	0x238D,	// gl_KgyHG ;		RHM_HT 2013/11/25	Modified
	0x2950,	// gl_KGXG  ;		RHM_HT 2013/11/25	Modified
	0x2C4E,	// gl_KGYG  ;		RHM_HT 2013/11/25	Modified
	0x0216,	// gl_SFTHAL_X;		RHM_HT 2013/11/25	Added
	0x01DA,	// gl_SFTHAL_Y;		RHM_HT 2013/11/25	Added
	0x0000,	// gl_TMP_X_;		RHM_HT 2013/11/25	Added
	0x0000,	// gl_TMP_Y_;		RHM_HT 2013/11/25	Added
	0xFE68,	// gl_KgxH0;		RHM_HT 2013/11/25	Added
	0x00F4,	// gl_KgyH0;		RHM_HT 2013/11/25	Added
#endif
}
#endif
;
