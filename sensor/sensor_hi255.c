...
LOCAL unsigned long sensor_InitTflash(unsigned long param);
...
LOCAL unsigned long _HI255_SetExifInfo_exposure(unsigned long param)
{
...
LOCAL unsigned long _HI255_SetExifInfo_ISO(unsigned long param)
{
	EXIF_SPEC_PIC_TAKING_COND_T *sensor_exif_info_ptr = &s_HI255_exif;
	uint8_t iso       = 0;
