...
static cmr_int _s5k3l8xxm3_qtech_section_checksum(unsigned char *buf,
                                           unsigned int offset,
...
static cmr_int _s5k3l8xxm3_qtech_compatible_convert(cmr_handle otp_drv_handle,void *p_data) {
    cmr_int ret = OTP_CAMERA_SUCCESS;
    CHECK_PTR(otp_drv_handle);
    OTP_LOGI("in");
    otp_drv_cxt_t *otp_cxt = (otp_drv_cxt_t *)otp_drv_handle;
...
/*just for expend*/
static cmr_int s5k3l8xxm3_qtech_otp_drv_ioctl(cmr_handle otp_drv_handle, cmr_uint cmd, void *params) {
    cmr_int ret = OTP_CAMERA_SUCCESS;
    CHECK_PTR(otp_drv_handle);
    OTP_LOGI("in");
