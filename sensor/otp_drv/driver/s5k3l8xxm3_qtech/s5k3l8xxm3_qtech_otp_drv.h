...
static cmr_int s5k3l8xxm3_qtech_otp_drv_create(otp_drv_init_para_t *input_para, cmr_handle *sns_af_drv_handle);
static cmr_int s5k3l8xxm3_qtech_otp_drv_delete(cmr_handle otp_drv_handle);
static cmr_int s5k3l8xxm3_qtech_otp_drv_read(cmr_handle otp_drv_handle,void *p_params);
static cmr_int s5k3l8xxm3_qtech_otp_drv_write(cmr_handle otp_drv_handle, void *p_params);
static cmr_int s5k3l8xxm3_qtech_otp_drv_parse(cmr_handle otp_drv_handle, void *p_params);
static cmr_int s5k3l8xxm3_qtech_otp_drv_calibration(cmr_handle otp_drv_handle);
static cmr_int s5k3l8xxm3_qtech_otp_drv_ioctl(cmr_handle otp_drv_handle, cmr_uint cmd, void *p_params);

otp_drv_entry_t s5k3l8xxm3_qtech_drv_entry = {
    .otp_cfg =
        {
            .cali_items =
                {
    ...
    .otp_ops =
        {
            ...
            .sensor_otp_calibration = s5k3l8xxm3_qtech_otp_drv_calibration,
            .sensor_otp_ioctl = s5k3l8xxm3_qtech_otp_drv_ioctl, /*expend*/
        },
};
