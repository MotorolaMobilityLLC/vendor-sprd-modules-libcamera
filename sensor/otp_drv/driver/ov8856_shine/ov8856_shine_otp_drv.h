...
#define MODULE_INFO_CHECK_SUM 0x0006
#define MODULE_INFO_CHECKSUM 0x0006
/*AF*/
#define AF_INFO_OFFSET 0x0008
#define AF_INFO_END_OFFSET 0x0015
#define AF_INFO_CHECKSUM 0x0015
/*AWB*/
#define AWB_INFO_OFFSET 0x0016
#define AWB_INFO_END_OFFSET 0x0029
#define AWB_INFO_CHECKSUM 0x0029
#define AWB_INFO_SIZE 6
#define AWB_SECTION_NUM 1
/*OPTICAL*/
#define OPTICAL_INFO_OFFSET 0x002b
#define LSC_INFO_OFFSET 0x003b
#define LSC_INFO_END_OFFSET 0x0723 //0B8B
#define LSC_INFO_CHANNEL_SIZE 442 //726
#define LSC_INFO_CHECKSUM 0x0723 //0B8B
