 ...
 *  path: \\shplm06\01-Unisoc Camera OTP \B1\EA׼\OTP map
 *
 *  otp map 0.4/0.5:
...
otp_drv_entry_t s5k3l6_otp_entry = {
    .otp_ops =
        {
            .sensor_otp_create = s5k3l6_otp_drv_create,
            .sensor_otp_delete = s5k3l6_otp_drv_delete,
            .sensor_otp_read = s5k3l6_otp_drv_read,
            .sensor_otp_write = s5k3l6_otp_drv_write,
            .sensor_otp_parse = s5k3l6_otp_drv_parse,
            .sensor_otp_calibration = s5k3l6_otp_drv_calibration,
            .sensor_otp_ioctl = s5k3l6_otp_drv_ioctl, /*expand*/
        },
};
