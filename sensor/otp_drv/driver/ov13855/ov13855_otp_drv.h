...
static int _ov13855_section_checksum(unsigned char *buf, unsigned int first,
...
int ov13855_otp_drv_parse(void *otp_drv_handle, void *P_params);
int ov13855_otp_drv_calibration(void *otp_drv_handle);
int ov13855_otp_drv_ioctl(otp_drv_cxt_t *otp_drv_handle, int cmd, void *params);
...
otp_drv_entry_t ov13855_drv_entry = {
    ...
    .otp_ops =
        {
            .sensor_otp_create = ov13855_otp_create,
