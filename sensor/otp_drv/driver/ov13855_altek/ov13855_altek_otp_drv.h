 ...
 **/
#define LOG_TAG "ov13855_altek_otp_drv"
#include <stdio.h>
#include <string.h>
#include <math.h>
#include <utils/Log.h>
...
#include "ov13855_altek_golden_otp.h"
#include "cmr_sensor_info.h"

/*Module Vendor ID*/
#define MODULE_VENDOR_ID  0x13

/*I2C slave address setting*/
#define OTP_I2C_ADDR (0xA0 >> 1)
#define SENSOR_I2C_ADDR (0x40 >> 1)
...
static cmr_int ov13855_altek_otp_drv_ioctl(cmr_handle otp_drv_handle, cmr_uint cmd, void *p_params);
            ...
            .cali_items =
                {
                    ...
                    .is_awbc_self_cal= FALSE,/*TRUE: Sensor side calibration, FALSE: ISP Side calibration*/
                    ...
                    .is_pdafc = TRUE, /* TRUE: support pdaf calibration, FALSE: Not support pdaf calibration */
