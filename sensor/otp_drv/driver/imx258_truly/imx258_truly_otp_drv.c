 ...
 **/
static cmr_int _imx258_truly_section_checksum(cmr_u8 *buf, cmr_uint offset,
                                              cmr_uint data_count,
...
static cmr_int _imx258_truly_buffer_init(cmr_handle otp_drv_handle) {
    cmr_int ret = OTP_CAMERA_SUCCESS;
    cmr_int otp_len;
...
static cmr_int _imx258_truly_parse_af_data(cmr_handle otp_drv_handle) {
    cmr_int ret = OTP_CAMERA_SUCCESS;
...
static cmr_int _imx258_truly_parse_awb_data(cmr_handle otp_drv_handle) {
    cmr_int ret = OTP_CAMERA_SUCCESS;
...
static cmr_int _imx258_truly_parse_lsc_data(cmr_handle otp_drv_handle) {
    cmr_int ret = OTP_CAMERA_SUCCESS;
    CHECK_PTR(otp_drv_handle);
    OTP_LOGV("in");
...
static cmr_int _imx258_truly_parse_pdaf_data(cmr_handle otp_drv_handle) {
    cmr_int ret = OTP_CAMERA_SUCCESS;
...
static cmr_int _imx258_truly_parse_dual_otp_data(cmr_handle otp_drv_handle,
                                                 void *param) {
    cmr_int ret = OTP_CAMERA_SUCCESS;
...
static cmr_int _imx258_truly_lsc_calibration(cmr_handle otp_drv_handle) {
    cmr_int ret = OTP_CAMERA_SUCCESS;
    OTP_LOGV("in");
    CHECK_PTR(otp_drv_handle);
...
static cmr_int _imx258_truly_pdaf_calibration(cmr_handle otp_drv_handle) {
    cmr_int ret = OTP_CAMERA_SUCCESS;
    OTP_LOGV("in");
    CHECK_PTR(otp_drv_handle);
...
static cmr_int imx258_truly_otp_drv_create(otp_drv_init_para_t *input_para,
                                           cmr_handle *sns_af_drv_handle) {
    return sensor_otp_drv_create(input_para, sns_af_drv_handle);
}

static cmr_int imx258_truly_otp_drv_delete(cmr_handle otp_drv_handle) {
    return sensor_otp_drv_delete(otp_drv_handle);
}

static cmr_int imx258_truly_otp_drv_read(cmr_handle otp_drv_handle,
                                         void *param) {
    cmr_int ret = OTP_CAMERA_SUCCESS;
    cmr_uint i = 0;
    cmr_u8 cmd_val[3];
    ...
    if (!otp_raw_data->buffer) {
        ...
        OTP_LOGI("buffer pointer:%p", otp_raw_data->buffer);
...
static cmr_int imx258_truly_otp_drv_write(cmr_handle otp_drv_handle,
                                          void *p_data) {
    cmr_int ret = OTP_CAMERA_SUCCESS;
    CHECK_PTR(otp_drv_handle);
    CHECK_PTR(p_data);
...
static cmr_int imx258_truly_otp_drv_parse(cmr_handle otp_drv_handle,
                                          void *params) {
    cmr_int ret = OTP_CAMERA_SUCCESS;
...
static cmr_int imx258_truly_otp_drv_calibration(cmr_handle otp_drv_handle) {
    cmr_int ret = OTP_CAMERA_SUCCESS;
    CHECK_PTR(otp_drv_handle);
    OTP_LOGV("in");
    otp_drv_cxt_t *otp_cxt = (otp_drv_cxt_t *)otp_drv_handle;
    ...
    otp_calib_items_t *cali_items =
        &(imx258_truly_drv_entry.otp_cfg.cali_items);
...
static cmr_int _imx258_truly_compatible_convert(cmr_handle otp_drv_handle,
                                                void *p_data) {
    cmr_int ret = OTP_CAMERA_SUCCESS;
    CHECK_PTR(otp_drv_handle);
    OTP_LOGV("in");
    ...
    single_otp->lsc_info.full_img_width =
        imx258_truly_drv_entry.otp_cfg.base_info_cfg.full_img_width;
    single_otp->lsc_info.full_img_height =
        imx258_truly_drv_entry.otp_cfg.base_info_cfg.full_img_height;
    single_otp->lsc_info.lsc_otp_grid =
        imx258_truly_drv_entry.otp_cfg.base_info_cfg.lsc_otp_grid;
    /*lsc golden data*/
    ...
    /**/
    _imx258_truly_parse_dual_otp_data(otp_drv_handle,
...
/*just for expend*/
static cmr_int imx258_truly_otp_drv_ioctl(cmr_handle otp_drv_handle,
