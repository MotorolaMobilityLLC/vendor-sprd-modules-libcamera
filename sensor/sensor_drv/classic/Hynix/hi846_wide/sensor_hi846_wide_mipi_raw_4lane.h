...
#include "parameters_dual/sensor_hi846_wide_raw_param_main.c"
#else
...
static const SENSOR_REG_T hi846_wide_init_setting[] = {
    ...
    {0x0A02, 0x0100}, {0x0A04, 0x014A}, // Lens shading correction disable
    ...
    {0x0900, 0x0300}, {0x0902, 0xC319}, // tx_op_mode1/2
    {0x0914, 0xC109},                   // mipi_exit_seq, tlpx
    {0x0916, 0x061A},                   // r_mipi_value_clk_prepare
    {0x0918, 0x0407},                   // r_mipi_value_clk_pre
    {0x091A, 0x0A0B},                   // r_mipi_value_data_zero
    {0x091C, 0x0E08},                   // r_mipi_value_clk_post
    {0x091E, 0x0A00},                   // r_mipi_value_exit
    {0x090C, 0x0427},                   // r_mipi_vblank_delay_h
    {0x090E, 0x0069},                   // r_mipi_hblank_short_delay_h
    {0x0954, 0x0089}, {0x0956, 0x0000},
    {0x0958, 0xCA80}, {0x095A, 0x9240},
    {0x0F08, 0x2F04}, {0x0F30, 0x001F},
    {0x0F36, 0x001F}, {0x0F04, 0x3A00},
    {0x0F32, 0x025A}, {0x0F38, 0x025A},
    {0x0F2A, 0x4124}, {0x006A, 0x0100},
    {0x004C, 0x0100},
};
...
struct sensor_raw_info *s_hi846_wide_mipi_raw_info_ptr = &s_hi846_wide_mipi_raw_info;
