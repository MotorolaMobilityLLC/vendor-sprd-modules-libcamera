...
static const SENSOR_REG_T hi1336_video_setting[] = {
        ...
        //Max Fps 	  		: 30.01fps
        //Pixel order 	  : GB
        //PDAF Type       : X / PD-DPC on, Dyn-DPC on
        /////////////////////////////////////////
        {0x3250, 0xa060},
        {0x0730, 0x770f},
        {0x0732, 0xe2b0},
...
static const SENSOR_REG_T hi1336_efuse_id_setting[] =
{
        {0x0b00, 0x0000},
        {0x2000, 0x0021},
        {0x2002, 0x04A5},
...
static struct sensor_i2c_reg_tab hi1336_efuse_id_tab = {
    .settings = hi1336_efuse_id_setting, .size = ARRAY_SIZE(hi1336_efuse_id_setting),
};
...
SENSOR_INFO_T g_hi1336_mipi_raw_info = {
    ...
    .sensor_version_info = (cmr_s8 *)"hi1336_arb_1",
};
