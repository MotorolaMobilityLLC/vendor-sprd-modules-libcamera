...
static struct sensor_res_tab_info s_s5k3l6_resolution_tab_raw[VENDOR_NUM] = {
	{
      ...
      .reg_tab = {
        {ADDR_AND_LEN_OF_ARRAY(s5k3l6_init_setting), PNULL, 0,
        .width = 0, .height = 0,
...
static struct sensor_i2c_reg_tab s5k3l6_shutter_tab = {
    .settings = s5k3l6_shutter_reg, 
	.size = ARRAY_SIZE(s5k3l6_shutter_reg),
};
...
static struct sensor_i2c_reg_tab s5k3l6_again_tab = {
    .settings = s5k3l6_again_reg, 
	.size = ARRAY_SIZE(s5k3l6_again_reg),
};
...
static struct sensor_i2c_reg_tab s5k3l6_dgain_tab = {
    .settings = s5k3l6_dgain_reg, 
	.size = ARRAY_SIZE(s5k3l6_dgain_reg),
};
...
SENSOR_INFO_T g_s5k3l6_mipi_raw_info = {
    ...
    .identify_count = 1,
    .identify_code =
        {{ .reg_addr = s5k3l6_PID_ADDR, .reg_value = s5k3l6_PID_VALUE},
         { .reg_addr = s5k3l6_VER_ADDR, .reg_value = s5k3l6_VER_VALUE}},
