...
/* frame length*/
#define VIDEO_FRAME_LENGTH 3438
#define PREVIEW_FRAME_LENGTH 3260
#define SNAPSHOT_FRAME_LENGTH 3260
...
static const SENSOR_REG_T s5k3l6_init_setting[] = {
    ...
    {0x34AC, 0x001A}, {0x34AE, 0x002A}, {0x39b4, 0x2301}, // add for csi
    {0x34B0, 0x0080}, {0x34B2, 0x0006}, {0x32A2, 0x0000}, {0x32A4, 0x0000},
    {0x32A6, 0x0000}, {0x32A8, 0x0000},
};
...
static struct sensor_res_tab_info s_s5k3l6_resolution_tab_raw[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
     .reg_tab = {{ADDR_AND_LEN_OF_ARRAY(s5k3l6_init_setting), PNULL, 0,
                  .width = 0, .height = 0, .xclk_to_sensor = EX_MCLK,
                  .image_format = SENSOR_IMAGE_FORMAT_RAW},
                 /*
                                 {ADDR_AND_LEN_OF_ARRAY(s5k3l6_video_setting),
                    PNULL, 0,
     ...
     .trim_info =
         {
             ...
             /*
                        {.trim_start_x = VIDEO_TRIM_X, .trim_start_y =
                VIDEO_TRIM_Y,
