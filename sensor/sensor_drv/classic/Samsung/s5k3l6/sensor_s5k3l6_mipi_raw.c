...
static void s5k3l6_drv_write_reg2sensor(cmr_handle handle, struct sensor_i2c_reg_tab *reg_info)
{
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void s5k3l6_drv_write_gain(cmr_handle handle, struct sensor_aec_i2c_tag *aec_info, cmr_u32 gain)
{
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void s5k3l6_drv_write_frame_length(cmr_handle handle, struct sensor_aec_i2c_tag *aec_info, cmr_u32 frame_len)
{
    SENSOR_IC_CHECK_PTR_VOID(aec_info);
	SENSOR_IC_CHECK_HANDLE_VOID(handle);
    struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void s5k3l6_drv_write_shutter(cmr_handle handle, struct sensor_aec_i2c_tag *aec_info , cmr_u32 shutter)
{
	SENSOR_IC_CHECK_PTR_VOID(aec_info);
    SENSOR_IC_CHECK_HANDLE_VOID(handle);
    struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 *============================================================================*/
static void s5k3l6_drv_calc_exposure(cmr_handle handle, cmr_u32 shutter,cmr_u32 dummy_line, 
...
static void s5k3l6_drv_calc_gain(cmr_handle handle,cmr_uint isp_gain, struct sensor_aec_i2c_tag *aec_info) 
{
	SENSOR_IC_CHECK_HANDLE_VOID(handle);
	struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
...
static cmr_int s5k3l6_drv_get_static_info(cmr_handle handle, cmr_u32 *param) 
{
    ...
    ex_info->sensor_version_info = (cmr_s8 *)g_s5k3l6_mipi_raw_info.sensor_version_info;
...
static cmr_int s5k3l6_drv_before_snapshot(cmr_handle handle, cmr_uint param)
{
    ...
    s5k3l6_drv_calc_exposure(handle,cap_shutter, 0 , capture_mode, &s5k3l6_aec_info);
...
static cmr_int s5k3l6_drv_write_exposure(cmr_handle handle, cmr_uint param)
{
	...
	s5k3l6_drv_calc_exposure(handle,exposure_line, dummy_line, size_index, &s5k3l6_aec_info);
	s5k3l6_drv_write_reg2sensor(handle, s5k3l6_aec_info.frame_length);
	s5k3l6_drv_write_reg2sensor(handle, s5k3l6_aec_info.shutter);
...
static cmr_int s5k3l6_drv_read_aec_info(cmr_handle handle, cmr_uint param) 
{
    ...
    s5k3l6_drv_calc_exposure(handle, exposure_line, dummy_line, mode, &s5k3l6_aec_info);
    s5k3l6_drv_calc_gain(handle,info->gain, &s5k3l6_aec_info);

    return ret_value;
}

static cmr_int s5k3l6_drv_set_master_FrameSync(cmr_handle handle, cmr_uint param) 
{
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
...
static cmr_int s5k3l6_drv_handle_create(struct sensor_ic_drv_init_para *init_param, cmr_handle* sns_ic_drv_handle) 
{
	...
	s5k3l6_drv_write_frame_length(sns_drv_cxt, &s5k3l6_aec_info, sns_drv_cxt->sensor_ev_info.preview_framelength);
	s5k3l6_drv_write_gain(sns_drv_cxt, &s5k3l6_aec_info, sns_drv_cxt->sensor_ev_info.preview_gain);
	s5k3l6_drv_write_shutter(sns_drv_cxt, &s5k3l6_aec_info, sns_drv_cxt->sensor_ev_info.preview_shutter);

    sensor_ic_set_match_module_info(sns_drv_cxt, ARRAY_SIZE(s_s5k3l6_module_info_tab), s_s5k3l6_module_info_tab);
    sensor_ic_set_match_resolution_info(sns_drv_cxt, ARRAY_SIZE(s_s5k3l6_resolution_tab_raw), s_s5k3l6_resolution_tab_raw);
    sensor_ic_set_match_trim_info(sns_drv_cxt, ARRAY_SIZE(s_s5k3l6_resolution_trim_tab), s_s5k3l6_resolution_trim_tab);
    sensor_ic_set_match_static_info(sns_drv_cxt, ARRAY_SIZE(s_s5k3l6_static_info), s_s5k3l6_static_info);
    sensor_ic_set_match_fps_info(sns_drv_cxt, ARRAY_SIZE(s_s5k3l6_mode_fps_info), s_s5k3l6_mode_fps_info);
...
static cmr_int s5k3l6_drv_get_private_data(cmr_handle handle, cmr_uint cmd, void**param)
{
    cmr_int ret = SENSOR_SUCCESS;
    SENSOR_IC_CHECK_HANDLE(handle);
    SENSOR_IC_CHECK_PTR(param);
