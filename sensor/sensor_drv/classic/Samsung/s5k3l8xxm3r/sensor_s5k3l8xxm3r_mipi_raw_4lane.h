...
#include "parameters/sensor_s5k3l8xxm3r_raw_param_main.c"

#define FEATURE_OTP

#define VENDOR_NUM 1
#define SENSOR_NAME				"s5k3l8xxm3r_mipi_raw"
#define I2C_SLAVE_ADDR			 0x5A //0x20 //

#define s5k3l8xxm3r_PID_ADDR			0x0000
#define s5k3l8xxm3r_PID_VALUE		0x30c8
#define s5k3l8xxm3r_VER_ADDR			0x0004
#define s5k3l8xxm3r_VER_VALUE		0x10ff
...
static const SENSOR_REG_T s5k3l8xxm3r_init_setting[] = {
...
static const SENSOR_REG_T s5k3l8xxm3r_preview_setting[] = {
...
static const SENSOR_REG_T s5k3l8xxm3r_snapshot_setting[] = {
    {0x6028, 0x2000}, {0x602A, 0x0F74}, {0x6F12, 0x0040}, {0x6F12, 0x0040},
    {0x6028, 0x4000}, {0x0344, 0x0008}, {0x0346, 0x0008}, {0x0348, 0x1077},
...
static const SENSOR_REG_T s5k3l8xxm3r_video_setting[] = {
...
static struct sensor_res_tab_info s_s5k3l8xxm3r_resolution_tab_raw[VENDOR_NUM] = {
	{
      .module_id = MODULE_SUNNY,
      .reg_tab = {
        {ADDR_AND_LEN_OF_ARRAY(s5k3l8xxm3r_init_setting), PNULL, 0,
        .width = 0, .height = 0,
        .xclk_to_sensor = EX_MCLK, .image_format = SENSOR_IMAGE_FORMAT_RAW},

		{ADDR_AND_LEN_OF_ARRAY(s5k3l8xxm3r_video_setting), PNULL, 0,
        .width = VIDEO_WIDTH, .height = VIDEO_HEIGHT,
        .xclk_to_sensor = EX_MCLK, .image_format = SENSOR_IMAGE_FORMAT_RAW},
		
        {ADDR_AND_LEN_OF_ARRAY(s5k3l8xxm3r_preview_setting), PNULL, 0,
        .width = PREVIEW_WIDTH, .height = PREVIEW_HEIGHT,
        .xclk_to_sensor = EX_MCLK, .image_format = SENSOR_IMAGE_FORMAT_RAW},

        {ADDR_AND_LEN_OF_ARRAY(s5k3l8xxm3r_snapshot_setting), PNULL, 0,
...
static SENSOR_TRIM_T s_s5k3l8xxm3r_resolution_trim_tab[VENDOR_NUM] = {
	{
     .module_id = MODULE_SUNNY,
     .trim_info = {
...
static SENSOR_REG_T s5k3l8xxm3r_shutter_reg[] = {
    {0x0202, SENSOR_MIN_SHUTTER}, 
};

static struct sensor_i2c_reg_tab s5k3l8xxm3r_shutter_tab = {
    .settings = s5k3l8xxm3r_shutter_reg, 
	.size = ARRAY_SIZE(s5k3l8xxm3r_shutter_reg),
};

static SENSOR_REG_T s5k3l8xxm3r_again_reg[] = {
    {0x0204, SENSOR_BASE_GAIN}, 
};

static struct sensor_i2c_reg_tab s5k3l8xxm3r_again_tab = {
    .settings = s5k3l8xxm3r_again_reg, 
	.size = ARRAY_SIZE(s5k3l8xxm3r_again_reg),
};

static SENSOR_REG_T s5k3l8xxm3r_dgain_reg[] = {
   
};

static struct sensor_i2c_reg_tab s5k3l8xxm3r_dgain_tab = {
    .settings = s5k3l8xxm3r_dgain_reg, 
	.size = ARRAY_SIZE(s5k3l8xxm3r_dgain_reg),
};

static SENSOR_REG_T s5k3l8xxm3r_frame_length_reg[] = {
    {0x0340, PREVIEW_FRAME_LENGTH}, 
};

static struct sensor_i2c_reg_tab s5k3l8xxm3r_frame_length_tab = {
    .settings = s5k3l8xxm3r_frame_length_reg,
    .size = ARRAY_SIZE(s5k3l8xxm3r_frame_length_reg),
};

static struct sensor_aec_i2c_tag s5k3l8xxm3r_aec_info = {
    .slave_addr = (I2C_SLAVE_ADDR >> 1),
    .addr_bits_type = SENSOR_I2C_REG_16BIT,
    .data_bits_type = SENSOR_I2C_VAL_16BIT,
    .shutter = &s5k3l8xxm3r_shutter_tab,
    .again = &s5k3l8xxm3r_again_tab,
    .dgain = &s5k3l8xxm3r_dgain_tab,
    .frame_length = &s5k3l8xxm3r_frame_length_tab,
};


static SENSOR_STATIC_INFO_T s_s5k3l8xxm3r_static_info[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
     .static_info = {
        .f_num = 200,
        .focal_length = 354,
...
static SENSOR_MODE_FPS_INFO_T s_s5k3l8xxm3r_mode_fps_info[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
       {.is_init = 0,
...
static struct sensor_module_info s_s5k3l8xxm3r_module_info_tab[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
     .module_info = {
...
struct sensor_raw_info *s_s5k3l8xxm3r_mipi_raw_info_ptr = &s_s5k3l8xxm3r_mipi_raw_info;

SENSOR_INFO_T g_s5k3l8xxm3r_mipi_raw_info = {
    ...
    .identify_count = 1,
    .identify_code =
        {{ .reg_addr = s5k3l8xxm3r_PID_ADDR, .reg_value = s5k3l8xxm3r_PID_VALUE},
         { .reg_addr = s5k3l8xxm3r_VER_ADDR, .reg_value = s5k3l8xxm3r_VER_VALUE}},
    ...
    .module_info_tab = s_s5k3l8xxm3r_module_info_tab,
    .module_info_tab_size = ARRAY_SIZE(s_s5k3l8xxm3r_module_info_tab),

    .resolution_tab_info_ptr = s_s5k3l8xxm3r_resolution_tab_raw,
    .sns_ops = &s_s5k3l8xxm3r_ops_tab,
    .raw_info_ptr = &s_s5k3l8xxm3r_mipi_raw_info_ptr,

    .video_tab_info_ptr = NULL,
    .sensor_version_info = (cmr_s8 *)"s5k3l8xxm3r_v1",
};
