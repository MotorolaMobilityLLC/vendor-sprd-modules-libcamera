...
static void
s5k3l8xxm3r_drv_write_reg2sensor(cmr_handle handle,
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void s5k3l8xxm3r_drv_write_gain(struct sensor_aec_i2c_tag *aec_info,
                                       cmr_u32 gain) {
 ...
 *============================================================================*/
static void
s5k3l8xxm3r_drv_write_frame_length(struct sensor_aec_i2c_tag *aec_info,
                                   cmr_u32 frame_len) {
  SENSOR_IC_CHECK_PTR_VOID(aec_info);
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void s5k3l8xxm3r_drv_write_shutter(struct sensor_aec_i2c_tag *aec_info,
                                          cmr_u32 shutter) {
  SENSOR_IC_CHECK_PTR_VOID(aec_info);
  cmr_u32 value = 0x00;
...
static void s5k3l8xxm3r_drv_calc_gain(cmr_handle handle, cmr_uint isp_gain,
                                      struct sensor_aec_i2c_tag *aec_info) {
  SENSOR_IC_CHECK_HANDLE_VOID(handle);
  struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
...
static cmr_int s5k3l8xxm3r_drv_get_pdaf_info(cmr_handle handle,
  ...
  pd_pos_is_right_size = NUMBER_OF_ARRAY(s5k3l8xxm3r_pd_is_right);
  pd_pos_row_size = NUMBER_OF_ARRAY(s5k3l8xxm3r_pd_row);
  pd_pos_col_size = NUMBER_OF_ARRAY(s5k3l8xxm3r_pd_col);
  ...
  pdaf_info->pd_is_right = (cmr_u16 *)s5k3l8xxm3r_pd_is_right;
  pdaf_info->pd_pos_row = (cmr_u16 *)s5k3l8xxm3r_pd_row;
  pdaf_info->pd_pos_col = (cmr_u16 *)s5k3l8xxm3r_pd_col;
...
static cmr_int s5k3l8xxm3r_drv_get_static_info(cmr_handle handle,
                                               uint32_t *param) {
  cmr_int rtn = SENSOR_SUCCESS;
  ...
  ex_info->sensor_version_info =
      (cmr_s8 *)g_s5k3l8xxm3r_mipi_raw_info.sensor_version_info;
...
static cmr_int s5k3l8xxm3r_drv_identify(cmr_handle handle, cmr_uint param) {
  ...
  if (s5k3l8xxm3r_PID_VALUE == pid_value) {
    ver_value =
        hw_sensor_read_reg(sns_drv_cxt->hw_handle, s5k3l8xxm3r_VER_ADDR);
 ...
 *============================================================================*/
static cmr_int s5k3l8xxm3r_drv_before_snapshot(cmr_handle handle,
                                               cmr_uint param) {
  ...
  s5k3l8xxm3r_drv_calc_exposure(handle, cap_shutter, 0, capture_mode,
                                &s5k3l8xxm3r_aec_info);
 ...
 *============================================================================*/
static cmr_int s5k3l8xxm3r_drv_write_exposure(cmr_handle handle,
                                              cmr_uint param) {
  ...
  s5k3l8xxm3r_drv_calc_exposure(handle, exposure_line, dummy_line, size_index,
                                &s5k3l8xxm3r_aec_info);
  s5k3l8xxm3r_drv_write_reg2sensor(handle, s5k3l8xxm3r_aec_info.frame_length);
  s5k3l8xxm3r_drv_write_reg2sensor(handle, s5k3l8xxm3r_aec_info.shutter);
 ...
 * you can change this function if it's necessary
 *============================================================================*/
static cmr_int s5k3l8xxm3r_drv_write_gain_value(cmr_handle handle,
                                                cmr_uint param) {
  cmr_int ret_value = SENSOR_SUCCESS;
...
static cmr_int s5k3l8xxm3r_drv_read_aec_info(cmr_handle handle,
                                             cmr_uint param) {
  cmr_int ret_value = SENSOR_SUCCESS;
  ...
  s5k3l8xxm3r_drv_calc_exposure(handle, exposure_line, dummy_line, mode,
                                &s5k3l8xxm3r_aec_info);
...
static cmr_int s5k3l8xxm3r_drv_set_master_FrameSync(cmr_handle handle,
                                                    cmr_uint param) {
  SENSOR_IC_CHECK_HANDLE(handle);
  struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
...
static cmr_int
s5k3l8xxm3r_drv_handle_create(struct sensor_ic_drv_init_para *init_param,
  ...
  sensor_ic_set_match_module_info(sns_drv_cxt,
                                  ARRAY_SIZE(s_s5k3l8xxm3r_module_info_tab),
                                  s_s5k3l8xxm3r_module_info_tab);
  sensor_ic_set_match_resolution_info(
      sns_drv_cxt, ARRAY_SIZE(s_s5k3l8xxm3r_resolution_tab_raw),
      s_s5k3l8xxm3r_resolution_tab_raw);
  sensor_ic_set_match_trim_info(sns_drv_cxt,
                                ARRAY_SIZE(s_s5k3l8xxm3r_resolution_trim_tab),
                                s_s5k3l8xxm3r_resolution_trim_tab);
  sensor_ic_set_match_static_info(sns_drv_cxt,
                                  ARRAY_SIZE(s_s5k3l8xxm3r_static_info),
                                  s_s5k3l8xxm3r_static_info);
  sensor_ic_set_match_fps_info(sns_drv_cxt,
                               ARRAY_SIZE(s_s5k3l8xxm3r_mode_fps_info),
                               s_s5k3l8xxm3r_mode_fps_info);
...
static cmr_int s5k3l8xxm3r_drv_get_private_data(cmr_handle handle, cmr_uint cmd,
                                                void **param) {
  cmr_int ret = SENSOR_SUCCESS;
  SENSOR_IC_CHECK_HANDLE(handle);
  SENSOR_IC_CHECK_PTR(param);
...
static struct sensor_ic_ops s_s5k3l8xxm3r_ops_tab = {
    ...
    .ext_ops = {
            [SENSOR_IOCTL_BEFORE_SNAPSHOT].ops =
                s5k3l8xxm3r_drv_before_snapshot,
