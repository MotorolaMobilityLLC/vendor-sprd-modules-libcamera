...
#include "sensor_s5ks3p92_mipi_raw_2lane.h"
#else
...
static void
s5ks3p92_drv_write_reg2sensor(cmr_handle handle,
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void s5ks3p92_drv_write_gain(struct sensor_aec_i2c_tag *aec_info,
                                       cmr_u32 gain) {
 ...
 *============================================================================*/
static void
s5ks3p92_drv_write_frame_length(struct sensor_aec_i2c_tag *aec_info,
                                   cmr_u32 frame_len) {
  SENSOR_IC_CHECK_PTR_VOID(aec_info);
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void s5ks3p92_drv_write_shutter(struct sensor_aec_i2c_tag *aec_info,
                                          cmr_u32 shutter) {
  SENSOR_IC_CHECK_PTR_VOID(aec_info);
  cmr_u32 value = 0x00;
...
static void s5ks3p92_drv_calc_exposure(cmr_handle handle, cmr_u32 shutter,
  ...
  if (dest_fr_len != cur_fr_len) {
    ...
    s5ks3p92_drv_write_frame_length(aec_info, dest_fr_len);
  }
  sns_drv_cxt->sensor_ev_info.preview_shutter = shutter;
  s5ks3p92_drv_write_shutter(aec_info, shutter);
}

static void s5ks3p92_drv_calc_gain(cmr_handle handle, cmr_uint isp_gain,
                                      struct sensor_aec_i2c_tag *aec_info) {
  SENSOR_IC_CHECK_HANDLE_VOID(handle);
  struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
  ...
  s5ks3p92_drv_write_gain(aec_info, sensor_gain);
}
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int s5ks3p92_drv_power_on(cmr_handle handle, cmr_uint power_on) {
  ...
  BOOLEAN power_down = g_s5ks3p92_mipi_raw_info.power_down_level;
  BOOLEAN reset_level = g_s5ks3p92_mipi_raw_info.reset_pulse_level;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int s5ks3p92_drv_init_fps_info(cmr_handle handle) {
...
static cmr_int s5ks3p92_drv_get_pdaf_info(cmr_handle handle,
  ...
  pd_pos_is_right_size = NUMBER_OF_ARRAY(s5ks3p92_pd_is_right);
  pd_pos_row_size = NUMBER_OF_ARRAY(s5ks3p92_pd_row);
  pd_pos_col_size = NUMBER_OF_ARRAY(s5ks3p92_pd_col);
  ...
  pdaf_info->pd_is_right = (cmr_u16 *)s5ks3p92_pd_is_right;
  pdaf_info->pd_pos_row = (cmr_u16 *)s5ks3p92_pd_row;
  pdaf_info->pd_pos_col = (cmr_u16 *)s5ks3p92_pd_col;
...
static cmr_int s5ks3p92_drv_get_static_info(cmr_handle handle,
                                               uint32_t *param) {
  cmr_int rtn = SENSOR_SUCCESS;
  ...
  if (!fps_info->is_init) {
    s5ks3p92_drv_init_fps_info(handle);
  }
  ...
  ex_info->name = (cmr_s8 *)g_s5ks3p92_mipi_raw_info.name;
  ex_info->sensor_version_info =
      (cmr_s8 *)g_s5ks3p92_mipi_raw_info.sensor_version_info;
...
static cmr_int s5ks3p92_drv_get_fps_info(cmr_handle handle, cmr_u32 *param) {
  cmr_int rtn = SENSOR_SUCCESS;
...
static cmr_int s5k3p9sp04_drv_get_4in1_info(cmr_handle handle, cmr_u32 *param) {
    ...
    sn_4in1_info->limited_4in1_width = 2320;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int s5ks3p92_drv_access_val(cmr_handle handle, cmr_uint param) {
  ...
  SENSOR_LOGI("sensor s5ks3p92: param_ptr->type=%x", param_ptr->type);

  switch (param_ptr->type) {
  case SENSOR_VAL_TYPE_GET_STATIC_INFO:
    ret = s5ks3p92_drv_get_static_info(handle, param_ptr->pval);
    break;
  case SENSOR_VAL_TYPE_GET_FPS_INFO:
    ret = s5ks3p92_drv_get_fps_info(handle, param_ptr->pval);
    break;
  case SENSOR_VAL_TYPE_SET_SENSOR_CLOSE_FLAG:
    ret = sns_drv_cxt->is_sensor_close = 1;
    break;
  case SENSOR_VAL_TYPE_GET_PDAF_INFO:
    ret = s5ks3p92_drv_get_pdaf_info(handle, param_ptr->pval);
    break;
#if 1
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int s5ks3p92_drv_identify(cmr_handle handle, cmr_uint param) {
 ...
 *============================================================================*/
static cmr_int s5ks3p92_drv_before_snapshot(cmr_handle handle,
                                               cmr_uint param) {
  ...
  s5ks3p92_drv_calc_exposure(handle, cap_shutter, 0, capture_mode,
                                &s5ks3p92_aec_info);
  s5ks3p92_drv_write_reg2sensor(handle, s5ks3p92_aec_info.frame_length);
  s5ks3p92_drv_write_reg2sensor(handle, s5ks3p92_aec_info.shutter);

  sns_drv_cxt->sensor_ev_info.preview_gain = cap_gain;
  s5ks3p92_drv_write_gain(&s5ks3p92_aec_info, cap_gain);
  s5ks3p92_drv_write_reg2sensor(handle, s5ks3p92_aec_info.again);
  s5ks3p92_drv_write_reg2sensor(handle, s5ks3p92_aec_info.dgain);
 ...
 *============================================================================*/
static cmr_int s5ks3p92_drv_write_exposure(cmr_handle handle,
                                              cmr_uint param) {
  ...
  s5ks3p92_drv_calc_exposure(handle, exposure_line, dummy_line, size_index,
                                &s5ks3p92_aec_info);
  s5ks3p92_drv_write_reg2sensor(handle, s5ks3p92_aec_info.frame_length);
  s5ks3p92_drv_write_reg2sensor(handle, s5ks3p92_aec_info.shutter);
 ...
 * you can change this function if it's necessary
 *============================================================================*/
static cmr_int s5ks3p92_drv_write_gain_value(cmr_handle handle,
                                                cmr_uint param) {
  cmr_int ret_value = SENSOR_SUCCESS;
  ...
  s5ks3p92_drv_calc_gain(handle, param, &s5ks3p92_aec_info);
  s5ks3p92_drv_write_reg2sensor(handle, s5ks3p92_aec_info.again);
  s5ks3p92_drv_write_reg2sensor(handle, s5ks3p92_aec_info.dgain);
...
static cmr_int s5ks3p92_drv_read_aec_info(cmr_handle handle,
                                             cmr_uint param) {
  cmr_int ret_value = SENSOR_SUCCESS;
  ...
  info->aec_i2c_info_out = &s5ks3p92_aec_info;
  exposure_line = info->exp.exposure;
  dummy_line = info->exp.dummy;
  mode = info->exp.size_index;

  s5ks3p92_drv_calc_exposure(handle, exposure_line, dummy_line, mode,
                                &s5ks3p92_aec_info);
  s5ks3p92_drv_calc_gain(handle, info->gain, &s5ks3p92_aec_info);

  return ret_value;
}

static cmr_int s5ks3p92_drv_set_master_FrameSync(cmr_handle handle,
                                                    cmr_uint param) {
  SENSOR_IC_CHECK_HANDLE(handle);
  struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int s5ks3p92_drv_stream_on(cmr_handle handle, cmr_uint param) {
  SENSOR_IC_CHECK_HANDLE(handle);
  struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
...
s5ks3p92_drv_handle_create(struct sensor_ic_drv_init_para *init_param,
  ...
  sensor_ic_set_match_module_info(sns_drv_cxt,
                                  ...
                                  s_s5ks3p92_module_info_tab);
  sensor_ic_set_match_resolution_info(
      sns_drv_cxt, ARRAY_SIZE(s_s5ks3p92_resolution_tab_raw),
      s_s5ks3p92_resolution_tab_raw);
  sensor_ic_set_match_trim_info(sns_drv_cxt,
                                ARRAY_SIZE(s_s5ks3p92_resolution_trim_tab),
                                s_s5ks3p92_resolution_trim_tab);
  sensor_ic_set_match_static_info(sns_drv_cxt,
                                  ARRAY_SIZE(s_s5ks3p92_static_info),
                                  s_s5ks3p92_static_info);
  sensor_ic_set_match_fps_info(sns_drv_cxt,
                               ARRAY_SIZE(s_s5ks3p92_mode_fps_info),
                               s_s5ks3p92_mode_fps_info);
...
static cmr_int s5ks3p92_drv_handle_delete(cmr_handle handle, void *param) {
  cmr_int ret = SENSOR_SUCCESS;
...
static cmr_int s5ks3p92_drv_get_private_data(cmr_handle handle, cmr_uint cmd,
                                                void **param) {
  cmr_int ret = SENSOR_SUCCESS;
  SENSOR_IC_CHECK_HANDLE(handle);
  SENSOR_IC_CHECK_PTR(param);
 ...
 * .power = s5ks3p92_power_on,
 *============================================================================*/
static struct sensor_ic_ops s_s5ks3p92_ops_tab = {
    .create_handle = s5ks3p92_drv_handle_create,
    .delete_handle = s5ks3p92_drv_handle_delete,
    .get_data = s5ks3p92_drv_get_private_data,
    .power = s5ks3p92_drv_power_on,
    ...
    .ext_ops = {
            [SENSOR_IOCTL_BEFORE_SNAPSHOT].ops =
                s5ks3p92_drv_before_snapshot,
            [SENSOR_IOCTL_STREAM_ON].ops = s5ks3p92_drv_stream_on,
            [SENSOR_IOCTL_STREAM_OFF].ops = s5ks3p92_drv_stream_off,
            /* expand interface,if you want to add your sub cmd ,
             *  you can add it in enum {@SENSOR_IOCTL_VAL_TYPE}
             */
            [SENSOR_IOCTL_ACCESS_VAL].ops = s5ks3p92_drv_access_val,
    }};
