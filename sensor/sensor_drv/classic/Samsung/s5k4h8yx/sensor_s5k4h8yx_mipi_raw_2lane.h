...
#define SNAPSHOT_MIPI_PER_LANE_BPS 642 /* 2*Mipi clk */

/*line time unit: 1ns*/
#define VIDEO_LINE_TIME 13371
#define PREVIEW_LINE_TIME 13371
#define SNAPSHOT_LINE_TIME 26742
...
static const SENSOR_REG_T s5k4h8yx_preview_setting[] = {
    /*
    2x2 binning size
    1632x1224_30fps_vt140M_2lane_mipi642M
    width	1632
    height	1224
    frame rate	30.01
    mipi_lane_num	2
...
static struct sensor_res_tab_info s_s5k4h8yx_resolution_tab_raw[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
     .reg_tab = {{ADDR_AND_LEN_OF_ARRAY(s5k4h8yx_init_setting), PNULL, 0,
     ...
     .trim_info =
         {
           ...
           .line_time = VIDEO_LINE_TIME, .bps_per_lane =
           VIDEO_MIPI_PER_LANE_BPS,
