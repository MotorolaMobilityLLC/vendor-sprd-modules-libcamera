...
static const SENSOR_REG_T s5k5e8yx_preview_setting[] = {
    ...
    {0x323b, 0x02}, {0x3301, 0x00}, {0x3321, 0x04}, {0x3306, 0x00},
    {0x3307, 0x08}, {0x3308, 0x0A}, {0x3309, 0x27}, {0x330A, 0x01},
    {0x330B, 0x01}, {0x330E, 0x00}, {0x330F, 0x08}, {0x3310, 0x07},
    {0x3311, 0x9F}, {0x3312, 0x03}, {0x3313, 0x01},
    //{0x0100, 0x01},
    //{0x3C22, 0x00},
    //{0x3C22, 0x00},
    //{0x3C0D, 0x00},
...
static const SENSOR_REG_T s5k5e8yx_snapshot_setting[] = {
    ...
    {0x0344, 0x00}, {0x0345, 0x08}, {0x0346, 0x00}, {0x0347, 0x08},
    {0x0348, 0x0A}, {0x0349, 0x27}, {0x034A, 0x07}, {0x034B, 0x9F},
    {0x034C, 0x0A}, {0x034D, 0x20}, {0x034E, 0x07}, {0x034F, 0x98},
    ...
    {0x3307, 0x08}, {0x3308, 0x0A}, {0x3309, 0x27}, {0x330A, 0x01},
    {0x330B, 0x01}, {0x330E, 0x00}, {0x330F, 0x08}, {0x3310, 0x07},
    {0x3311, 0x9F}, {0x3312, 0x01}, {0x3313, 0x01},
    //{0x0100, 0x01},
    //{0x3C22, 0x00},
    //{0x3C22, 0x00},
    //{0x3C0D, 0x00},
