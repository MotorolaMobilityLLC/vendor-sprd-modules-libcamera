 ...
 * global variable
 *============================================================================*/
static cmr_u32 s_current_default_frame_length = PREVIEW_FRAME_LENGTH;
...
static cmr_u32 s_s5k5e8yx_sensor_close_flag = 0;
static cmr_u32 s_current_frame_length = 0;
static cmr_u32 s_current_default_line_time = 0;
 ...
 *
 *============================================================================*/
static cmr_u32 s5k5e8yx_get_default_frame_length(SENSOR_HW_HANDLE handle,
                                                 cmr_u32 mode) {
 ...
 *============================================================================*/
static cmr_u32 s5k5e8yx_init_mode_fps_info(SENSOR_HW_HANDLE handle) {
        ...
        for (i = 0; i < NUMBER_OF_ARRAY(s_s5k5e8yx_resolution_trim_tab); i++) {
            ...
            if (0 != tempfps) {
                ...
                if (s_s5k5e8yx_mode_fps_info.sensor_mode_fps[i].max_fps > 30) {
                    ...
                    s_s5k5e8yx_mode_fps_info.sensor_mode_fps[i]
                        .high_fps_skip_num =
            ...
            SENSOR_PRINT("mode %d,tempfps %d,frame_len %d,line_time: %d ", i,
                         tempfps, s_s5k5e8yx_resolution_trim_tab[i].frame_line,
...
static cmr_u32 s5k5e8yx_get_fps_info(SENSOR_HW_HANDLE handle, cmr_u32 *param) {
    cmr_u32 rtn = SENSOR_SUCCESS;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void s5k5e8yx_write_gain(SENSOR_HW_HANDLE handle, cmr_u32 gain) {
    ...
    if (gain < SENSOR_MAX_GAIN) {
        ...
        a_gain = SENSOR_MAX_GAIN;
        d_gain = 256.0 * gain / a_gain;
        SENSOR_PRINT("s5k5e8yx: real_gain:0x%x, a_gain: 0x%x, d_gain: 0x%x",
                     gain, a_gain, d_gain);
        if (d_gain > 256 * 2)
            d_gain = 256 * 2; // d_gain < 256x
    }
    /*again*/
    Sensor_WriteReg(0x204, (a_gain >> 8) & 0xff);
    Sensor_WriteReg(0x205, a_gain & 0xff);
    /*dgain*/
    Sensor_WriteReg(0x20e, d_gain);
    Sensor_WriteReg(0x210, d_gain);
    Sensor_WriteReg(0x212, d_gain);
    Sensor_WriteReg(0x214, d_gain);
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_u32 s5k5e8yx_read_shutter(SENSOR_HW_HANDLE handle) {
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void s5k5e8yx_write_shutter(SENSOR_HW_HANDLE handle, cmr_u32 shutter) {
...
static uint16_t s5k5e8yx_update_exposure(SENSOR_HW_HANDLE handle,
    ...
    cmr_u32 fr_len = s_current_default_frame_length;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_u32 s5k5e8yx_power_on(SENSOR_HW_HANDLE handle, cmr_u32 power_on) {
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_u32 s5k5e8yx_identify(SENSOR_HW_HANDLE handle, cmr_u32 param) {
 ...
 *============================================================================*/
static cmr_u32 s5k5e8yx_before_snapshot(SENSOR_HW_HANDLE handle,
                                        cmr_u32 param) {
 ...
 *============================================================================*/
static cmr_u32 s5k5e8yx_write_exposure(SENSOR_HW_HANDLE handle,
                                       unsigned long param) {
    ...
    frame_interval =
        (uint16_t)(((exposure_line + dummy_line) *
                    (s_s5k5e8yx_resolution_trim_tab[size_index].line_time)) /
                   1000000);

    SENSOR_PRINT("current mode = %d, exposure_line = %d, dummy_line=%d",
                 size_index, exposure_line, dummy_line);
    s_current_default_frame_length =
        s5k5e8yx_get_default_frame_length(handle, size_index);
 ...
 *============================================================================*/
static cmr_u32 isp_to_real_gain(SENSOR_HW_HANDLE handle, cmr_u32 param) {
    cmr_u32 real_gain = 0;
 ...
 * you can change this function if it's necessary
 *============================================================================*/
static cmr_u32 s5k5e8yx_write_gain_value(SENSOR_HW_HANDLE handle,
                                         cmr_u32 param) {
    cmr_u32 ret_value = SENSOR_SUCCESS;
    cmr_u32 real_gain = 0;
...
static cmr_u32 s5k5e8yx_get_static_info(SENSOR_HW_HANDLE handle,
                                        cmr_u32 *param) {
    cmr_u32 rtn = SENSOR_SUCCESS;
...
static cmr_u32 s5k5e8yx_set_sensor_close_flag(SENSOR_HW_HANDLE handle) {
    cmr_u32 rtn = SENSOR_SUCCESS;
 ...
 *============================================================================*/
static cmr_u32 s5k5e8yx_write_af(SENSOR_HW_HANDLE handle, cmr_u32 param) {
    SENSOR_PRINT("E");
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_u32 s5k5e8yx_stream_on(SENSOR_HW_HANDLE handle, cmr_u32 param) {
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_u32 s5k5e8yx_stream_off(SENSOR_HW_HANDLE handle, cmr_u32 param) {
...
static unsigned long s5k5e8yx_access_val(SENSOR_HW_HANDLE handle,
    ...
    case SENSOR_VAL_TYPE_WRITE_OTP:
        // rtn = _s5k5e8yx_write_otp(handle, (cmr_u32)param_ptr->pval);
        break;
...
static SENSOR_IOCTL_FUNC_TAB_T s_s5k5e8yx_ioctl_func_tab = {
    ...
    .ex_write_exp = s5k5e8yx_write_exposure,
