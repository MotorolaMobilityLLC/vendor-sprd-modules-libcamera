...
#define LOG_TAG "s5k5e8yx_mipi_raw"

#define MIPI_RAW_INFO g_s5k5e8yx_mipi_raw_info
#define RES_TRIM_TAB s_s5k5e8yx_resolution_trim_tab
#define FPS_INFO s_s5k5e8yx_mode_fps_info
#define STATIC_INFO s_s5k5e8yx_static_info
#define VIDEO_INFO s_s5k5e8yx_video_info
#define MODULE_INFO s_s5k5e8yx_module_info_tab
#define RES_TAB_RAW s_s5k5e8yx_resolution_tab_raw
 ...
 *
 *============================================================================*/
static cmr_int s5k5e8yx_drv_set_video_mode(cmr_handle handle, cmr_u32 param) {
 ...
 *============================================================================*/
static cmr_u32 s5k5e8yx_drv_init_fps_info(cmr_handle handle) {
...
static cmr_u32 s5k5e8yx_drv_get_static_info(cmr_handle handle, cmr_u32 *param) {
    cmr_u32 rtn = SENSOR_SUCCESS;
    ...
    if (!fps_info->is_init) {
        s5k5e8yx_drv_init_fps_info(handle);
    }
...
static cmr_u32 s5k5e8yx_drv_get_fps_info(cmr_handle handle, cmr_u32 *param) {
    cmr_u32 rtn = SENSOR_SUCCESS;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void s5k5e8yx_drv_group_hold_on(cmr_handle handle) {
    SENSOR_LOGI("E");
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void s5k5e8yx_drv_group_hold_off(cmr_handle handle) {
    SENSOR_LOGI("E");
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_u16 s5k5e8yx_drv_read_gain(cmr_handle handle) {
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void s5k5e8yx_drv_write_gain(cmr_handle handle, float gain) {
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_u16 s5k5e8yx_drv_read_frame_length(cmr_handle handle) {
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void s5k5e8yx_drv_write_frame_length(cmr_handle handle,
                                            cmr_u32 frame_len) {
    SENSOR_IC_CHECK_HANDLE_VOID(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_u32 s5k5e8yx_drv_read_shutter(cmr_handle handle) {
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void s5k5e8yx_drv_write_shutter(cmr_handle handle, cmr_u32 shutter) {
    SENSOR_IC_CHECK_HANDLE_VOID(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 *============================================================================*/
static cmr_u16 s5k5e8yx_drv_update_exposure(cmr_handle handle, cmr_u32 shutter,
                                            cmr_u32 dummy_line) {
    ...
    cur_fr_len = s5k5e8yx_drv_read_frame_length(handle);

    if (shutter < SENSOR_MIN_SHUTTER)
        shutter = SENSOR_MIN_SHUTTER;

    if (dest_fr_len != cur_fr_len)
        s5k5e8yx_drv_write_frame_length(handle, dest_fr_len);
write_sensor_shutter:
    /* write shutter to sensor registers */
    s5k5e8yx_drv_write_shutter(handle, shutter);
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int s5k5e8yx_drv_power_on(cmr_handle handle, cmr_uint power_on) {
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
    struct module_cfg_info *module_info = sns_drv_cxt->module_info;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int s5k5e8yx_drv_access_val(cmr_handle handle, unsigned long param) {
    cmr_int ret = SENSOR_FAIL;
    ...
    case SENSOR_VAL_TYPE_SHUTTER:
        *((cmr_u32 *)param_ptr->pval) = s5k5e8yx_drv_read_shutter(handle);
        break;
    case SENSOR_VAL_TYPE_READ_OTP_GAIN:
        *((cmr_u32 *)param_ptr->pval) = s5k5e8yx_drv_read_gain(handle);
        break;
    case SENSOR_VAL_TYPE_GET_STATIC_INFO:
        ret = s5k5e8yx_drv_get_static_info(handle, param_ptr->pval);
        break;
    case SENSOR_VAL_TYPE_GET_FPS_INFO:
        ret = s5k5e8yx_drv_get_fps_info(handle, param_ptr->pval);
        break;
    default:
        break;
    }
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int s5k5e8yx_drv_init_exif_info(cmr_handle handle,
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int s5k5e8yx_drv_identify(cmr_handle handle, cmr_uint param) {
    ...
    pid_value = hw_sensor_read_reg(sns_drv_cxt->hw_handle, S5K5E8YX_PID_ADDR);
    if (S5K5E8YX_PID_VALUE == pid_value) {
        ver_value =
            hw_sensor_read_reg(sns_drv_cxt->hw_handle, S5K5E8YX_VER_ADDR);
        SENSOR_LOGI("Identify: PID = %x, VER = %x", pid_value, ver_value);
        if (S5K5E8YX_VER_VALUE == ver_value) {
            SENSOR_LOGI("this is s5k5e8yx sensor");
            // s5k5e8yx_drv_init_exif_info();
 ...
 *============================================================================*/
static cmr_u32 s5k5e8yx_drv_before_snapshot(cmr_handle handle, cmr_uint param) {
 ...
 *============================================================================*/
static cmr_int s5k5e8yx_drv_write_exposure(cmr_handle handle, cmr_uint param) {
 ...
 * you can change this function if it's necessary
 *============================================================================*/
static cmr_int s5k5e8yx_drv_write_gain_value(cmr_handle handle, cmr_u32 param) {
    cmr_int ret_value = SENSOR_SUCCESS;
    float real_gain = 0;
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 *
 *============================================================================*/
static void s5k5e8yx_drv_increase_hdr_exposure(cmr_handle handle,
 ...
 *
 *============================================================================*/
static void s5k5e8yx_drv_decrease_hdr_exposure(cmr_handle handle,
                                               cmr_u8 ev_divisor) {
    ...
    if (gain_multiply >= ev_divisor) {
        s5k5e8yx_drv_update_exposure(handle, hdr_info->capture_shutter, 0);
        s5k5e8yx_drv_write_gain(handle, hdr_info->capture_gain / ev_divisor);

    } else {
        shutter = hdr_info->capture_shutter * gain_multiply / ev_divisor;
        s5k5e8yx_drv_update_exposure(handle, shutter, 0);
        s5k5e8yx_drv_write_gain(handle, hdr_info->capture_gain / gain_multiply);
    }
}
 ...
 * you can change this function if it's necessary
 *============================================================================*/
static cmr_int s5k5e8yx_drv_set_hdr_ev(cmr_handle handle, cmr_uint param) {
    ...
    case SENSOR_HDR_EV_LEVE_0:
        ev_divisor = 2;
        s5k5e8yx_drv_decrease_hdr_exposure(handle, ev_divisor);
        break;
    case SENSOR_HDR_EV_LEVE_1:
        ev_multiplier = 1;
        s5k5e8yx_drv_increase_hdr_exposure(handle, ev_multiplier);
        break;
 ...
 *sensor_drv_u.h
 *============================================================================*/
static cmr_int s5k5e8yx_drv_ext_func(cmr_handle handle, cmr_uint param) {
    ...
    switch (ext_ptr->cmd) {
    case SENSOR_EXT_EV:
        rtn = s5k5e8yx_drv_set_hdr_ev(handle, param);
        break;
    default:
        break;
    }
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int s5k5e8yx_drv_stream_on(cmr_handle handle, cmr_u32 param) {
    SENSOR_LOGI("E");
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int s5k5e8yx_stream_off(cmr_handle handle, cmr_u32 param) {
    SENSOR_LOGI("E");
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
...
static cmr_int
s5k5e8yx_drv_handle_create(struct sensor_ic_drv_init_para *init_param,
    ...
    s5k5e8yx_drv_init_exif_info(sns_drv_cxt, &sns_drv_cxt->exif_ptr);
...
static cmr_int s5k5e8yx_drv_handle_delete(cmr_handle handle, cmr_int *param) {
    cmr_int ret = SENSOR_SUCCESS;
...
static cmr_int s5k5e8yx_drv_get_private_data(cmr_handle handle, cmr_uint cmd,
                                             void **param) {
    cmr_int ret = SENSOR_SUCCESS;
    SENSOR_IC_CHECK_HANDLE(handle);
...
{
     return &g_s5k5e8yx_mipi_raw_info;
}
 ...
 * .power = s5k5e8yx_drv_power_on,
 *============================================================================*/
static struct sensor_ic_ops s5k5e8yx_ops_tab = {
    .create_handle = s5k5e8yx_drv_handle_create,
    .delete_handle = s5k5e8yx_drv_handle_delete,
    .get_data = s5k5e8yx_drv_get_private_data,

    .power = s5k5e8yx_drv_power_on,
    .identify = s5k5e8yx_drv_identify,
    .ex_write_exp = s5k5e8yx_drv_write_exposure,
    .write_gain_value = s5k5e8yx_drv_write_gain_value,

    .ext_ops = {
            [SENSOR_IOCTL_EXT_FUNC].ops = s5k5e8yx_drv_ext_func,
            [SENSOR_IOCTL_VIDEO_MODE].ops = s5k5e8yx_drv_set_video_mode,
            [SENSOR_IOCTL_BEFORE_SNAPSHOT].ops = s5k5e8yx_drv_before_snapshot,
            [SENSOR_IOCTL_STREAM_ON].ops = s5k5e8yx_drv_stream_on,
            [SENSOR_IOCTL_STREAM_OFF].ops = s5k5e8yx_stream_off,
            [SENSOR_IOCTL_ACCESS_VAL].ops = s5k5e8yx_drv_access_val,
    }};
