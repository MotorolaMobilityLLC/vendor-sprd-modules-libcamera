...
#include "sensor_imx258_raw_param_prv_2.c"
#include "sensor_imx258_raw_param_prv_3.c"
#include "sensor_imx258_raw_param_cap_0.c"
#include "sensor_imx258_raw_param_cap_1.c"
#include "sensor_imx258_raw_param_cap_2.c"
#include "sensor_imx258_raw_param_cap_3.c"
...
/* Capture Sizes:
	4208x3120,2104x1560,1280x720,1052x780,2096x1552,1048x776
*/
...
static struct sensor_raw_info s_imx258_mipi_raw_info=
{
	&s_imx258_version_info,
	{
		...
		{s_imx258_tune_info_prv_2, sizeof(s_imx258_tune_info_prv_2)},
		{s_imx258_tune_info_prv_3, sizeof(s_imx258_tune_info_prv_3)},
		{s_imx258_tune_info_cap_0, sizeof(s_imx258_tune_info_cap_0)},
		{s_imx258_tune_info_cap_1, sizeof(s_imx258_tune_info_cap_1)},
		{s_imx258_tune_info_cap_2, sizeof(s_imx258_tune_info_cap_2)},
		{s_imx258_tune_info_cap_3, sizeof(s_imx258_tune_info_cap_3)},
	...
	(struct sensor_libuse_info *)s_imx258_libuse_info,
	{
		...
		&s_imx258_fix_info_prv_2,
		&s_imx258_fix_info_prv_3,
		&s_imx258_fix_info_cap_0,
		&s_imx258_fix_info_cap_1,
		&s_imx258_fix_info_cap_2,
		&s_imx258_fix_info_cap_3,
	...
	},
	{
		...
		{s_imx258_prv_2_tool_ui_input, sizeof(s_imx258_prv_2_tool_ui_input)},
		{s_imx258_prv_3_tool_ui_input, sizeof(s_imx258_prv_3_tool_ui_input)},
		...
		{s_imx258_cap_2_tool_ui_input, sizeof(s_imx258_cap_2_tool_ui_input)},
		{s_imx258_cap_3_tool_ui_input, sizeof(s_imx258_cap_3_tool_ui_input)},
