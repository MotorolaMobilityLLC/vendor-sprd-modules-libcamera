    ...
    {.module_id = MODULE_SUNNY,
     .reg_tab =
         {{ADDR_AND_LEN_OF_ARRAY(imx586_init_setting), PNULL, 0, .width = 0,
          ...
          {ADDR_AND_LEN_OF_ARRAY(imx586_snapshot_setting), PNULL, 0,
