 ...
 * V2.0
 */
#ifndef _SENSOR_OV7251_dual_MIPI_RAW_H_
#define _SENSOR_OV7251_dual_MIPI_RAW_H_
...
#define VENDOR_NUM 1
#define ov7251_dual_CHIP_ID_H_ADDR 0x300A
#define ov7251_dual_CHIP_ID_H_VALUE 0x77
#define ov7251_dual_CHIP_ID_L_ADDR 0x300B
#define ov7251_dual_CHIP_ID_L_VALUE 0x50
...
/* frame length*/
#define PREVIEW_FRAME_LENGTH 522
...
static const SENSOR_REG_T ov7251_dual_init_setting[] = {
...
static const SENSOR_REG_T ov7251_dual_640x480_raw10_30fps_setting[] = {
    {0x3800, 0x00}, {0x3801, 0x04},// x addr start
    {0x3802, 0x00}, {0x3803, 0x04},// y addr start
    {0x3804, 0x02}, {0x3805, 0x8b},// x addr end
    {0x3806, 0x01}, {0x3807, 0xeb},// y addr end
...
static const SENSOR_REG_T ov7251_dual_640x480_raw10_20fps_slave_setting[] = {
#if 1
...
static struct sensor_res_tab_info s_ov7251_dual_resolution_tab_raw[VENDOR_NUM] = {
    {
        ...
        .reg_tab = {
            ...
            {
                ADDR_AND_LEN_OF_ARRAY(ov7251_dual_640x480_raw10_20fps_slave_setting),
                PNULL,
                0,
                .width = 640,
                .height = 480,
...
SENSOR_INFO_T g_ov7251_dual_mipi_raw_info = {
 ...
 //   .reset_pulse_level = SENSOR_LOW_PULSE_RESET,
    ...
    .identify_code = {
        {
            .reg_addr = ov7251_dual_CHIP_ID_H_ADDR,
            .reg_value = ov7251_dual_CHIP_ID_H_VALUE,
        },
        {
            .reg_addr = ov7251_dual_CHIP_ID_L_ADDR,
            .reg_value = ov7251_dual_CHIP_ID_L_VALUE,
        },
    },
    ...
    .module_info_tab = s_ov7251_dual_module_info_tab,
    .module_info_tab_size = ARRAY_SIZE(s_ov7251_dual_module_info_tab),

    .resolution_tab_info_ptr = s_ov7251_dual_resolution_tab_raw,
    .sns_ops = &s_ov7251_dual_ops_tab,
    .raw_info_ptr = &s_ov7251_dual_mipi_raw_info_ptr,

    .video_tab_info_ptr = NULL,
    .sensor_version_info = (cmr_s8 *)"ov7251_dualv1",
};
#endif
