...
#define LOG_TAG "ov8856_front"

#if defined(OV8856_FRONT_MIPI_4LANE)
#include "sensor_ov8856_front_mipi_raw_4lane.h"
#else
#include "sensor_ov8856_front_mipi_raw_2lane.h"
#endif
...
static cmr_int ov8856_drv_power_on(cmr_handle handle, cmr_uint power_on) {
    ...
    BOOLEAN power_down = g_ov8856_front_mipi_raw_info.power_down_level;
    BOOLEAN reset_level = g_ov8856_front_mipi_raw_info.reset_pulse_level;
...
static cmr_int ov8856_drv_get_static_info(cmr_handle handle, cmr_u32 *param) {
    ...
    ex_info->name = (cmr_s8 *)g_ov8856_front_mipi_raw_info.name;
    ex_info->sensor_version_info =
        (cmr_s8 *)g_ov8856_front_mipi_raw_info.sensor_version_info;
...
static cmr_int ov8856_drv_identify(cmr_handle handle, cmr_uint param) {
    ...
    if (ov8856_PID_VALUE == pid_value) {
        ...
        if (ov8856_VER_VALUE == ver_value) {
            ...
            SENSOR_LOGI("this is ov8856_front sensor");
...
{
     return &g_ov8856_front_mipi_raw_info;
}
/*==============================================================================
 * Description:
 * all ioctl functoins
