...
static struct sensor_raw_ioctrl s_ov13855_ioctrl = {0, 0, 0};

/************************************************************************/

static struct sensor_version_info s_ov13855_version_info = {
    0x00070005,
    {{0x32786D69, 0x00003835, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
...
static struct sensor_raw_info s_ov13855_mipi_raw_info = {
    ...
    {
        &s_ov13855_fix_info_common, &s_ov13855_fix_info_prv_0,
        &s_ov13855_fix_info_prv_1, NULL, NULL, &s_ov13855_fix_info_cap_0,
        &s_ov13855_fix_info_cap_1, NULL, NULL, &s_ov13855_fix_info_video_0,
        &s_ov13855_fix_info_video_1, NULL, NULL,
    },
    {
        {s_ov13855_common_tool_ui_input,
         sizeof(s_ov13855_common_tool_ui_input)},
        ...
        {NULL, 0},
        {NULL, 0},
        {s_ov13855_video_0_tool_ui_input,
         sizeof(s_ov13855_video_0_tool_ui_input)},
        {s_ov13855_video_1_tool_ui_input,
         sizeof(s_ov13855_video_1_tool_ui_input)},
        {NULL, 0},
        {NULL, 0},
    },
    {
        &s_ov13855_nr_scene_map_param, &s_ov13855_nr_level_number_map_param,
