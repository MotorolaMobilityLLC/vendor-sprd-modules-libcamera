...
#define PREVIEW_HEIGHT 1568  // 2008
...
static const SENSOR_REG_T ov13855_init_setting[] = {
    ...
    {0x3809, 0x70}, {0x380a, 0x0c}, {0x380b, 0x30}, {0x380c, 0x04},
...
static const SENSOR_REG_T ov13855_2112x1568_setting[] = {
    /*4Lane
       ...
       Output format Setting
           Address value*/
    //	{0x0100,0x00},
    {0x0303, 0x01}, {0x3501, 0x40}, {0x3662, 0x10}, {0x3714, 0x28},
    {0x3737, 0x08}, {0x3739, 0x20}, {0x37c2, 0x14}, {0x37e3, 0x08},
    {0x37e4, 0x34}, {0x37e6, 0x08}, {0x3800, 0x00}, {0x3801, 0x00},
    {0x3802, 0x00}, {0x3803, 0x08}, {0x3804, 0x10}, {0x3805, 0x9f},
    {0x3806, 0x0c}, {0x3807, 0x4f}, {0x3808, 0x08}, {0x3809, 0x40},
    {0x380a, 0x06}, {0x380b, 0x20}, {0x380c, 0x04}, {0x380d, 0x62},
    {0x380e, 0x06}, {0x380f, 0x48}, {0x3811, 0x08}, {0x3813, 0x02},
    {0x3814, 0x03}, {0x3816, 0x03}, {0x3820, 0xab}, {0x3826, 0x04},
    {0x3827, 0x90}, {0x3829, 0x07}, {0x4009, 0x0d}, {0x4050, 0x04},
    {0x4051, 0x0b}, {0x4837, 0x1c}, {0x4902, 0x01},
    // {0x0100,0x01},
};
...
static const SENSOR_REG_T ov13855_4224x3136_30fps_setting[] = {
    ...
    Output format Setting
        Address value*/
    //  {0x0100,0x00},
    {0x0303, 0x00}, {0x3501, 0x80}, {0x3662, 0x12}, {0x3714, 0x24},
    {0x3737, 0x04}, {0x3739, 0x12}, {0x37c2, 0x04}, {0x37e3, 0x04},
    {0x37e4, 0x26}, {0x37e6, 0x04}, {0x3800, 0x00}, {0x3801, 0x00},
    {0x3802, 0x00}, {0x3803, 0x08}, {0x3804, 0x10}, {0x3805, 0x9f},
    {0x3806, 0x0c}, {0x3807, 0x57}, {0x3808, 0x10}, {0x3809, 0x70},
    {0x380a, 0x0c}, {0x380b, 0x30}, {0x380c, 0x04}, {0x380d, 0x62},
    {0x380e, 0x0c}, {0x380f, 0x8e}, {0x3811, 0x10}, {0x3813, 0x08},
    {0x3814, 0x01}, {0x3816, 0x01}, {0x3820, 0xa8}, {0x3826, 0x11},
    {0x3827, 0x1c}, {0x3829, 0x03}, {0x4009, 0x0f}, {0x4050, 0x04},
    {0x4051, 0x0b}, {0x4837, 0x0e}, {0x4902, 0x01},
    //    {0x0100,0x01},
...
static const SENSOR_REG_T ov13855_4224x3136_15fps_setting[] = {
    ...
    Output format Setting
        Address value*/
    //    {0x0100,0x00},
    {0x0303, 0x01}, {0x3501, 0x80}, {0x3662, 0x12}, {0x3714, 0x24},
    {0x3737, 0x04}, {0x3739, 0x12}, {0x37c2, 0x04}, {0x37e3, 0x04},
    {0x37e4, 0x26}, {0x37e6, 0x04}, {0x3800, 0x00}, {0x3801, 0x00},
    {0x3802, 0x00}, {0x3803, 0x08}, {0x3804, 0x10}, {0x3805, 0x9f},
    {0x3806, 0x0c}, {0x3807, 0x57}, {0x3808, 0x10}, {0x3809, 0x70},
    {0x380a, 0x0c}, {0x380b, 0x30}, {0x380c, 0x08}, {0x380d, 0xc4},
    {0x380e, 0x0c}, {0x380f, 0x8e}, {0x3811, 0x10}, {0x3813, 0x08},
    {0x3814, 0x01}, {0x3816, 0x01}, {0x3820, 0xa8}, {0x3826, 0x11},
    {0x3827, 0x1c}, {0x3829, 0x03}, {0x4009, 0x0f}, {0x4050, 0x04},
    {0x4051, 0x0b}, {0x4837, 0x1c}, {0x4902, 0x01},
...
static const SENSOR_REG_T ov13855_1024x768_setting[] = {
    ...
    Output format Setting
        Address value*/
    //    {0x0100,0x00},
    {0x0303, 0x03}, {0x3501, 0x20}, {0x3662, 0x08}, {0x3714, 0x30},
    {0x3737, 0x08}, {0x3739, 0x20}, {0x37c2, 0x2c}, {0x37d9, 0x06},
    {0x37e3, 0x08}, {0x37e4, 0x34}, {0x37e6, 0x08}, {0x3800, 0x00},
    ...
    {0x380d, 0x62}, {0x380e, 0x03}, {0x380f, 0x24}, {0x3811, 0x04},
    {0x3813, 0x04}, {0x3814, 0x07}, {0x3816, 0x07}, {0x3820, 0xac},
    {0x3826, 0x04}, {0x3827, 0x48}, {0x3829, 0x03}, {0x4009, 0x05},
    {0x4050, 0x02}, {0x4051, 0x05}, {0x4837, 0x38}, {0x4902, 0x02},
    // {0x0100,0x01},
};
...
static const SENSOR_REG_T ov13855_1280x720_setting[] = {
    ...
    {0x0303, 0x01}, {0x3501, 0x40}, {0x3662, 0x10}, {0x3714, 0x28},
    {0x3737, 0x08}, {0x3739, 0x20}, {0x37c2, 0x14}, {0x37e3, 0x08},
    {0x37e4, 0x34}, {0x37e6, 0x08}, {0x3800, 0x03}, {0x3801, 0x30},
    {0x3802, 0x03}, {0x3803, 0x50}, {0x3804, 0x0d}, {0x3805, 0x6f},
    {0x3806, 0x09}, {0x3807, 0x0f}, {0x3808, 0x05}, {0x3809, 0x00},
    {0x380a, 0x02}, {0x380b, 0xd0}, {0x380c, 0x04}, {0x380d, 0x62},
    {0x380e, 0x06}, {0x380f, 0x48}, {0x3811, 0x08}, {0x3813, 0x08},
    {0x3814, 0x03}, {0x3816, 0x03}, {0x3820, 0xab}, {0x3826, 0x04},
    {0x3827, 0x90}, {0x3829, 0x07}, {0x4009, 0x0d}, {0x4050, 0x04},
    {0x4051, 0x0b}, {0x4837, 0x1c}, {0x4902, 0x01},
    //    {0x0100,0x01},
...
LOCAL SENSOR_TRIM_T s_ov13855_resolution_trim_tab[SENSOR_MODE_MAX] = {
    {/*init trim*/
     .trim_start_x = 0,
     .trim_start_y = 0,
     .trim_width = 0,
    ...
    {// fps 30 full size
     .trim_start_x = 0,
     .trim_start_y = 0,
     .trim_width = 4208,  // 4224,
     .trim_height = 3120, // 3136,
     .line_time = 10380,
     .bps_per_lane = 1080,
