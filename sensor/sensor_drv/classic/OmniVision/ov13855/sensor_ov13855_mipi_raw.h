...
//	{
//		.sensor_reg_tab_ptr = (SENSOR_REG_T*)ov13855_4224x3136_15fps_setting,
//		.reg_count          = NUMBER_OF_ARRAY(ov13855_4224x3136_15fps_setting),
//		.width              = 4208,// 4224,
//		.height             = 3120,//3136,
//		.xclk_to_sensor     = 24,
//		.image_format       = SENSOR_IMAGE_FORMAT_RAW,
...
LOCAL const SENSOR_REG_T s_ov13855_preview_size_video_tab[SENSOR_VIDEO_MODE_MAX][1] =
{
	{/*video mode 0: ?fps */
		{
			.reg_addr  = 0xffff,
...
LOCAL const SENSOR_REG_T s_ov13855_capture_size_video_tab[SENSOR_VIDEO_MODE_MAX][1] =
{
	{/*video mode 0: ?fps */
		{
			.reg_addr  = 0xffff,
...
SENSOR_INFO_T g_ov13855_mipi_raw_info =
{
	...
	*/
	...
	.identify_code      =
	{
		...
		{
			.reg_addr   = ov13855_VER_1_ADDR,
			.reg_value  = ov13855_VER_1_VALUE,
		}
