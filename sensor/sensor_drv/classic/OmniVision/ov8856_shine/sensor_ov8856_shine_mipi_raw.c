...
static cmr_s64 ov8856_drv_get_shutter_skew(cmr_handle handle, cmr_u32 *param) {
    cmr_int rtn = SENSOR_SUCCESS;
    cmr_u16 height = 0;
    cmr_u32 line_time = 0;
    ...
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
    height = s_ov8856_resolution_tab_raw[0].reg_tab[shutter_skew_info->sns_mode].height;
