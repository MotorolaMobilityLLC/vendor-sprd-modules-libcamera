...
#define LOG_TAG "ov8856_shine_2lane"
#include <utils/Log.h>
#include "sensor.h"
...
//#endif
//#define IMAGE_HV_MIRROR IMAGE_NORMAL_MIRROR IMAGE_H_MIRROR IMAGE_V_MIRROR
...
static const SENSOR_REG_T ov8856_init_setting[] = {
    ...
    {0x3010, 0x00}, {0x3015, 0x84}, {0x3018, 0x32}, {0x3021, 0x23},
    {0x3033, 0x24}, {0x3500, 0x00}, {0x3501, 0x4c}, {0x3502, 0xe0},
    {0x3503, 0x78}, {0x3505, 0x83}, {0x3508, 0x01}, {0x3509, 0x80},
...
static const SENSOR_REG_T ov8856_preview_setting[] = {
    ...
    ob_value @ max_gain  =  64 @ 15.5
    bayer pattern=BGGR*/
    {0x0100, 0x00}, {0x0300, 0x04}, {0x0302, 0x61}, {0x3501, 0x4c},
    {0x3502, 0xe0}, {0x366e, 0x08}, {0x3714, 0x27}, {0x37c2, 0x14},
    {0x3801, 0x00}, {0x3802, 0x00}, {0x3803, 0x0c}, {0x3804, 0x0c},
    {0x3805, 0xdf}, {0x3806, 0x09}, {0x3807, 0xa3}, {0x3808, 0x06},
    {0x3809, 0x60}, {0x380a, 0x04}, {0x380b, 0xc8}, {0x380c, 0x0f},
    {0x380d, 0x18}, {0x380e, 0x04}, {0x380f, 0xde}, {0x3811, 0x08},
    {0x3813, 0x02}, {0x3814, 0x03}, {0x3820, 0x90}, {0x3821, 0x67},
    {0x382a, 0x03}, {0x4009, 0x05}, {0x4837, 0x14}, {0x5795, 0x00},
    {0x5796, 0x10}, {0x5797, 0x10}, {0x5798, 0x73}, {0x5799, 0x73},
    {0x579b, 0x28}, {0x579d, 0x16}, {0x579e, 0x06}, {0x579f, 0x20},
    {0x57a0, 0x04}, {0x57a1, 0xa0},
    ...
    {0x3820, 0x96}, {0x3821, 0x67}, {0x502e, 0x00}, {0x5001, 0x0e},
    {0x5004, 0x04}, {0x376b, 0x36},
#endif
#ifdef IMAGE_HV_MIRROR
    {0x3820, 0xd6}, {0x3821, 0x21}, {0x502e, 0x00}, {0x5001, 0x0e},
...
static const SENSOR_REG_T ov8856_snapshot_setting[] = {
    ...
    fps = 30
    line_time = 1932/144000000  s
    min_line = 6
    ob_value = 64
    ob_value @ max_gain  =  64 @ 15.5
    bayer pattern=BGGR*/
    {0x0100, 0x00}, {0x0300, 0x00}, {0x0302, 0x35}, {0x3501, 0x9a},
    {0x3502, 0x20}, {0x366e, 0x10}, {0x3714, 0x23}, {0x37c2, 0x04},
    {0x3801, 0x00}, {0x3802, 0x00}, {0x3803, 0x0c}, {0x3804, 0x0c},
    {0x3805, 0xdf}, {0x3806, 0x09}, {0x3807, 0xa3}, {0x3808, 0x0c},
    {0x3809, 0xc0}, {0x380a, 0x09}, {0x380b, 0x90}, {0x380c, 0x07},
    {0x380d, 0x8c}, {0x380e, 0x09}, {0x380f, 0xc0}, {0x3811, 0x10},
    {0x3813, 0x04}, {0x3814, 0x01}, {0x3820, 0x80}, {0x3821, 0x46},
    {0x382a, 0x01}, {0x4009, 0x0b}, {0x4837, 0x0c}, {0x5795, 0x02},
    {0x5796, 0x20}, {0x5797, 0x20}, {0x5798, 0xd5}, {0x5799, 0xd5},
    {0x579b, 0x50}, {0x579d, 0x2c}, {0x579e, 0x0c}, {0x579f, 0x40},
    {0x57a0, 0x09}, {0x57a1, 0x40},
#ifdef IMAGE_NORMAL_MIRROR
...
#endif
#ifdef IMAGE_V_MIRROR
    {0x3820, 0x86}, {0x3821, 0x46}, {0x502e, 0x00}, {0x5001, 0x0e},
    {0x5004, 0x04}, {0x376b, 0x36},
#endif
#ifdef IMAGE_HV_MIRROR
    {0x3820, 0xc6}, {0x3821, 0x00}, {0x502e, 0x00}, {0x5001, 0x0e},
    {0x5004, 0x00}, {0x376b, 0x36},
#endif
...
static const SENSOR_REG_T ov8856_video_setting[] = {
    ...
    ob_value @ max_gain  =  64 @ 15.5
    bayer pattern=BGGR*/
    {0x0100, 0x00}, {0x0300, 0x04}, {0x0302, 0x61}, {0x3501, 0x32},
    {0x3502, 0xc0}, {0x366e, 0x08}, {0x3714, 0x27}, {0x37c2, 0x14},
    {0x3801, 0xe0}, {0x3802, 0x01}, {0x3803, 0xbc}, {0x3804, 0x0b},
    {0x3805, 0xff}, {0x3806, 0x07}, {0x3807, 0xf3}, {0x3808, 0x05},
    {0x3809, 0x00}, {0x380a, 0x02}, {0x380b, 0xd0}, {0x380c, 0x07},
    {0x380d, 0x8c}, {0x380e, 0x03}, {0x380f, 0x3c}, {0x3811, 0x48},
    {0x3813, 0x26}, {0x3814, 0x03}, {0x3820, 0x90}, {0x3821, 0x67},
    {0x382a, 0x03}, {0x4009, 0x05}, {0x4837, 0x14}, {0x5795, 0x00},
    {0x5796, 0x10}, {0x5797, 0x10}, {0x5798, 0x73}, {0x5799, 0x73},
    {0x579b, 0x00}, {0x579d, 0x00}, {0x579e, 0x05}, {0x579f, 0xa0},
    {0x57a0, 0x03}, {0x57a1, 0x20},
#ifdef IMAGE_NORMAL_MIRROR
    {0x3820, 0x90}, {0x3821, 0x67}, {0x502e, 0x03}, {0x5001, 0x0a},
    {0x5004, 0x04}, {0x376b, 0x30},
#endif
