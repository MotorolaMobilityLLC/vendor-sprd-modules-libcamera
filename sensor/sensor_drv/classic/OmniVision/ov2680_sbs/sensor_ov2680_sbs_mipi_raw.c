...
*
*/
#define LOG_TAG "ov2680_sbs_mipi_raw"
#include "sensor_ov2680_sbs_mipi_raw.h"
...
#define MIPI_RAW_INFO g_ov2680_sbs_mipi_raw_info
 ...
 *============================================================================*/
static void ov2680_drv_group_hold_on(cmr_handle handle) { SENSOR_LOGI("E"); }
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void ov2680_drv_group_hold_off(cmr_handle handle) { SENSOR_LOGI("E"); }
