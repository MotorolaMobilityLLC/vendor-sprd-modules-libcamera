...
#define SNAPSHOT_MIPI_PER_LANE_BPS 738 // 900 /* 2*Mipi clk */ // 738
#define PREVIEW_MIPI_PER_LANE_BPS 738  // 900 /* 2*Mipi clk */  // 738
...
#define PREVIEW_FRAME_LENGTH 1600 // 2000
...
static const SENSOR_REG_T ov5675_init_setting[] = {
    {0x0100, 0x00}, {0x0103, 0x01}, {0x0300, 0x05},
    {0x0302, 0x7b}, {0x0303, 0x00}, {0x030b, 0x01},
    {0x030d, 0x24}, {0x3002, 0x21}, // 0x23->0x01
    {0x3107, 0x23}, {0x3501, 0x20}, {0x3503, 0x78},
    {0x3508, 0x03}, {0x3509, 0x00}, {0x3600, 0x66},
    {0x3601, 0x40}, {0x3602, 0x30}, {0x3610, 0xa5},
    {0x3612, 0x93}, {0x3620, 0x80}, {0x3642, 0x0e},
    {0x3661, 0x00}, {0x3662, 0x10}, {0x3664, 0xf3},
    {0x3665, 0x9e}, {0x3667, 0xa5}, {0x366e, 0x55},
    {0x366f, 0x55}, {0x3670, 0x11}, {0x3671, 0x11},
    {0x3672, 0x11}, {0x3673, 0x11}, {0x3714, 0x24},
    {0x371a, 0x3e}, {0x3733, 0x10}, {0x3734, 0x00},
    {0x373d, 0x24}, {0x3764, 0x20}, {0x3765, 0x20},
    {0x3766, 0x12}, {0x37a1, 0x14}, {0x37a8, 0x1c},
    {0x37ab, 0x0f}, {0x37c2, 0x04}, {0x37cb, 0x00},
    {0x37cc, 0x00}, {0x37cd, 0x00}, {0x37ce, 0x00},
    {0x37d8, 0x02}, {0x37d9, 0x08}, {0x37dc, 0x04},
    {0x3800, 0x00}, {0x3801, 0x00}, {0x3802, 0x00},
    {0x3803, 0x04}, {0x3804, 0x0a}, {0x3805, 0x3f},
    {0x3806, 0x07}, {0x3807, 0xb3}, {0x3808, 0x0a},
    {0x3809, 0x20}, {0x380a, 0x07}, {0x380b, 0x98},
    {0x380c, 0x02}, {0x380d, 0xee}, {0x380e, 0x07},
    {0x380f, 0xd0}, {0x3811, 0x10}, {0x3813, 0x0c},
    {0x3814, 0x01}, {0x3815, 0x01}, {0x3816, 0x01},
    {0x3817, 0x01}, {0x381e, 0x02}, {0x3820, 0x88},
    {0x3821, 0x01}, {0x3832, 0x48}, {0x3c80, 0x01},
    {0x3c82, 0x00}, {0x3c83, 0xc8}, {0x3c8c, 0x0f},
    {0x3c8d, 0xa0}, {0x3c90, 0x00}, {0x3c91, 0x00},
    {0x3c92, 0x00}, {0x3c93, 0x00}, {0x3c94, 0xd0},
    {0x3c95, 0x50}, {0x3c96, 0x35}, {0x3c97, 0x00},
    {0x4001, 0xe0}, {0x4008, 0x02}, {0x4009, 0x0d},
    {0x400f, 0x80}, {0x4013, 0x02}, {0x4040, 0x00},
    {0x4041, 0x07}, {0x404c, 0x50}, {0x404e, 0x20},
    {0x4500, 0x06}, {0x4503, 0x00}, {0x450a, 0x04},
    {0x4809, 0x04}, {0x480c, 0x12}, {0x4819, 0x70},
    {0x4825, 0x32}, {0x4826, 0x32}, {0x482a, 0x06},
    {0x4833, 0x08}, {0x4837, 0x15}, {0x5000, 0x77},
    {0x5b00, 0x01}, {0x5b01, 0x10}, {0x5b02, 0x01},
    {0x5b03, 0xdb}, {0x5b05, 0x6c}, {0x5e10, 0xfc},
    {0x5780, 0x3e}, {0x5781, 0x0f}, {0x5782, 0x44},
    {0x5783, 0x02}, {0x5784, 0x01}, {0x5785, 0x01},
    {0x5786, 0x00}, {0x5787, 0x04}, {0x5788, 0x02},
    {0x5789, 0x0f}, {0x578a, 0xfd}, {0x578b, 0xf5},
    {0x578c, 0xf5}, {0x578d, 0x03}, {0x578e, 0x08},
    {0x578f, 0x0c}, {0x5790, 0x08}, {0x5791, 0x06},
    {0x5792, 0x00}, {0x5793, 0x52}, {0x5794, 0xa3},
    {0x4003, 0x40}, {0x0100, 0x01},
};

static const SENSOR_REG_T ov5675_preview_setting1[] = {
    //@@ 1296x972_30FPS_MIPI_2_LANE_738Mbps
    // Frame length = 0x2ee = 750
    // Line time = 16.667 us
    /* Common setting */
...
static const SENSOR_REG_T ov5675_preview_setting[] = {
    ...
    // Line time = 20.833 us
    // {0x0100, 0x00},
    {0x0300, 0x05}, {0x0302, 0x7b}, {0x0303, 0x00}, {0x030b, 0x01},
    {0x030d, 0x24}, {0x3002, 0x21}, {0x3107, 0x23}, {0x3501, 0x20},
    {0x3503, 0x78}, {0x3508, 0x03}, {0x3509, 0x00}, {0x3600, 0x66},
    {0x3601, 0x41}, {0x3602, 0x30}, {0x3610, 0xa5}, {0x3612, 0x93},
    {0x3620, 0x80}, {0x3642, 0x0e}, {0x3661, 0x00}, {0x3662, 0x08},
    {0x3664, 0xf3}, {0x3665, 0x9e}, {0x3667, 0xa5}, {0x366e, 0x55},
    ...
    {0x3804, 0x0a}, {0x3805, 0x3f}, {0x3806, 0x07}, {0x3807, 0xb7},
    {0x3808, 0x05}, {0x3809, 0x10}, {0x380a, 0x03}, {0x380b, 0xcc},
    {0x380c, 0x02}, {0x380d, 0xee}, {0x380e, 0x06}, {0x380f, 0x40},
    {0x3811, 0x08}, {0x3813, 0x08}, {0x3814, 0x03}, {0x3815, 0x01},
    {0x3816, 0x03}, {0x3817, 0x01}, {0x381e, 0x02}, {0x3820, 0x8b},
    {0x3821, 0x01}, {0x3832, 0x48}, {0x3c80, 0x01}, {0x3c82, 0x00},
    {0x3c83, 0xc8}, {0x3c8c, 0x0f}, {0x3c8d, 0xa0}, {0x3c90, 0x00},
    {0x3c91, 0x00}, {0x3c92, 0x00}, {0x3c93, 0x00}, {0x3c94, 0xd0},
    {0x3c95, 0x50}, {0x3c96, 0x35}, {0x3c97, 0x00}, {0x4001, 0xe0},
    {0x4003, 0x40}, {0x4008, 0x00}, {0x4009, 0x07}, {0x400f, 0x80},
    {0x4013, 0x02}, {0x4040, 0x00}, {0x4041, 0x03}, {0x404c, 0x50},
...
static const SENSOR_REG_T ov5675_snapshot_setting[] = {
    ...
    // Frame length = 0x2ee = 750
    // Line time = 20.833 us
    {0x0103, 0x01}, {0x0300, 0x05}, {0x0302, 0x7b}, {0x0303, 0x00},
    {0x030b, 0x01}, {0x030d, 0x24}, {0x3002, 0x21}, {0x3107, 0x23},
    {0x3501, 0x20}, {0x3503, 0x78}, {0x3508, 0x03}, {0x3509, 0x00},
    {0x3600, 0x66}, {0x3601, 0x40}, {0x3602, 0x30}, {0x3610, 0xa5},
    {0x3612, 0x93}, {0x3620, 0x80}, {0x3642, 0x0e}, {0x3661, 0x00},
    {0x3662, 0x10}, {0x3664, 0xf3}, {0x3665, 0x9e}, {0x3667, 0xa5},
    {0x366e, 0x55}, {0x366f, 0x55}, {0x3670, 0x11}, {0x3671, 0x11},
    {0x3672, 0x11}, {0x3673, 0x11}, {0x3714, 0x24}, {0x371a, 0x3e},
    {0x3733, 0x10}, {0x3734, 0x00}, {0x373d, 0x24}, {0x3764, 0x20},
    {0x3765, 0x20}, {0x3766, 0x12}, {0x37a1, 0x14}, {0x37a8, 0x1c},
    {0x37ab, 0x0f}, {0x37c2, 0x04}, {0x37cb, 0x00}, {0x37cc, 0x00},
    {0x37cd, 0x00}, {0x37ce, 0x00}, {0x37d8, 0x02}, {0x37d9, 0x08},
    {0x37dc, 0x04}, {0x3800, 0x00}, {0x3801, 0x00}, {0x3802, 0x00},
    ...
    {0x3815, 0x01}, {0x3816, 0x01}, {0x3817, 0x01}, {0x381e, 0x02},
    {0x3820, 0x88}, {0x3821, 0x01}, {0x3832, 0x48}, {0x3c80, 0x01},
    {0x3c82, 0x00}, {0x3c83, 0xc8}, {0x3c8c, 0x0f}, {0x3c8d, 0xa0},
    {0x3c90, 0x00}, {0x3c91, 0x00}, {0x3c92, 0x00}, {0x3c93, 0x00},
    {0x3c94, 0xd0}, {0x3c95, 0x50}, {0x3c96, 0x35}, {0x3c97, 0x00},
    {0x4001, 0xe0}, {0x4008, 0x02}, {0x4009, 0x0d}, {0x400f, 0x80},
    {0x4013, 0x02}, {0x4040, 0x00}, {0x4041, 0x07}, {0x404c, 0x50},
    {0x404e, 0x20}, {0x4500, 0x06}, {0x4503, 0x00}, {0x450a, 0x04},
    {0x4809, 0x04}, {0x480c, 0x12}, {0x4819, 0x70}, {0x4825, 0x32},
    {0x4826, 0x32}, {0x482a, 0x06}, {0x4833, 0x08}, {0x4837, 0x15},
    {0x5000, 0x77}, {0x5b00, 0x01}, {0x5b01, 0x10}, {0x5b02, 0x01},
