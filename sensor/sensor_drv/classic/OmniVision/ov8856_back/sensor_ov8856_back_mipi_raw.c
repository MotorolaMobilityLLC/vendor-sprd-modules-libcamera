...
#define LOG_TAG "ov8856_back"

#if defined(OV8856_SHINE_MIPI_4LANE)
#include "sensor_ov8856_back_mipi_raw_4lane.h"
#else
#include "sensor_ov8856_back_mipi_raw_2lane.h"
#endif
...
static cmr_int ov8856_drv_power_on(cmr_handle handle, cmr_uint power_on) {
    ...
    BOOLEAN power_down = g_ov8856_back_mipi_raw_info.power_down_level;
    BOOLEAN reset_level = g_ov8856_back_mipi_raw_info.reset_pulse_level;
...
static cmr_int ov8856_drv_get_static_info(cmr_handle handle, cmr_u32 *param) {
    ...
    ex_info->name = (cmr_s8 *)g_ov8856_back_mipi_raw_info.name;
    ex_info->sensor_version_info =
        (cmr_s8 *)g_ov8856_back_mipi_raw_info.sensor_version_info;
...
{
     return &g_ov8856_back_mipi_raw_info;
}
/*==============================================================================
 * Description:
 * all ioctl functoins
