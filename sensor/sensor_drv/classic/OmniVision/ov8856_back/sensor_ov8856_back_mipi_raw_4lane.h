...
#ifndef _SENSOR_ov8856_BACK_MIPI_RAW_H_
#define _SENSOR_ov8856_BACK_MIPI_RAW_H_

#define LOG_TAG "ov8856_back_4lane"
#include <utils/Log.h>
#include "sensor.h"
...
#include "sensor_ov8856_back_otp.h"

#define VENDOR_NUM 1
#define SENSOR_NAME "ov8856_back"
...
#define VIDEO_MIPI_PER_LANE_BPS 770    /* 2*Mipi clk */
#define PREVIEW_MIPI_PER_LANE_BPS 770  /* 2*Mipi clk */
#define SNAPSHOT_MIPI_PER_LANE_BPS 770 /* 2*Mipi clk */
...
#define PREVIEW_FRAME_LENGTH 1242
#define SNAPSHOT_FRAME_LENGTH 2484
...
struct sensor_raw_info *s_ov8856_back_mipi_raw_info_ptr = PNULL;
 ...
 *============================================================================*/
SENSOR_INFO_T g_ov8856_back_mipi_raw_info = {
    ...
    .raw_info_ptr = &s_ov8856_back_mipi_raw_info_ptr,

    .video_tab_info_ptr = NULL,
    .sensor_version_info = (cmr_s8 *)"ov8856_back",
};
