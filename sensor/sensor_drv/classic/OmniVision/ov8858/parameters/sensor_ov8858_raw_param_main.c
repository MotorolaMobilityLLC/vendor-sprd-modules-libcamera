...
#include "sensor_ov8858_raw_param_prv_1.c"
#include "sensor_ov8858_raw_param_cap_0.c"
#include "sensor_ov8858_raw_param_cap_1.c"
#include "sensor_ov8858_raw_param_video_0.c"
#include "sensor_ov8858_raw_param_video_1.c"
...
static struct sensor_raw_info s_ov8858_mipi_raw_info=
{
	&s_ov8858_version_info,
	{
		...
		{s_ov8858_tune_info_prv_1, sizeof(s_ov8858_tune_info_prv_1)},
		{NULL, 0},
		{NULL, 0},
		{s_ov8858_tune_info_cap_0, sizeof(s_ov8858_tune_info_cap_0)},
		{s_ov8858_tune_info_cap_1, sizeof(s_ov8858_tune_info_cap_1)},
		{NULL, 0},
		{NULL, 0},
		{s_ov8858_tune_info_video_0, sizeof(s_ov8858_tune_info_video_0)},
		{s_ov8858_tune_info_video_1, sizeof(s_ov8858_tune_info_video_1)},
		{NULL, 0},
		{NULL, 0},
	},
	&s_ov8858_trim_info,
	...
	(struct sensor_libuse_info *)s_ov8858_libuse_info,
	{
		...
		&s_ov8858_fix_info_prv_1,
		NULL,
		NULL,
		&s_ov8858_fix_info_cap_0,
		&s_ov8858_fix_info_cap_1,
		NULL,
		NULL,
		&s_ov8858_fix_info_video_0,
		&s_ov8858_fix_info_video_1,
		NULL,
		NULL,
	},
	{
		...
		{s_ov8858_prv_1_tool_ui_input, sizeof(s_ov8858_prv_1_tool_ui_input)},
		{NULL, 0},
		{NULL, 0},
		{s_ov8858_cap_0_tool_ui_input, sizeof(s_ov8858_cap_0_tool_ui_input)},
		{s_ov8858_cap_1_tool_ui_input, sizeof(s_ov8858_cap_1_tool_ui_input)},
		{NULL, 0},
		{NULL, 0},
		{s_ov8858_video_0_tool_ui_input, sizeof(s_ov8858_video_0_tool_ui_input)},
		{s_ov8858_video_1_tool_ui_input, sizeof(s_ov8858_video_1_tool_ui_input)},
		{NULL, 0},
		{NULL, 0},
	},
	{
		&s_ov8858_nr_scene_map_param,
		&s_ov8858_nr_level_number_map_param,
		&s_ov8858_default_nr_level_map_param,
	},
};
