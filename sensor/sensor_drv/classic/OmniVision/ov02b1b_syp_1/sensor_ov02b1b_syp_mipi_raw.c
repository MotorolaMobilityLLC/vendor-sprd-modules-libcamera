...
static cmr_int ov02b1b_syp_drv_identify(cmr_handle handle, cmr_uint param)
{
    ...
    if (OV02B1B_SYP_PID_VALUE == pid_value) {
        ...
        if ((OV02B1B_SYP_VER_VALUE == ver_value) && (0x5357 == mid_value)) {
            SENSOR_LOGI("this is ov02b1b_syp_sun sensor");
            sensor_rid_save_sensor_name(SENSOR_HWINFOR_BACKAUX_CAM_NAME, "2_ov02b1b_syp_1");
