...
#ifndef _SENSOR_sp0a09z_MIPI_RAW_H_
#define _SENSOR_sp0a09z_MIPI_RAW_H_
...
#include "parameters/sensor_sp0a09z_raw_param_main.c"

//#define FEATURE_OTP

#define VENDOR_NUM 1
#define SENSOR_NAME				"sp0a09z_mipi_raw"
#define I2C_SLAVE_ADDR			0x42    /* 8bit slave address*/

#define sp0a09z_PID_ADDR				0xa0
#define sp0a09z_PID_VALUE			0x0a
#define sp0a09z_VER_ADDR				0xb0
#define sp0a09z_VER_VALUE			0x09
...
static const SENSOR_REG_T sp0a09z_init_setting[] = {
	{0xfd,0x00},
	{0x0b,0x2c},
	{0x0c,0x00}, 
	{0x0f,0x3f},
...
static const SENSOR_REG_T sp0a09z_preview_setting[] = {

};

static const SENSOR_REG_T sp0a09z_snapshot_setting[] = {

};



static struct sensor_res_tab_info s_sp0a09z_resolution_tab_raw[VENDOR_NUM] = {
	{
      .module_id = MODULE_SUNNY,
      .reg_tab = {
        {ADDR_AND_LEN_OF_ARRAY(sp0a09z_init_setting), PNULL, 0,
        .width = 0, .height = 0,
        .xclk_to_sensor = EX_MCLK, .image_format = SENSOR_IMAGE_FORMAT_RAW},
		/*
        {ADDR_AND_LEN_OF_ARRAY(sp0a09z_preview_setting), PNULL, 0,
        .width = PREVIEW_WIDTH, .height = PREVIEW_HEIGHT,
        .xclk_to_sensor = EX_MCLK, .image_format = SENSOR_IMAGE_FORMAT_RAW},*/

        {ADDR_AND_LEN_OF_ARRAY(sp0a09z_snapshot_setting), PNULL, 0,
...
static SENSOR_TRIM_T s_sp0a09z_resolution_trim_tab[VENDOR_NUM] = {
	{
     .module_id = MODULE_SUNNY,
     .trim_info = {
...
static SENSOR_REG_T sp0a09z_shutter_reg[] = {
    {0xfd, 0x01}, 
    {0x03, 0x01}, 
    {0x04, 0x73}, 
};
...
static struct sensor_i2c_reg_tab sp0a09z_shutter_tab = {
    .settings = sp0a09z_shutter_reg, 
	.size = ARRAY_SIZE(sp0a09z_shutter_reg),
};

static SENSOR_REG_T sp0a09z_again_reg[] = {
	{0xfd, 0x00}, 
	{0x24, 0x28}, 
	{0x01, 0x01}, 
};
...
static struct sensor_i2c_reg_tab sp0a09z_again_tab = {
    .settings = sp0a09z_again_reg, 
	.size = ARRAY_SIZE(sp0a09z_again_reg),
};

static SENSOR_REG_T sp0a09z_dgain_reg[] = {
   
};

static struct sensor_i2c_reg_tab sp0a09z_dgain_tab = {
    .settings = sp0a09z_dgain_reg, 
	.size = ARRAY_SIZE(sp0a09z_dgain_reg),
};

static SENSOR_REG_T sp0a09z_frame_length_reg[] = {
...
static SENSOR_STATIC_INFO_T s_sp0a09z_static_info[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
     .static_info = {
        .f_num = 200,
        .focal_length = 354,
...
static SENSOR_MODE_FPS_INFO_T s_sp0a09z_mode_fps_info[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
       {.is_init = 0,
...
static struct sensor_module_info s_sp0a09z_module_info_tab[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
     .module_info = {
...
struct sensor_raw_info *s_sp0a09z_mipi_raw_info_ptr = &s_sp0a09z_mipi_raw_info;
 ...
 *============================================================================*/
SENSOR_INFO_T g_sp0a09z_mipi_raw_info = {
    ...
    .identify_count = 1,
    .identify_code =
        {{ .reg_addr = sp0a09z_PID_ADDR, .reg_value = sp0a09z_PID_VALUE},
         { .reg_addr = sp0a09z_VER_ADDR, .reg_value = sp0a09z_VER_VALUE}},
    ...
    .module_info_tab = s_sp0a09z_module_info_tab,
    .module_info_tab_size = ARRAY_SIZE(s_sp0a09z_module_info_tab),

    .resolution_tab_info_ptr = s_sp0a09z_resolution_tab_raw,
    .sns_ops = &s_sp0a09z_ops_tab,
    .raw_info_ptr = &s_sp0a09z_mipi_raw_info_ptr,

    .video_tab_info_ptr = NULL,
    .sensor_version_info = (cmr_s8 *)"sp0a09z_v1",
};
