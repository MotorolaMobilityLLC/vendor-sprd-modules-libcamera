...
static void sp5508_drv_write_reg2sensor(cmr_handle handle,struct sensor_i2c_reg_tab *reg_info)
{
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void sp5508_drv_write_gain(cmr_handle handle, struct sensor_aec_i2c_tag *aec_info, cmr_u32 gain)
{
    ...
    if(gain <= 0x10*1.5)//<1.5x
		    hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x55, 0x24);
    else if(gain > 0x10*1.5 && gain <= 0x10*3)////1.5x--3x
			hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x55, 0x1e);
    else if(gain > 0x10*3 && gain <= 0x10*15.5)//<15.5x--3x
			hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x55, 0x14);
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void sp5508_drv_write_frame_length(cmr_handle handle, struct sensor_aec_i2c_tag *aec_info, cmr_u32 frame_len)
{
    SENSOR_IC_CHECK_PTR_VOID(aec_info);
	SENSOR_IC_CHECK_HANDLE_VOID(handle);
    struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
                                                  ...
                                                  cmr_u16 mode, struct sensor_aec_i2c_tag *aec_info)
{
	...
	if (dest_fr_len != cur_fr_len){
		...
		sp5508_drv_write_frame_length(handle, aec_info,dest_fr_len);
	}
    sns_drv_cxt->sensor_ev_info.preview_shutter = shutter;
	sp5508_drv_write_shutter(handle, aec_info,shutter);
...
static void sp5508_drv_calc_gain(cmr_handle handle,cmr_uint isp_gain, struct sensor_aec_i2c_tag *aec_info) 
{
	SENSOR_IC_CHECK_HANDLE_VOID(handle);
	struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int sp5508_drv_power_on(cmr_handle handle, cmr_uint power_on)
{
...
static cmr_int sp5508_drv_get_static_info(cmr_handle handle, cmr_u32 *param)
{
    ...
    if (!fps_info->is_init) {
        sp5508_drv_init_fps_info(handle);
    }
    ...
    ex_info->name = (cmr_s8 *)g_sp5508_mipi_raw_info.name;
    ex_info->sensor_version_info = (cmr_s8 *)g_sp5508_mipi_raw_info.sensor_version_info;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int sp5508_drv_access_val(cmr_handle handle, cmr_uint param)
{
	...
	switch(param_ptr->type)
	{
		case SENSOR_VAL_TYPE_GET_STATIC_INFO:
			ret = sp5508_drv_get_static_info(handle, param_ptr->pval);
			break;
		case SENSOR_VAL_TYPE_GET_FPS_INFO:
			ret = sp5508_drv_get_fps_info(handle, param_ptr->pval);
			break;
		case SENSOR_VAL_TYPE_SET_SENSOR_CLOSE_FLAG:
			ret = sns_drv_cxt->is_sensor_close = 1;
			break;
		case SENSOR_VAL_TYPE_GET_PDAF_INFO:
			//ret = sp5508_drv_get_pdaf_info(handle, param_ptr->pval);
			break;
		default:
			break;
    }
...
static cmr_int sp5508_arb_read_module_id(cmr_handle handle)
{
	cmr_u16 module_id_flag = 0;
	cmr_u16 module_id = 0;
	cmr_u16 otp_status = 0;
	...
	module_id_flag = hw_sensor_read_reg(handle, 0x80);
	SENSOR_LOGI("sp5508_arb otp module_id_flag=%x\n", module_id_flag);

	if (module_id_flag == 0x01 ) {
		module_id = hw_sensor_read_reg(handle, 0x81);
	}
	if (module_id_flag == 0x13) {
		module_id = hw_sensor_read_reg(handle, 0x8d);
	}
	if (module_id_flag == 0x37) {
		module_id = hw_sensor_read_reg(handle, 0x99);
	}
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int sp5508_drv_identify(cmr_handle handle, cmr_uint param)
{
	...
	pid_value = hw_sensor_read_reg(sns_drv_cxt->hw_handle, sp5508_PID_ADDR);

	if (sp5508_PID_VALUE == pid_value) {
 ...
 *============================================================================*/
static cmr_int sp5508_drv_before_snapshot(cmr_handle handle, cmr_uint param)
{
	...
	sp5508_drv_calc_exposure(handle,cap_shutter,0,capture_mode,&sp5508_aec_info);
	sp5508_drv_write_reg2sensor(handle,sp5508_aec_info.frame_length);
	sp5508_drv_write_reg2sensor(handle,sp5508_aec_info.shutter);

	sns_drv_cxt->sensor_ev_info.preview_gain=cap_gain;
	sp5508_drv_write_gain(handle, &sp5508_aec_info, cap_gain);
	sp5508_drv_write_reg2sensor(handle,sp5508_aec_info.again);
	sp5508_drv_write_reg2sensor(handle,sp5508_aec_info.dgain);
 ...
 *============================================================================*/
static cmr_int sp5508_drv_write_exposure(cmr_handle handle, cmr_uint param)
{
	...
	sp5508_drv_calc_exposure(handle,exposure_line,dummy_line,size_index,&sp5508_aec_info);
	sp5508_drv_write_reg2sensor(handle,sp5508_aec_info.frame_length);
	sp5508_drv_write_reg2sensor(handle,sp5508_aec_info.shutter);
 ...
 * you can change this function if it's necessary
 *============================================================================*/
static cmr_int sp5508_drv_write_gain_value(cmr_handle handle, cmr_uint param)
{
	cmr_int ret_value = SENSOR_SUCCESS;
	...
	sp5508_drv_calc_gain(handle,param,&sp5508_aec_info);
	sp5508_drv_write_reg2sensor(handle,sp5508_aec_info.again);
	sp5508_drv_write_reg2sensor(handle,sp5508_aec_info.dgain);
 ...
 * please don't change this function unless it's necessary
 *============================================================================*/
static cmr_int sp5508_drv_read_aec_info(cmr_handle handle,cmr_uint param)
{
    cmr_int ret_value = SENSOR_SUCCESS;
    ...
    info->aec_i2c_info_out = &sp5508_aec_info;
    exposure_line = info->exp.exposure;
    dummy_line = info->exp.dummy;
    mode = info->exp.size_index;

    sp5508_drv_calc_exposure(handle, exposure_line, dummy_line, mode, &sp5508_aec_info);
    sp5508_drv_calc_gain(handle,info->gain, &sp5508_aec_info);

    return ret_value;
}

static cmr_int sp5508_drv_set_master_FrameSync(cmr_handle handle,cmr_uint param)
{
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int sp5508_drv_stream_on(cmr_handle handle, cmr_uint param)
{
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
    ...
    if (!strcmp(value1, "1")) {
        ...
        //sp5508_drv_set_master_FrameSync(handle,param);
#endif
    }
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int sp5508_drv_stream_off(cmr_handle handle, cmr_uint param)
{
	SENSOR_LOGI("E");
    ...
    value = hw_sensor_read_reg(sns_drv_cxt->hw_handle, 0xa0);
    if (value != 0x00) {
...
static cmr_int sp5508_drv_handle_create(struct sensor_ic_drv_init_para *init_param, cmr_handle* sns_ic_drv_handle) 
{
	...
	sp5508_drv_write_frame_length(sns_drv_cxt, &sp5508_aec_info, sns_drv_cxt->sensor_ev_info.preview_framelength);
	sp5508_drv_write_gain(sns_drv_cxt, &sp5508_aec_info, sns_drv_cxt->sensor_ev_info.preview_gain);
	sp5508_drv_write_shutter(sns_drv_cxt, &sp5508_aec_info, sns_drv_cxt->sensor_ev_info.preview_shutter);

    sensor_ic_set_match_module_info(sns_drv_cxt, ARRAY_SIZE(s_sp5508_module_info_tab), s_sp5508_module_info_tab);
    sensor_ic_set_match_resolution_info(sns_drv_cxt, ARRAY_SIZE(s_sp5508_resolution_tab_raw), s_sp5508_resolution_tab_raw);
    sensor_ic_set_match_trim_info(sns_drv_cxt, ARRAY_SIZE(s_sp5508_resolution_trim_tab), s_sp5508_resolution_trim_tab);
    sensor_ic_set_match_static_info(sns_drv_cxt, ARRAY_SIZE(s_sp5508_static_info), s_sp5508_static_info);
    sensor_ic_set_match_fps_info(sns_drv_cxt, ARRAY_SIZE(s_sp5508_mode_fps_info), s_sp5508_mode_fps_info);

    /*init exif info,this will be deleted in the future*/
    sp5508_drv_init_fps_info(sns_drv_cxt);

    /*add private here*/
    return ret;
}

static cmr_int sp5508_drv_handle_delete(cmr_handle handle, void *param)
{
    cmr_int ret = SENSOR_SUCCESS;
...
static cmr_int sp5508_drv_get_private_data(cmr_handle handle, cmr_uint cmd, void**param)
{
    cmr_int ret = SENSOR_SUCCESS;
    SENSOR_IC_CHECK_HANDLE(handle);
    SENSOR_IC_CHECK_PTR(param);
 ...
 * .power = sp5508_power_on,
 *============================================================================*/
static struct sensor_ic_ops s_sp5508_ops_tab = {
    .create_handle = sp5508_drv_handle_create,
    .delete_handle = sp5508_drv_handle_delete,
    .get_data = sp5508_drv_get_private_data,
/*---------------------------------------*/
	.power = sp5508_drv_power_on,
	.identify = sp5508_drv_identify,
	.ex_write_exp = sp5508_drv_write_exposure,
	.write_gain_value = sp5508_drv_write_gain_value,

#if defined(CONFIG_DUAL_MODULE)
	.read_aec_info = sp5508_drv_read_aec_info,
#endif

    .ext_ops = {
        [SENSOR_IOCTL_BEFORE_SNAPSHOT].ops = sp5508_drv_before_snapshot,
        [SENSOR_IOCTL_STREAM_ON].ops = sp5508_drv_stream_on,
        [SENSOR_IOCTL_STREAM_OFF].ops = sp5508_drv_stream_off,
        /* expand interface,if you want to add your sub cmd ,
         *  you can add it in enum {@SENSOR_IOCTL_VAL_TYPE}
         */
        [SENSOR_IOCTL_ACCESS_VAL].ops = sp5508_drv_access_val,
    }
};
