...
SENSOR_REG_T GC0310_MIPI_YUV_COMMON3[]=
{
	{0xfe,0xf0},
	{0xfe,0xf0},
	{0xfe,0x00},
...
{
	// COMMON INIT
	{ADDR_AND_LEN_OF_ARRAY(GC0310_MIPI_YUV_COMMON1), 0, 0, 24, SENSOR_IMAGE_FORMAT_YUV422},

	// YUV422 PREVIEW 1
	{ADDR_AND_LEN_OF_ARRAY(GC0310_MIPI_YUV_COMMON1), 640, 480,24, SENSOR_IMAGE_FORMAT_YUV422},
	{PNULL, 0, 0, 0, 0, 0},
	{PNULL, 0, 0, 0, 0, 0},
	{PNULL, 0, 0, 0, 0, 0},
...
SENSOR_INFO_T g_GC0310_MIPI_yuv_info =
{
	...
	.reg_addr_value_bits = SENSOR_I2C_REG_8BIT | SENSOR_I2C_VAL_8BIT | SENSOR_I2C_FREQ_100,								// bit0: 0: i2c register value is 8 bit, 1: i2c register value is 16 bit
	...
	.step_count          = 7,								// bit[0:7]: count of step in brightness, contrast, sharpness, saturation
									// bit[8:31] reseved

	.reset_pulse_level  = SENSOR_LOW_PULSE_RESET,			// reset pulse level
	.reset_pulse_width  = 100,								// reset pulse width(ms)

	.power_down_level   = SENSOR_HIGH_LEVEL_PWDN,			// 1: high level valid; 0: low level valid
	...
	.name               = "GC0310_MIPI",					// name of sensor

	.image_format       = SENSOR_IMAGE_FORMAT_YUV422,		// define in SENSOR_IMAGE_FORMAT_E enum,
									// if set to SENSOR_IMAGE_FORMAT_MAX here, image format depent on SENSOR_REG_TAB_INFO_T
	.image_pattern      = SENSOR_IMAGE_PATTERN_YUV422_YUYV,	// pattern of input image form sensor;

	.resolution_tab_info_ptr = s_GC0310_MIPI_resolution_Tab_YUV,	// point to resolution table information structure
	.ioctl_func_tab_ptr      = &s_GC0310_MIPI_ioctl_func_tab,		// point to ioctl function table
...
static unsigned long GC0310_access_val(SENSOR_HW_HANDLE handle, unsigned long param)
{
	uint32_t rtn = SENSOR_SUCCESS;
	SENSOR_VAL_T* param_ptr = (SENSOR_VAL_T*)param;
	uint16_t tmp;

	SENSOR_LOGI("SENSOR_GC0310: _gc0310_access_val E param_ptr = %p", param_ptr);
	if(!param_ptr){
		return rtn;
	}
