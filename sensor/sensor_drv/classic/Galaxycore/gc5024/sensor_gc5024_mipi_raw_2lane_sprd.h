...
#include "parameters_sprd/sensor_gc5024_raw_param_main.c"
...
#define VIDEO_LINE_TIME		  	  22200
#define PREVIEW_LINE_TIME		  22200
#define SNAPSHOT_LINE_TIME		  22200
...
#define PRE_BLK_VAL_H 	0x00
#define PRE_BLK_VAL_L 	0x78
#define CAP_BLK_VAL_H 	0x3c
#define CAP_BLK_VAL_L 	0x00
#define PRE_STARTY 		0x02
#define PRE_STARTX 		0x0c
#define CAP_STARTY 		0x02
#define CAP_STARTX 		0x0c
#endif
...
#define CAP_BLK_VAL_L 	0x00
#define PRE_STARTY 		0x02
#define PRE_STARTX 		0x01 //0x0c
#define CAP_STARTY 		0x02
#define CAP_STARTX 		0x01
#endif
...
#define PH_SWITCH 		0x1b
#define PRE_BLK_VAL_H 	0x00
#define PRE_BLK_VAL_L 	0xe1
#define CAP_BLK_VAL_H 	0x00
#define CAP_BLK_VAL_L 	0x3c
#define PRE_STARTY 		0x02
#define PRE_STARTX 		0x0c
...
static const SENSOR_REG_T gc5024_init_setting[] = {
	...
	{0x8d,0x07},
	{0x90,0x01},
	{0x92,CAP_STARTY},//Don't Change Here!!!
	{0x94,CAP_STARTX},//Don't Change Here!!!
	{0x95,0x07},
	{0x96,0x98},//1944
	{0x97,0x0a},
	{0x98,0x20},//2592
	...
	/* BLK */
	{0x40,0x22},
	{0x4e,CAP_BLK_VAL_H},//Don't Change Here!!!
	{0x4f,CAP_BLK_VAL_L},//Don't Change Here!!!
	{0x60,0x00},
	{0x61,0x80},
	{0xfe,0x02},
	{0xa4,0x30},
...
static struct sensor_res_tab_info s_gc5024_resolution_tab_raw[VENDOR_NUM] = {
	{
      ...
      .reg_tab = {
        {ADDR_AND_LEN_OF_ARRAY(gc5024_init_setting), PNULL, 0,
        .width = 0, .height = 0,
...
static struct sensor_i2c_reg_tab gc5024_shutter_tab = {
    .settings = gc5024_shutter_reg, 
	.size = ARRAY_SIZE(gc5024_shutter_reg),
};
...
static struct sensor_i2c_reg_tab gc5024_again_tab = {
    .settings = gc5024_again_reg, 
	.size = ARRAY_SIZE(gc5024_again_reg),
};
...
static struct sensor_i2c_reg_tab gc5024_dgain_tab = {
    .settings = gc5024_dgain_reg, 
	.size = ARRAY_SIZE(gc5024_dgain_reg),
};
...
SENSOR_INFO_T g_gc5024_mipi_raw_info = {
    ...
    .identify_count = 1,
    .identify_code =
        {{ .reg_addr = gc5024_PID_ADDR, .reg_value = gc5024_PID_VALUE},
         { .reg_addr = gc5024_VER_ADDR, .reg_value = gc5024_VER_VALUE}},
