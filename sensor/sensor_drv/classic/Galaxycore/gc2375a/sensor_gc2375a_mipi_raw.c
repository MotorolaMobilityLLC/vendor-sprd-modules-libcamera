...
static void gc2375a_drv_write_reg2sensor(cmr_handle handle,
  ...
  for (i = 0; i < reg_info->size; i++) {
    ...
    // reg_info->settings[i].reg_addr, reg_info->settings[i].reg_value);
  }
}
...
static void gc2375a_drv_write_gain(struct sensor_aec_i2c_tag *aec_info,
                                   cmr_u32 gain) {
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void gc2375a_drv_write_frame_length(struct sensor_aec_i2c_tag *aec_info,
                                           cmr_u32 frame_len) {
  SENSOR_IC_CHECK_PTR_VOID(aec_info);
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void gc2375a_drv_write_shutter(struct sensor_aec_i2c_tag *aec_info,
                                      cmr_u32 shutter) {
  SENSOR_IC_CHECK_PTR_VOID(aec_info);
  cmr_u32 value = 0x00;
...
static void gc2375a_drv_calc_exposure(cmr_handle handle, cmr_u32 shutter,
  ...
  SENSOR_LOGI("lihai 00 fps = %f , exposure_line = %d, dummy_line= %d, "
...
static void gc2375a_drv_calc_gain(cmr_handle handle, cmr_uint isp_gain,
                                  struct sensor_aec_i2c_tag *aec_info) {
  SENSOR_IC_CHECK_HANDLE_VOID(handle);
  struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
...
static cmr_int gc2375a_drv_get_static_info(cmr_handle handle, uint32_t *param) {
  ...
  ex_info->sensor_version_info =
      (cmr_s8 *)g_gc2375a_mipi_raw_info.sensor_version_info;
...
static cmr_int gc2375a_drv_before_snapshot(cmr_handle handle, cmr_uint param) {
  ...
  gc2375a_drv_calc_exposure(handle, cap_shutter, 0, capture_mode,
                            &gc2375a_aec_info);
...
static cmr_int gc2375a_drv_write_exposure(cmr_handle handle, cmr_uint param) {
  ...
  gc2375a_drv_calc_exposure(handle, exposure_line, dummy_line, size_index,
                            &gc2375a_aec_info);
...
static cmr_int gc2375a_drv_read_aec_info(cmr_handle handle, cmr_uint param) {
  ...
  gc2375a_drv_calc_exposure(handle, exposure_line, dummy_line, mode,
                            &gc2375a_aec_info);
...
static cmr_int gc2375a_drv_set_Slave_FrameSync(cmr_handle handle,
                                               cmr_uint param) {
  SENSOR_IC_CHECK_HANDLE(handle);
  struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
...
#else // master
  hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x00, 0x0b);
  hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x00, 0x8b);
  hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x00, 0x2b);
  hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x00, 0x4b);
  hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x86, 0x01);
...
static cmr_int gc2375a_drv_stream_on(cmr_handle handle, cmr_uint param) {
  ...
  gc2375a_drv_set_Slave_FrameSync(handle, param);
...
static cmr_int
gc2375a_drv_handle_create(struct sensor_ic_drv_init_para *init_param,
  ...
  sensor_ic_set_match_module_info(sns_drv_cxt,
                                  ARRAY_SIZE(s_gc2375a_module_info_tab),
                                  s_gc2375a_module_info_tab);
  sensor_ic_set_match_resolution_info(sns_drv_cxt,
                                      ARRAY_SIZE(s_gc2375a_resolution_tab_raw),
                                      s_gc2375a_resolution_tab_raw);
  sensor_ic_set_match_trim_info(sns_drv_cxt,
                                ARRAY_SIZE(s_gc2375a_resolution_trim_tab),
                                s_gc2375a_resolution_trim_tab);
  sensor_ic_set_match_static_info(
      sns_drv_cxt, ARRAY_SIZE(s_gc2375a_static_info), s_gc2375a_static_info);
  sensor_ic_set_match_fps_info(sns_drv_cxt, ARRAY_SIZE(s_gc2375a_mode_fps_info),
                               s_gc2375a_mode_fps_info);
...
static cmr_int gc2375a_drv_get_private_data(cmr_handle handle, cmr_uint cmd,
                                            void **param) {
  cmr_int ret = SENSOR_SUCCESS;
  SENSOR_IC_CHECK_HANDLE(handle);
  SENSOR_IC_CHECK_PTR(param);
