...
#define VENDOR_NUM 1
#define SENSOR_NAME			"gc2385_wj_1"
...
#define PREVIEW_MIPI_PER_LANE_BPS	  656  /* 2*Mipi clk */
#define SNAPSHOT_MIPI_PER_LANE_BPS	  656  /* 2*Mipi clk */
...
static SENSOR_REG_T gc2385_shutter_reg[] = {
    {0xfe, 0x00}, 
    {0x03, 0x04}, 
    {0x04, 0x80}, 
};

static struct sensor_i2c_reg_tab gc2385_shutter_tab = {
    .settings = gc2385_shutter_reg, 
	.size = ARRAY_SIZE(gc2385_shutter_reg),
};

static SENSOR_REG_T gc2385_again_reg[] = {
	{0xfe, 0x00}, 
	{0x20, 0x73}, 
	{0x22, 0xa2}, 
	{0xb6, 0x00}, 
...
static struct sensor_i2c_reg_tab gc2385_again_tab = {
    .settings = gc2385_again_reg, 
	.size = ARRAY_SIZE(gc2385_again_reg),
};

static SENSOR_REG_T gc2385_dgain_reg[] = {
   
};

static struct sensor_i2c_reg_tab gc2385_dgain_tab = {
    .settings = gc2385_dgain_reg, 
	.size = ARRAY_SIZE(gc2385_dgain_reg),
};

static SENSOR_REG_T gc2385_frame_length_reg[] = {

};

static struct sensor_i2c_reg_tab gc2385_frame_length_tab = {
    .settings = gc2385_frame_length_reg,
    .size = ARRAY_SIZE(gc2385_frame_length_reg),
};

static struct sensor_aec_i2c_tag gc2385_aec_info = {
    .slave_addr = (I2C_SLAVE_ADDR >> 1),
    .addr_bits_type = SENSOR_I2C_REG_8BIT,
    .data_bits_type = SENSOR_I2C_VAL_8BIT,
    .shutter = &gc2385_shutter_tab,
    .again = &gc2385_again_tab,
    .dgain = &gc2385_dgain_tab,
    .frame_length = &gc2385_frame_length_tab,
};
...
struct sensor_raw_info *s_gc2385_mipi_raw_info_ptr = PNULL;
...
SENSOR_INFO_T g_gc2385_mipi_raw_info = {
    ...
    .sensor_version_info = (cmr_s8 *)"gc2385_wj_1",
};
