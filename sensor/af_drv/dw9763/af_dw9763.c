 ...
 *============================================================================*/
static uint32_t _dw9763_write_dac_code(cmr_handle sns_af_drv_handle, int32_t code)
{
...
static int dw9763_drv_create(struct af_drv_init_para *input_ptr, cmr_handle* sns_af_drv_handle)
{
...
static int dw9763_drv_ioctl(cmr_handle sns_af_drv_handle, enum sns_cmd cmd, void* param)
{
    uint32_t ret_value = AF_SUCCESS;
    struct sns_af_drv_cxt *af_drv_cxt = (struct sns_af_drv_cxt*)sns_af_drv_handle;
    CHECK_PTR(sns_af_drv_handle);
