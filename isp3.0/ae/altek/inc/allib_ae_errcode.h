...
#define _AL_AELIB_INVALID_ISO               ( _AL_AELIB_GLOBAL_ERR_OFFSET  + 0x08 )
#define _AL_AELIB_MISMATCH_STATS_SIZE       ( _AL_AELIB_GLOBAL_ERR_OFFSET  + 0x09 )
#define _AL_AELIB_INCONSIST_SETDAT          ( _AL_AELIB_GLOBAL_ERR_OFFSET  + 0x0A )
#define _AL_AELIB_SOF_FRAME_INDEX_MISMATCH  ( _AL_AELIB_GLOBAL_ERR_OFFSET  + 0x0B )
#define _AL_AELIB_INVALID_ISOLEVEL          ( _AL_AELIB_GLOBAL_ERR_OFFSET  + 0x0C )
#define _AL_AELIB_INVALID_CALIB_GAIN          ( _AL_AELIB_GLOBAL_ERR_OFFSET  + 0x0D )
#define _AL_AELIB_INVALID_STATS_ADDR         ( _AL_AELIB_GLOBAL_ERR_OFFSET  + 0x0E )
#define _AL_AELIB_INVALID_PCURVE_ADDR         ( _AL_AELIB_GLOBAL_ERR_OFFSET  + 0x0F )
#define _AL_AELIB_INVALID_PCURVE_CALC         ( _AL_AELIB_GLOBAL_ERR_OFFSET  + 0x10 )
