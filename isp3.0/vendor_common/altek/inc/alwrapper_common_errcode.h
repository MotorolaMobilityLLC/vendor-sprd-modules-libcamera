...
#define ERR_WRP_COMM_INVALID_SIZEINFO(info) ( ERR_WRP_COMM_PARSE_BASE + 0x10 + info)
#define ERR_WRP_COMM_INVALID_FUNCTION(info) ( ERR_WRP_COMM_PARSE_BASE + 0x18 + info)