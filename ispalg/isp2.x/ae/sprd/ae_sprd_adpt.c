...
static cmr_s32 ae_pre_process(struct ae_ctrl_cxt *cxt)
{
	...
	if ((FLASH_PRE_BEFORE <= cxt->cur_status.settings.flash) && (FLASH_MAIN_AFTER_RECEIVE >= cxt->cur_status.settings.flash)) {
