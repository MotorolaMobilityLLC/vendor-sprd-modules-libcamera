...
/* smart callback command */
	...
	enum smart_ctrl_app_mode {
		SMART_CTRL_APP_MODE_AUTO_PHOTO = 0,
		SMART_CTRL_APP_MODE_MANUAL,
		SMART_CTRL_APP_MODE_CONTINUE,
		SMART_CTRL_APP_MODE_INTERVAL,
		SMART_CTRL_APP_MODE_PANORAMA,
		SMART_CTRL_APP_MODE_REFOCUS,
		SMART_CTRL_APP_MODE_SCENE,
		SMART_CTRL_APP_MODE_PIP,
		SMART_CTRL_APP_MODE_GCAM,
		SMART_CTRL_APP_MODE_AUTO_VIDEO,
		SMART_CTRL_APP_MODE_VIV,
		SMART_CTRL_APP_MODE_TIMELAPSE,
		SMART_CTRL_APP_MODE_SLOWMOTION,
		SMART_CTRL_APP_MODE_AUDIO_PICTURE,
		SMART_CTRL_APP_MODE_FILTER,
		SMART_CTRL_APP_MODE_QRCODE,
		SMART_CTRL_APP_MODE_VIDEO_TD,
		SMART_CTRL_APP_MODE_PHOTO_TD,
		SMART_CTRL_APP_MODE_FRONT_BLURREFOCUS,
		SMART_CTRL_APP_MODE_TD_RANGE_FIND,
		SMART_CTRL_APP_MODE_3DNR_PHOTO,
		SMART_CTRL_APP_MODE_3DNR_VIDEO,
		SMART_CTRL_APP_MODE_MAX
	};
