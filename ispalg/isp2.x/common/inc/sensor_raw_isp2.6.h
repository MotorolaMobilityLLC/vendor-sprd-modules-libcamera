 ...
 */
#ifndef _SENSOR_RAW_ISP2_6_H_
#define _SENSOR_RAW_ISP2_6_H_
...
struct sensor_bpc_level_v0 {
	/* must be same as (struct sensor_bpc_level) for CONFIG_ISP_2_5 */
	struct sensor_bpc_comm bpc_comm;
	struct sensor_bpc_pos_out bpc_pos;
	struct sensor_bpc_thr bpc_thr;
	struct sensor_bpc_rules bpc_rules;
...
struct sensor_bpc_level_v1 {
	/* must be same as (struct sensor_bpc_level) for CONFIG_ISP_2_6 */
	struct sensor_bpc_comm bpc_comm;
	struct sensor_bpc_pos_out bpc_pos;
	struct sensor_bpc_thr bpc_thr;
	struct sensor_bpc_rules bpc_rules;
...
struct sensor_ynr_level {
	...
	struct sensor_ynr_den_str_v0 ynr_den_str;
...
struct sensor_ynr_level_v1 {
	/* must be same as (struct sensor_ynr_level) for CONFIG_ISP_2_6 */
	struct sensor_ynr_sal_str ynr_sal_str;
	struct sensor_ynr_den_str ynr_wv_parm[3];
	struct sensor_ynr_blf_str ynr_blf_str;
	struct sensor_ynr_addback addback[4];
...
struct sensor_ynr_level_v0 {
	/* must be same as (struct sensor_ynr_level) for CONFIG_ISP_2_5 */
	struct sensor_ynr_region ynr_region;
	struct sensor_ynr_texture_calc ynr_txt_calc;
	struct sensor_ynr_den_str_v0 ynr_den_str;
	cmr_u16 freqratio[24];
...
struct sensor_cce_uvdiv_chroma_v0 {
	cmr_u8 chroma_min_h;
	cmr_u8 chroma_min_l;
	cmr_u8 chroma_max_h;
	cmr_u8 chroma_max_l;
...
struct sensor_cce_uvdiv_ratio_v0 {
	cmr_u8 ratio_0;
	cmr_u8 ratio_1;
	cmr_u8 ratio;
	cmr_u8 ratio_uv_min;
...
struct sensor_cce_uvdiv_level {
	struct sensor_cce_uvdiv_lum uvdiv_lum;
	struct sensor_cce_uvdiv_chroma_v0 uvdiv_chroma;
	struct sensor_cce_uvdiv_th u_th_1;
	struct sensor_cce_uvdiv_th u_th_0;
	struct sensor_cce_uvdiv_th v_th_1;
	struct sensor_cce_uvdiv_th v_th_0;
	struct sensor_cce_uvdiv_ratio_v0 uvdiv_ratio;
	cmr_u8 uv_abs_th_len;
	cmr_u8 y_th_l_len;
	cmr_u8 y_th_h_len;
	cmr_u8 bypass;
...
struct sensor_cce_uvdiv_level_v1 {
	/* must be same as (struct sensor_cce_uvdiv_level) for CONFIG_ISP_2_6 */
	struct sensor_cce_uvdiv_lum uvdiv_lum;
	struct sensor_cce_uvdiv_chroma uvdiv_chroma;
	struct sensor_cce_uvdiv_th u_th_0;
	struct sensor_cce_uvdiv_th u_th_1;
...
struct sensor_cce_uvdiv_level_v0 {
	/* must be same as (struct sensor_cce_uvdiv_level) for CONFIG_ISP_2_5 */
	struct sensor_cce_uvdiv_lum uvdiv_lum;
	struct sensor_cce_uvdiv_chroma_v0 uvdiv_chroma;
	struct sensor_cce_uvdiv_th u_th_1;
	struct sensor_cce_uvdiv_th u_th_0;
...
// 3DNR for SharkL3
struct sensor_3dnr_cfg_v0 {
	cmr_u8 src_wgt[4];	// dynamic weight needs 4 buffer
	cmr_u8 nr_thr;
	cmr_u8 nr_wgt;
	cmr_u8 thr_polyline_cap[9];
	cmr_u8 gain_polyline_cap[9];
};

struct sensor_3dnr_yuv_cfg_v0 {
	cmr_u8 grad_wgt_polyline_cap[11];
	cmr_u8 reserved;
	struct sensor_3dnr_cfg_v0 y_cfg;
	struct sensor_3dnr_cfg_v0 u_cfg;
	struct sensor_3dnr_cfg_v0 v_cfg;
};

//reduce color noise around corners
struct sensor_3dnr_radialval_str_v0 {
	cmr_u16 r_circle_cap[3];
	cmr_u16 reserved;
	struct sensor_3dnr_radialval u_range;
	struct sensor_3dnr_radialval v_range;
...
struct sensor_3dnr_level {
	...
	cmr_u8 reserved;
	struct sensor_3dnr_yuv_cfg_v0 yuv_cfg;
	struct sensor_3dnr_radialval_str_v0 sensor_3dnr_cor;
	struct sensor_3dnr_fast_me_v0 fast_me;
};
#else
struct sensor_3dnr_level {
	cmr_u8 bypass;
...
struct sensor_nlm_first_lum_v0 {
...
struct sensor_nlm_radius_param_v0 {
	cmr_u16 radius_threshold_filter_ratio;
	cmr_u16 coef2;
	cmr_u16 protect_gain_min;
	cmr_u16 reserved;
...
struct sensor_nlm_radius_1D_v0 {
	cmr_u16 cal_radius_bypass;
	cmr_u16 center_y;
	cmr_u16 center_x;
	cmr_u16 update_flat_thr_bypass;
	cmr_u16 radius_threshold;
	cmr_u16 radial_1D_bypass;
	struct sensor_nlm_radius_param_v0 radius[3][4];
	cmr_u16 protect_gain_max;
	cmr_u16 reserved;
};
...
#else
struct sensor_nlm_level {
	struct sensor_nlm_first_lum_v0 first_lum;
	struct sensor_nlm_radius_1D_v0 radius_1d;
	struct sensor_nlm_direction nlm_dic;
	struct sesor_simple_bpc simple_bpc;
	struct sensor_lutw_level lut_w;
	cmr_u8 imp_opt_bypass;
...
struct sensor_nlm_level_v1 {
	/* must be same as (struct sensor_nlm_level) for CONFIG_ISP_2_6 */
	struct sensor_nlm_first_lum first_lum;
	struct sensor_nlm_radius_1D radius_1d;
	struct sensor_nlm_direction nlm_dic;
	struct sesor_simple_bpc simple_bpc;
...
struct sensor_nlm_level_v0 {
	/* must be same as (struct sensor_nlm_level) for CONFIG_ISP_2_5 */
	struct sensor_nlm_first_lum_v0 first_lum;
	struct sensor_nlm_radius_1D_v0 radius_1d;
	struct sensor_nlm_direction nlm_dic;
	struct sesor_simple_bpc simple_bpc;
...
struct sensor_posterize_param_v0 {
	cmr_u8 pstrz_bot[8];
	cmr_u8 pstrz_top[8];
	cmr_u8 pstrz_out[8];
...
struct sensor_contrast_param_v0 {
	cmr_u8 factor[16];
	cmr_u32 cur_index;
	cmr_u8 scenemode[MAX_SCENEMODE_NUM];
};
...
struct sensor_saturation_param_v0 {
	cmr_u8 csa_factor_u[16];
	cmr_u8 csa_factor_v[16];
	cmr_u32 index_u;
	cmr_u32 index_v;
...
struct sensor_filter_weights_v0
{
	cmr_u8 distWeight[9]; //distance weight for different scale
	cmr_u8 level_enable;
	cmr_u16 low_ct_thrd;
...
struct sensor_cnr_level {
	cmr_u8 filter_en[CNR_LEVEL]; //enable control of filter
	cmr_u8 rangTh[CNR_LEVEL][2]; //threshold for different scale(rangTh[CNR_LEVEL][0]:U threshold, rangTh[CNR_LEVEL][1]:V threshold)
	struct sensor_filter_weights_v0 weight[CNR_LEVEL][2]; //weight table(wTable[CNR_LEVEL][0]:U weight table, wTable[CNR_LEVEL][1]:V weight table)
	float dist_sigma[CNR_LEVEL][2];
	float rang_sigma[CNR_LEVEL][2];
};
#endif

struct sensor_cnr_level_v0 {
	/* must be same as (struct sensor_cnr_level) for CONFIG_ISP_2_5 */
	cmr_u8 filter_en[CNR_LEVEL]; //enable control of filter
	cmr_u8 rangTh[CNR_LEVEL][2]; //threshold for different scale(rangTh[CNR_LEVEL][0]:U threshold, rangTh[CNR_LEVEL][1]:V threshold)
	struct sensor_filter_weights_v0 weight[CNR_LEVEL][2]; //weight table(wTable[CNR_LEVEL][0]:U weight table, wTable[CNR_LEVEL][1]:V weight table)
	float dist_sigma[CNR_LEVEL][2];
...
struct sensor_cnr_level_v1 {
	/* must be same as (struct sensor_cnr_level) for CONFIG_ISP_2_6 */
       cmr_u8 level_enable;
       cmr_u16 low_ct_thrd;
       cmr_u8 reserved; //for 4 bytes allign
	cmr_u8 filter_en[CNR_LEVEL]; //enable control of filter
...
enum {
	...
	ISP_BLK_RGB_AFM_T,
	ISP_BLK_UVDIV_T,
	ISP_BLK_3DNR_T = ISP_BLK_UVDIV_T + 1,
	ISP_BLK_3DNR_PRE_T = ISP_BLK_UVDIV_T + 1,
	ISP_BLK_3DNR_CAP_T = ISP_BLK_UVDIV_T + 2,
	ISP_BLK_PPE_T = ISP_BLK_UVDIV_T + 2,
	ISP_BLK_YUV_PRECDN_T = ISP_BLK_UVDIV_T + 3,
	ISP_BLK_CDN_T,
	ISP_BLK_POSTCDN_T,
	ISP_BLK_YNR_T,
	ISP_BLK_EDGE_T,
