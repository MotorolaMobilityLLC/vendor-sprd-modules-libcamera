...
static void save_tab_to_channel(unsigned int gain_width, unsigned int gain_height, unsigned int gain_pattern, unsigned short* ch_r, unsigned short* ch_gr, unsigned short* ch_gb, unsigned short* ch_b, unsigned short* rlt_tab)
{
	unsigned int i = 0;
