...
#define PD_VERSION "PDAF_Algo_Ver: v1.18" //Support Dual PD
...
extern "C" {
	...
	cmr_s32 PD_DoPoint2(void *a_pInPhaseBuf, cmr_s32 a_dRectX, cmr_s32 a_dRectY, cmr_s32 a_dRectW, cmr_s32 a_dRectH);
