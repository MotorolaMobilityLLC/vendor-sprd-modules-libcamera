...
struct awb_aiscene_info_old {
	...
	enum awb_aiscene_type_3_0 cur_scene_id;
	struct ai_task0_result task0[AI_SCENE_TASK0_MAX_3_0];
	struct ai_task1_result task1[AI_SCENE_TASK1_MAX_3_0];
	struct ai_task2_result task2[AI_SCENE_TASK2_MAX_3_0];
};
...
enum awb_flash_status_3_0
{
    AWB_FLASH_PRE_BEFORE_3_0,
	AWB_FLASH_PRE_LIGHTING_3_0,
	AWB_FLASH_PRE_AFTER_3_0,
	AWB_FLASH_MAIN_BEFORE_3_0,
	AWB_FLASH_MAIN_LIGHTING_3_0,
	AWB_FLASH_MAIN_MEASURE_3_0,
	AWB_FLASH_MAIN_AFTER_3_0,
	AWB_FLASH_MODE_MAX_3_0
};

struct awb_flash_info_3_0
{
   int mainFlash_enable;
   enum awb_flash_status_3_0 flash_status;
   int flash_ratio;
   int flash_ratio1;
...
enum
{
	...
	AWB_IOCTRL_AWB_SYNC_DEBUGINFO = 6,

	AWB_IOCTRL_MWB_BY_MODEID_DEBUGINFO = 7,

	AWB_IOCTRL_MWB_BY_CT_DEBUGINFO = 8,
...
// for WIN32 debugtool
	...
	AWB_IOCTRL_GET_GRAY_SUBZONE_RESULT,
	AWB_IOCTRL_GET_GRAY_TRANSITION_SUBZONE_RESULT,
	AWB_IOCTRL_GET_ZONE_CTTINT_RESULT,
	AWB_IOCTRL_GET_ZONE_WEIGHT_RESULT,
	AWB_IOCTRL_GET_CMC,
	AWB_IOCTRL_GET_ORIGINAL_CTTINT,
	AWB_IOCTRL_GET_AISCENE_RESULT,
	AWB_IOCTRL_GET_FACEAWB_RESULT,
// for WIN32 debugtool
