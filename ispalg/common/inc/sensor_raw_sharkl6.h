 ...
 */
#ifndef _SENSOR_RAW_SHARKL6_H_
#define _SENSOR_RAW_SHARKL6_H_
...
#define SENSOR_PARAM_VERSION "ums9230_11_21a_0000"
...
enum isp_scene_mode {
	...
	ISP_SCENEMODE_FACEBOOK,
	ISP_SCENEMODE_MESSENGER,
	ISP_SCENEMODE_QQ,
	ISP_SCENEMODE_SNAPCHAT,
	ISP_SCENEMODE_WHATAPPS,
	ISP_SCENEMODE_WECHAT,
	ISP_SCENEMODE_MAX
};
...
struct sensor_hsv_lut_param {
	cmr_u8 hsv_bypass;
	cmr_u8 delta_value_en;
	cmr_u8 hsv_hue_thr[3][2];
	cmr_u16 hsv_1d_hue_lut[25];
	cmr_u16 hsv_1d_sat_lut[17];
	struct sensor_hsv_curve hsv_curve_param[4];
	struct isp_sample_point_info cur_idx;
	struct sensor_hsv_lut hsv_lut[SENSOR_HSV_NUM];
...
enum ai_scene{
	...
	AI_SECNE_PRO_OVERCAST,
	AI_SECNE_PRO_CAR,
	AI_SECNE_PRO_BICYCLE,
	AI_SECNE_PRO_BEACH,
	AI_SECNE_PRO_WATERAREA,
	AI_SECNE_PRO_WATERFALL,
	AI_SECNE_PRO_AUTUMNLEAF,
	AI_SECNE_PRO_CHINESEARCHITECTUR,
	...
	AI_SECNE_PRO_RESERVED7,
	AI_SECNE_PRO_RESERVED8,
	AI_SECNE_PRO_RESERVED9,
	AI_SECNE_PRO_RESERVED10,
	AI_SCENE_PRO_MAX
};
//AI_Bchs
...
struct sensor_ai_hsv_param {
	struct sensor_ai_hsv_offset hsv_offset;
	cmr_u8 hue_offset_enable;
	cmr_u8 reserved[3];
};
