 ...
 */
#ifndef _SENSOR_RAW_SHARKL6PRO_H_
#define _SENSOR_RAW_SHARKL6PRO_H_
...
#define SENSOR_PARAM_VERSION "ums9620_11_21a_0000"
...
// dec_bwd
struct sensor_dec_bwd{
	cmr_u8 dec_bwd_bypass;
	cmr_u8 dec_bwd_outbits;
	cmr_u8 reserved[2];
};
...
// bwd_3dnr
struct sensor_bwd_3dnr{
	cmr_u8 bwd_3dnr_outbits;
	cmr_u8 reserved[3];
};

// scaler1bwd
struct sensor_scaler1_bwd{
	cmr_u8 scaler1_bwd_bypass;
	cmr_u8 scaler1_bwd_outbits;
	cmr_u8 reserved[2];
};

// scaler2bwd
struct sensor_scaler2_bwd{
	cmr_u8 scaler2_bwd_bypass;
	cmr_u8 scaler2_bwd_outbits;
	cmr_u8 reserved[2];
};

// scaler2bwd
struct sensor_scaler3_bwd{
	cmr_u8 scaler3_bwd_bypass;
	cmr_u8 scaler3_bwd_outbits;
	cmr_u8 reserved[2];
};
...
struct sensor_bwu_bwd_level{
	...
	struct sensor_bwd0 bwd0;
	struct sensor_bwd1 bwd1;
	struct sensor_bwd2 bwd2;
	struct sensor_dec_bwd dec_bwd;
	struct sensor_bwd_3dnr bwd_3dnr;
	struct sensor_scaler1_bwd scaler1_bwd;
	struct sensor_scaler2_bwd scaler2_bwd;
	struct sensor_scaler3_bwd scaler3_bwd;
};
...
struct sensor_bpc_rules {
	...
	cmr_u16 g_ratio;
	cmr_u16 dirc_ratio;
	cmr_u8 diffthCoeff_limit;
	cmr_u8 diffthCoeff_detect;
	cmr_u16 diffLimit;
};
...
//YNR
struct sensor_ynr_layer_epsilon{
	cmr_u16 gf_epsilon_low;
	cmr_u16 gf_epsilon_mid;
	cmr_u16 gf_epsilon_high;
	cmr_u16 reserved;
};

struct sensor_ynr_layer{
	struct sensor_ynr_layer_epsilon ynr_epsilon;
	cmr_u8 lum_thresh[2];
	cmr_u8 gf_enable;
	cmr_u8 gf_radius;
	cmr_u16 gf_rnr_offset;
	cmr_u8 gf_rnr_ratio;
	cmr_u8 gf_addback_enable;
	cmr_u8 gf_addback_ratio;
	cmr_u8 gf_addback_clip;
	cmr_u8 reserved[2];
};

struct sensor_ynr_level {
	struct sensor_ynr_layer ynr_layer[5];
	cmr_u16 bypass;
	cmr_u16 radius;
	cmr_u16 radius_base;
...
struct sensor_cce_uvdiv_chroma {
	cmr_u8 chroma_max1_h;
	cmr_u8 chroma_max1_m;
	cmr_u8 chroma_max1_l;
	cmr_u8 chroma_max2_h;
	cmr_u8 chroma_max2_m;
	cmr_u8 chroma_max2_l;
	cmr_u8 reserved[2];
};
...
struct sensor_rgb_afm_enhanced_lum {
	cmr_u8 gamma_en;
	cmr_u8 hist_en;
	cmr_u8 scale_en;
	cmr_u8 scale_hx;
	cmr_u8 scale_vx;
	cmr_u8 max_lum_num_th;
	cmr_u16 max_lum_th;
	cmr_u16 gamma_curve[SENSOR_RGB_AFM_GAMMA_POINT_NUM];
	cmr_u16 reserved;
};
...
struct sensor_rgb_afm_enhanced {
	...
	struct sensor_rgb_afm_enhanced_lum afm_enhanced_lum;
};
...
struct sensor_pyramid_onl_level{
	...
	cmr_u8 store_dec1_bypass;
	cmr_u8 store_dec2_bypass;
	cmr_u8 store_dec3_bypass;
	cmr_u8 store_dec4_bypass;
	cmr_u8 reconstruction_byass;
	cmr_u8 online_layer_num;
	cmr_u8 reserved;
};

//pyramid offline
struct sensor_pyramid_offl_level{
	cmr_u8 dec_offline_bypass;
	cmr_u8 reconstruction_byass;
	cmr_u8 offline_layer_num;
	cmr_u8 reserved;
};

//DCT
struct sensor_dct_coef{
	cmr_u8 coef_thresh[4];
	cmr_u8 coef_ratio[3];
	cmr_u8 reserved;
};

struct sensor_dct_luma{
	cmr_u8 lnr_en;
	cmr_u8 reserved[3];
	cmr_u8 luma_thresh[2];
	cmr_u8 luma_ratio[2];
};

struct sensor_dct_fnr{
	cmr_u8 fnr_en;
	cmr_u8 fnr_ratio[2];
	cmr_u8 reserved;
	cmr_u16 flat_th;
...
struct sensor_dct_rnr{
	cmr_u8 rnr_en;
	cmr_u8 rnr_ratio[2];
	cmr_u8 reserved;
	cmr_u16 rnr_radius;
	cmr_u16 rnr_radius_factor;
	cmr_u16 rnr_radius_base;
	cmr_u16 rnr_imgCenterX;
	cmr_u16 rnr_imgCenterY;
	cmr_u16 rnr_step;
};

struct sensor_dct_blend{
	cmr_u8 blend_en;
	cmr_u8 blend_radius;
	cmr_u8 blend_thresh[2];
	cmr_u8 blend_weight;
	cmr_u16 blend_epsilon;
	cmr_u8 blend_ratio[2];
	cmr_u8 reserved[3];
};

struct sensor_dct_direction{
	cmr_u8 direction_smooth_en;
	cmr_u8 direction_mode;
	cmr_u8 direction_freq_hop_control_en;
	cmr_u8 direction_freq_hop_thresh;
	cmr_u8 direction_freq_hop_total_num_thresh;
	cmr_u8 reserved[3];
...
struct sensor_dct_level{
	...
	cmr_u8 addback_clip;
	cmr_u8 reserved[3];
	struct sensor_dct_coef dct_coef;
	struct sensor_dct_luma dct_luma;
	struct sensor_dct_fnr dct_fnr;
	struct sensor_dct_rnr dct_rnr;
	struct sensor_dct_blend dct_blend;
	struct sensor_dct_direction dct_direction;
};
...
struct sensor_ee_ipd_direction {
	cmr_u8 direction_mode;
	cmr_u8 direction_freq_hop_control_en;
	cmr_u8 direction_freq_hop_thresh;
	cmr_u8 freq_hop_total_num_thresh;
	cmr_u16 direction_thresh_diff;
	cmr_u16 direction_thresh_min;
	cmr_u16 direction_hop_thresh_diff;
	cmr_u16 direction_hop_thresh_min;
...
struct sensor_ee_ipd {
	cmr_u8 ipd_bypass;
	cmr_u8 ipd_mask_mode;
	cmr_u8 ipd_1d_en;
	cmr_u8 ipd_orientation_filter_mode;
	...
	struct sensor_ee_ipd_direction ipd_direction;
};
...
struct sensor_ee_offset_gradient {
	cmr_u16 gradient_curve_pos[4];
	cmr_u16 gradient_curve_neg[4];
};

struct sensor_ee_offset_layer0{
	struct sensor_ee_offset_list ee_offset_layer0;
	struct sensor_ee_offset_gradient ee_offset_gradient;
	cmr_u8 computation_type;
	cmr_u8 reserved[3];
};

struct sensor_ee_offset_layer {
	cmr_u8 ee_old_gradient_en;
	cmr_u8 ee_new_pyramid_en;
	cmr_u8 ee_ratio_old_gradient;
	cmr_u8 ee_ratio_new_pyramid;
	struct sensor_ee_offset_list ee_offset_layer[2];
	struct sensor_ee_offset_layer0 ee_offset_layer0;
};

//ee_racial_list
struct sensor_ee_racial_ratio_gain{
	cmr_u16 ratio_gain_max;
	cmr_u16 ratio_gain_min;
};

struct sensor_ee_racial_list {
	cmr_u8 cal_radius_en;
	cmr_u8 racial_1d_en;
	cmr_u8 old_gradient_ratio_en;
	cmr_u8 new_pyramid_ratio_en;
	cmr_u8 pyramid_layer_offset_en;
	cmr_u8 reserved[3];
	cmr_u16 center_x;
	cmr_u16 center_y;
	cmr_u16 radius_threshold;
	cmr_u16 radius_threshold_factor;
	cmr_s16 old_gradient_ratio_coef;
	cmr_s16 new_pyramid_ratio_coef;
	cmr_s16 layer_pyramid_offset_coef[3];
	cmr_u16 layer_pyramid_offset_gain_max;
	cmr_u16 layer_pyramid_offset_clip_ratio_max;
	cmr_u16 layer_pyramid_offset_gain_min[3];
	struct sensor_ee_racial_ratio_gain old_gradient;
	struct sensor_ee_racial_ratio_gain new_pyramid;
};
...
struct sensor_ee_level {
	...
	struct sensor_ee_racial_list ee_racial_list;
	cmr_u8 bypass;
	cmr_u8 reserved[3];
};

struct rgb_gtm_stat_rgb2y {
	cmr_u8 rgb2y_mode;
	cmr_u8 reserved;
...
// rgb gtm stat
struct sensor_rgb_gtm_stat {
	cmr_u8 gtm_stat_bypass;
	cmr_u8 reserved[3];
	struct rgb_gtm_stat_rgb2y gtm_stat_rgb2y;
	struct rgb_gtm_stat_percentile_16bit percentile_16bit;
	struct rgb_gtm_stat_target_norm target_norm;
	struct rgb_gtm_stat_image gtm_stat_image;
	struct rgb_gtm_stat_video gtm_stat_video;
};

//gtm map
struct sensor_stat_map {
	cmr_u8 bypass;
	cmr_u8 map_video_mode;
	cmr_u8 dist[7][7];
	cmr_u8 reserved;
	float bilateral_sigma_d;
	float bilateral_sigma_r;
	cmr_u16 dis_weight[19];
	cmr_u16 range_weight[61];
};

//rgb gtm level
struct sensor_rgb_gtm_level {
	struct sensor_rgb_gtm_stat rgb_gtm_stat;
	struct sensor_stat_map rgb_gtm_map;
};

struct sensor_rgb_gtm_param {
	struct isp_sample_point_info cur_idx;
	struct sensor_rgb_gtm_level rgb_gtm_param[SENSOR_RGB_GTM_NUM];
};
...
//cnr_h
struct sensor_multilayer_param_cnr_h {
	cmr_u8 lowpass_filter_en;
	cmr_u8 denoise_radial_en;
	cmr_u8 filter_size;
	cmr_u8 order_y[3];
	...
	float sigma_y[3];
	float sigma_uv[3];
	cmr_u8 weight_y[3][72];
	cmr_u8 weight_uv[3][72];
	cmr_u16 reserved1[10];
};

struct sensor_cnr_h_level {
	cmr_u8 level_enable;
	cmr_u8 reserved0[3];
	cmr_u16 low_ct_thrd;
	cmr_u16 radius_base;
	struct sensor_multilayer_param_cnr_h param_layer_cnr_h[CNR_H_LAYER_NUM];
	cmr_u16 reserved1[10];
};

//post_cnr
struct sensor_multilayer_param_post_cnr_h {
	cmr_u8 lowpass_filter_en;
	cmr_u8 denoise_radial_en;
	cmr_u8 filter_size;
	cmr_u8 order_y[3];
...
struct sensor_post_cnr_h_level {
	cmr_u8 level_enable;
	cmr_u8 reserved0[3];
	cmr_u16 low_ct_thrd;
	cmr_u16 radius_base;
	struct sensor_multilayer_param_post_cnr_h multilayer_param_post_cnr_h;
	cmr_u16 reserved1[10];
};
...
enum {
	...
	ISP_BLK_MFNR_T,
	ISP_BLK_POST_EE_T,
	ISP_BLK_PYRAMID_ONL_T,
	ISP_BLK_PYRAMID_OFFL_T,
	ISP_BLK_DCT_T,
	ISP_BLK_CNR_H_T,
	ISP_BLK_POST_CNR_H_T,
	ISP_BLK_NR_MAX
};
...
struct sensor_nr_set_group_param {
	...
	cmr_u32 post_ee_len;
	cmr_u8 *pyramid_onl;
	cmr_u32 pyramid_onl_len;
	cmr_u8 *pyramid_offl;
	cmr_u32 pyramid_offl_len;
	cmr_u8 *dct;
	cmr_u32 dct_len;
	cmr_u8 *cnr_h;
	cmr_u32 cnr_h_len;
	cmr_u8 *post_cnr_h;
	cmr_u32 post_cnr_h_len;
};
...
struct denoise_param_update {
	...
	struct sensor_pyramid_onl_level *pyramid_onl_level_ptr;
	struct sensor_pyramid_offl_level *pyramid_offl_level_ptr;
	struct sensor_dct_level *dct_level_ptr;
	struct sensor_cnr_h_level *cnr_h_level_ptr;
	struct sensor_post_cnr_h_level *post_cnr_h_level_ptr;
