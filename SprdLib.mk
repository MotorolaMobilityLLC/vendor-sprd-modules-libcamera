...
LOCAL_SHARED_LIBRARIES += libsprd_portrait_cap libsprddepth libbokeh_depth libSegLiteMNN
#else ifeq ($(strip $(TARGET_BOARD_SPRD_RANGEFINDER_SUPPORT)),true)
#LOCAL_SHARED_LIBRARIES += libsprddepth libalParseOTP
endif

ifeq ($(strip $(TARGET_BOARD_PORTRAIT_SINGLE_SUPPORT)),true)
LOCAL_SHARED_LIBRARIES += libbokeh_gaussian libbokeh_gaussian_cap libSegLiteMNN libBokeh2Frames libsprd_portrait_cap
endif
