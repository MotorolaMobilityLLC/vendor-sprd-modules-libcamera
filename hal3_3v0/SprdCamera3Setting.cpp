...
const sensor_fov_tab_t back_sensor_fov_tab[] =
{
	...
	{"s5k3p8sm_mipi_raw",{4.640f,3.488f},3.563f},
	{"", {3.50f, 2.625f}, 3.75f},
};
...
int32_t jpeg_stream_size = (4160 * 3120 * 3 / 2 + sizeof(camera3_jpeg_blob_t));
...
const int32_t kavailable_back_stream_configurations[CAMERA_SETTINGS_CONFIG_ARRAYSIZE][4] = {
#if defined(CONFIG_CAMERA_SUPPORT_21M)
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 5312, 3984, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_16M)
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 4608, 3456, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_13M)
	//{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 4128, 3104, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 4160, 3120, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_4K2K)
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 3840, 2160, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_21M) || \
    defined(CONFIG_CAMERA_SUPPORT_16M) || \
    defined(CONFIG_CAMERA_SUPPORT_13M) || \
    defined(CONFIG_CAMERA_SUPPORT_8M)
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 3840, 2160, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 3264, 2448, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 3264, 1836, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 2592, 1944, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 2560, 1920, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 2560, 1440, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 2048, 1536, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1920, 1920, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	...
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 480, 480, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	...
	{HAL_PIXEL_FORMAT_YV12, 1920, 1080, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
...
#if defined(CONFIG_CAMERA_SUPPORT_21M)
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 5312, 3984, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_16M)
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 4608, 3456, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_13M)
	//{HAL_PIXEL_FORMAT_YCbCr_420_888, 4128, 3104, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	...
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 1920, 1920, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	...
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 480, 480, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
...
#if defined(CONFIG_CAMERA_SUPPORT_21M)
	{HAL_PIXEL_FORMAT_BLOB, 5312, 3984, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_16M)
	{HAL_PIXEL_FORMAT_BLOB, 4608, 3456, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_13M)
	//{HAL_PIXEL_FORMAT_BLOB, 4128, 3104, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
    ...
    defined(CONFIG_CAMERA_SUPPORT_13M) || \
    defined(CONFIG_CAMERA_SUPPORT_8M)
	{HAL_PIXEL_FORMAT_BLOB, 3840, 2160, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	...
	{HAL_PIXEL_FORMAT_BLOB, 1920, 1920, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	...
	{HAL_PIXEL_FORMAT_BLOB, 480, 480, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
...
#endif
#if defined(CONFIG_FRONT_CAMERA_SUPPORT_8M) || \
    defined(CONFIG_FRONT_CAMERA_SUPPORT_5M)
	{HAL_PIXEL_FORMAT_BLOB, 2592, 1944, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_BLOB, 2576, 1932, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_BLOB, 2560, 1440, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
	{HAL_PIXEL_FORMAT_BLOB, 2048, 1536, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_BLOB, 2048, 1152, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_BLOB, 1920, 1920, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_BLOB, 1920, 1080, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_BLOB, 1600, 1200, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_BLOB, 1280, 960, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
...
//	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1920, 1080, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	...
	{HAL_PIXEL_FORMAT_YV12, 1280, 960, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_YV12, 1280, 720, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_YV12, 800, 600, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_YV12, 640, 480, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
...
//	{HAL_PIXEL_FORMAT_YCbCr_420_888, 1920, 1080, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	...
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 1280, 960, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 1280, 720, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 800, 600, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 640, 480, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 320, 240, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
...
const int64_t kavailable_back_min_frame_durations[CAMERA_SETTINGS_CONFIG_ARRAYSIZE][4] = {
	...
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 4160, 3120, 33331760L},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_4K2K)
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 3840, 2160, 33331760L},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_21M) || \
    defined(CONFIG_CAMERA_SUPPORT_16M) || \
    defined(CONFIG_CAMERA_SUPPORT_13M) || \
	...
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 3264, 1836, 33331760L},
#endif
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 2592, 1944, 33331760L},
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 2560, 1920, 33331760L},
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 2560, 1440, 33331760L},
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 2048, 1536, 33331760L},
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1920, 1920, 33331760L},
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1920, 1080, 33331760L},
	...
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 480, 480, 33331760L},
	...
	{HAL_PIXEL_FORMAT_YV12, 1920, 1080, 33331760L},
...
//	{HAL_PIXEL_FORMAT_YCbCr_420_888, 4128, 3104, 33331760L},
    ...
    defined(CONFIG_CAMERA_SUPPORT_13M) || \
    defined(CONFIG_CAMERA_SUPPORT_8M)
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 3840, 2160, 33331760L},
	...
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 1920, 1920, 33331760L},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 1920, 1080, 33331760L},
	...
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 480, 480, 33331760L},
...
#if defined(CONFIG_CAMERA_SUPPORT_21M)
	{HAL_PIXEL_FORMAT_BLOB, 5312, 3984, 33331760L},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_16M)
	{HAL_PIXEL_FORMAT_BLOB, 4608, 3456, 33331760L},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_13M)
//	{HAL_PIXEL_FORMAT_BLOB, 4128, 3104, 33331760L},
    ...
    defined(CONFIG_CAMERA_SUPPORT_13M) || \
    defined(CONFIG_CAMERA_SUPPORT_8M)
	{HAL_PIXEL_FORMAT_BLOB, 3840, 2160, 33331760L},
	...
	{HAL_PIXEL_FORMAT_BLOB, 2448, 2448, 33331760L},
	{HAL_PIXEL_FORMAT_BLOB, 2048, 1536, 33331760L},
	{HAL_PIXEL_FORMAT_BLOB, 2048, 1152, 33331760L},
	{HAL_PIXEL_FORMAT_BLOB, 1920, 1920, 33331760L},
	...
	{HAL_PIXEL_FORMAT_BLOB, 480, 480, 33331760L},
...
const int64_t kavailable_front_min_frame_durations[CAMERA_SETTINGS_CONFIG_ARRAYSIZE][4] = {
	...
	{HAL_PIXEL_FORMAT_BLOB, 2592, 1944, 33331760L},
#endif
	{HAL_PIXEL_FORMAT_BLOB, 2576, 1932, 33331760L},
	{HAL_PIXEL_FORMAT_BLOB, 2560, 1440, 33331760L},
	{HAL_PIXEL_FORMAT_BLOB, 1920, 1920, 33331760L},
	{HAL_PIXEL_FORMAT_BLOB, 2048, 1536, 33331760L},
	{HAL_PIXEL_FORMAT_BLOB, 2048, 1152, 33331760L},
	{HAL_PIXEL_FORMAT_BLOB, 1920, 1080, 33331760L},
...
//	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1920, 1080, 33331760L},
	...
	{HAL_PIXEL_FORMAT_YV12, 1280, 960, 33331760L},
	{HAL_PIXEL_FORMAT_YV12, 1280, 720, 33331760L},
	{HAL_PIXEL_FORMAT_YV12, 800, 600, 33331760L},
	{HAL_PIXEL_FORMAT_YV12, 640, 480, 33331760L},
...
//	{HAL_PIXEL_FORMAT_YCbCr_420_888, 1920, 1080, 33331760L},
	...
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 1280, 960, 33331760L},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 1280, 720, 33331760L},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 800, 600, 33331760L},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 640, 480, 33331760L},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 320, 240, 33331760L},
...
#if defined(CONFIG_CAMERA_SUPPORT_21M)
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 5312, 3984, 0L},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_16M)
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 4608, 3456, 0L},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_13M)
//	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 4128, 3104, 0L},
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 4160, 3120, 0L},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_4K2K)
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 3840, 2160, 0L},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_21M) || \
    defined(CONFIG_CAMERA_SUPPORT_16M) || \
    defined(CONFIG_CAMERA_SUPPORT_13M) || \
	...
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 3264, 1836, 0L},
#endif
	...
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1920, 1920, 0L},
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1920, 1080, 0L},
	...
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 480, 480, 0L},
	...
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 5312, 3984, 0L},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 4608, 3456, 0L},
//	{HAL_PIXEL_FORMAT_YCbCr_420_888, 4128, 3104, 0L},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 4160, 3120, 0L},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 3840, 2160, 0L},
	...
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 1920, 1920, 0L},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 1920, 1080, 0L},
	...
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 800, 600, 0L},
	...
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 480, 480, 0L},
...
const cam_dimension_t  largest_stream_sizes[CAMERA_ID_COUNT] =
{
#if defined(CONFIG_CAMERA_SUPPORT_21M)
	{5312, 3984},
#elif defined(CONFIG_CAMERA_SUPPORT_16M)
...
int SprdCamera3Setting::setLargestSensorSize(int32_t cameraId, cmr_u16 width, cmr_u16 height)
{
	sensor_max_width[cameraId]  =  width;
	sensor_max_height[cameraId] =  height;

	HAL_LOGD("camera id = %d, max_width =%d, max_height = %d",
			cameraId, sensor_max_width[cameraId] ,sensor_max_height[cameraId]);

	return 0 ;
}

int SprdCamera3Setting::getLargestSensorSize(int32_t cameraId, cmr_u16 *width, cmr_u16 *height)
{
#ifdef CONFIG_CAMERA_AUTO_DETECT_SENSOR
	*width  = sensor_max_width[cameraId];
	*height = sensor_max_height[cameraId];
#else
	*width = largest_stream_sizes[cameraId].width;
	*height = largest_stream_sizes[cameraId].height;
#endif
	HAL_LOGD("camera id = %d, max_width =%d, max_height = %d", cameraId, *width, *height);
	return 0;
}

int SprdCamera3Setting::getLargestPictureSize(int32_t cameraId, cmr_u16 *width, cmr_u16 *height)
{
...
{
	struct sensor_drv_context *sensor_cxt = (struct sensor_drv_context *)malloc(sizeof(struct sensor_drv_context ));
	int ret = 0;
	...
	if(ret) {
		...
		HAL_LOGD("camera id = %d, sensor_max_height = %d, sensor_max_width= %d", cameraId,
				sensor_cxt->sensor_list_ptr[cameraId]->source_height_max, sensor_cxt->sensor_list_ptr[cameraId]->source_width_max);
	}

	setLargestSensorSize(cameraId, sensor_cxt->sensor_list_ptr[cameraId]->source_width_max, sensor_cxt->sensor_list_ptr[cameraId]->source_height_max);
...
int SprdCamera3Setting::initStaticParameters(int32_t cameraId)
{
	...
	for (size_t j = 0; j < scaler_formats_count; j++) {
		for (size_t i = 0; i < stream_sizes_tbl_cnt; i++) {
			if((stream_info[i].stream_sizes_tbl.width <= largest_sensor_width) && (stream_info[i].stream_sizes_tbl.height  <= largest_sensor_height)){
				available_stream_configs.add(scaler_formats[j]);
				available_stream_configs.add(stream_info[i].stream_sizes_tbl.width);
				...
				available_stream_configs.add(ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT);
				 /* keep largest */
				if (stream_info[i].stream_sizes_tbl.width >= largest_picture_size[cameraId].width &&stream_info[i].stream_sizes_tbl.height>= largest_picture_size[cameraId].height)
					largest_picture_size[cameraId] =stream_info[i].stream_sizes_tbl;
			}
		}
	}
	memcpy(s_setting[cameraId].scalerInfo.available_stream_configurations, &(available_stream_configs[0]), available_stream_configs.size()*sizeof(int32_t));
	...
	for (size_t j = 0; j < scaler_formats_count; j++) {
		for (size_t i = 0; i < stream_sizes_tbl_cnt; i++) {
			if((stream_info[i].stream_sizes_tbl.width <= largest_sensor_width) && (stream_info[i].stream_sizes_tbl.height  <= largest_sensor_height)){
				...
				available_min_durations.add(stream_info[i].stream_sizes_tbl.width);
				available_min_durations.add(stream_info[i].stream_sizes_tbl.height);
				available_min_durations.add(stream_info[i].stream_min_duration);
			}
		}
	}
	memcpy(s_setting[cameraId].scalerInfo.min_frame_durations, &(available_min_durations[0]), available_min_durations.size()*sizeof(int64_t));
	...
	for (size_t j = 0; j < scaler_formats_count; j++) {
		for (size_t i = 0; i < stream_sizes_tbl_cnt; i++) {
			if((stream_info[i].stream_sizes_tbl.width <= largest_sensor_width) && (stream_info[i].stream_sizes_tbl.height  <= largest_sensor_height)){
				if (scaler_formats[j] == (HAL_PIXEL_FORMAT_BLOB||HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED||HAL_PIXEL_FORMAT_RAW16 )) {
					available_stall_durations.add(scaler_formats[j]);
					available_stall_durations.add(stream_info[i].stream_sizes_tbl.width);
					available_stall_durations.add(stream_info[i].stream_sizes_tbl.height);
					available_stall_durations.add(stream_info[i].stream_stall_duration);
				}else{
					available_stall_durations.add(scaler_formats[j]);
					available_stall_durations.add(stream_info[i].stream_sizes_tbl.width);
					available_stall_durations.add(stream_info[i].stream_sizes_tbl.height);
	...
	memcpy(s_setting[cameraId].scalerInfo.stall_durations, &(available_stall_durations[0]), available_stall_durations.size()*sizeof(int64_t));
	...
	s_setting[cameraId].sensor_InfoInfo.pixer_array_size[0] = largest_picture_size[cameraId].width;
	s_setting[cameraId].sensor_InfoInfo.pixer_array_size[1] = largest_picture_size[cameraId].height;
	s_setting[cameraId].sensor_InfoInfo.active_array_size[0] =	0;
	s_setting[cameraId].sensor_InfoInfo.active_array_size[1] =	0;
	s_setting[cameraId].sensor_InfoInfo.active_array_size[2] =	largest_picture_size[cameraId].width;
	s_setting[cameraId].sensor_InfoInfo.active_array_size[3] =	largest_picture_size[cameraId].height;
	...
	jpeg_stream_size = getJpegStreamSize(cameraId,largest_picture_size[cameraId].width,largest_picture_size[cameraId].height);
...
#define FILL_CAM_INFO_ARRAY(Array, Start, Num, Flag) \
	...
	FILL_CAM_INFO_ARRAY(s_setting[cameraId].scalerInfo.available_stream_configurations, 0,
				CAMERA_SETTINGS_CONFIG_ARRAYSIZE, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS)
	...
	FILL_CAM_INFO_ARRAY(s_setting[cameraId].scalerInfo.min_frame_durations, 0,
				CAMERA_SETTINGS_CONFIG_ARRAYSIZE, ANDROID_SCALER_AVAILABLE_MIN_FRAME_DURATIONS)
	FILL_CAM_INFO_ARRAY(s_setting[cameraId].scalerInfo.stall_durations, 0,
				CAMERA_SETTINGS_CONFIG_ARRAYSIZE, ANDROID_SCALER_AVAILABLE_STALL_DURATIONS)
										...
										camera_metadata_t **metadata)
{
	...
	if(mCameraId == 0){
		...
		requestInfo.update(ANDROID_SPRD_DUAL_OTP_FLAG, &(s_setting[mCameraId].otpInfo.dual_otp_flag),1);
	}
...
//JPEG
	...
	if (frame_settings.exists(ANDROID_JPEG_THUMBNAIL_QUALITY) && is_capture) {
		valueU8 = frame_settings.find(ANDROID_JPEG_THUMBNAIL_QUALITY).data.u8[0];
		GET_VALUE_IF_DIF(s_setting[mCameraId].jpgInfo.thumbnail_quality, valueU8, ANDROID_JPEG_THUMBNAIL_QUALITY)
	...
	if (frame_settings.exists(ANDROID_FLASH_MODE)) {
		...
		GET_VALUE_IF_DIF(s_setting[mCameraId].flashInfo.mode, valueU8, ANDROID_FLASH_MODE)
	...
	valueU8 = frame_settings.find(ANDROID_CONTROL_AE_MODE).data.u8[0];
		...
		GET_VALUE_IF_DIF(s_setting[mCameraId].controlInfo.ae_mode,valueU8,ANDROID_CONTROL_AE_MODE)
	}
	...
	if (frame_settings.exists(ANDROID_CONTROL_AE_EXPOSURE_COMPENSATION)) {
		...
		ae_compensat = (frame_settings.find(ANDROID_CONTROL_AE_EXPOSURE_COMPENSATION).data.i32[0] + s_setting[mCameraId].controlInfo.ae_compensation_range[1])/2;
...
//SPRD
	...
	if (frame_settings.exists(ANDROID_SPRD_3DCALIBRATION_ENABLED)) {
		valueU8 = frame_settings.find(ANDROID_SPRD_3DCALIBRATION_ENABLED).data.u8[0];
		GET_VALUE_IF_DIF(s_setting[mCameraId].sprddefInfo.sprd_3dcalibration_enabled, valueU8, ANDROID_SPRD_3DCALIBRATION_ENABLED)
...
//AF_CONTROL
	...
	if (frame_settings.exists(ANDROID_CONTROL_AF_MODE)) {
		...
		GET_VALUE_IF_DIF(s_setting[mCameraId].controlInfo.af_mode, valueU8, ANDROID_CONTROL_AF_MODE)
...
SprdCamera3Setting::translateLocalToFwMetadata()
{
	...
	if(mCameraId == 0){// && s_setting[mCameraId].otpInfo.otp_data){ // "s_setting[mCameraId].otpInfo.otp_data" always "true"
		...
		camMetadata.update(ANDROID_SPRD_DUAL_OTP_FLAG, &(s_setting[mCameraId].otpInfo.dual_otp_flag),1);
	}
	if(mCameraId == 0){
