...
typedef enum sprd_camera_ext_tags {
    ...
    ANDROID_SPRD_AUTO_SLIDE_POSITION,
    ...
    ANDROID_SPRD_NOTIFY_NEXT_CAPTURE,
    ANDROID_SPRD_ENGENEER_MODE_PARAM,
    ...
    ANDROID_SPRD_AWB_CT_VALUE,
    ANDROID_SPRD_FALSH_CALIBRATION_ENABLE,
    ANDROID_SPRD_FALSH_CALIBRATION_RESULT,
    ANDROID_SPRD_SN_READY,
    VENDOR_SECTION_END,
