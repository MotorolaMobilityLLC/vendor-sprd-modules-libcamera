...
const int32_t kavailable_back_stream_configurations[CAMERA_SETTINGS_CONFIG_ARRAYSIZE][4] = {
	...
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 3840, 2176, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
...
const int64_t kavailable_back_min_frame_durations[CAMERA_SETTINGS_CONFIG_ARRAYSIZE][4] = {
	...
	#endif*/
#ifdef CONFIG_CAMERA_SUPPORT_4K2K
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 3840, 2176, 33331760L},
#endif
...
const int64_t kavailable_back_stall_durations[CAMERA_SETTINGS_CONFIG_ARRAYSIZE][4] = {
	...
	*/
#ifdef CONFIG_CAMERA_SUPPORT_4K2K
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 3840, 2176, 0L},
#endif
