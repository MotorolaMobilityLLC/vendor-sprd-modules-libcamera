...
/*#if defined(CONFIG_CAMERA_SUPPORT_21M)
	...
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 2448, 2448, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
...
*/
...
#ifdef CONFIG_CAMERA_SUPPORT_4K2K
	...
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 4128, 3104, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},//for ss
	//HAL_PIXEL_FORMAT_YCbCr_420_888, 3104, 4128, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},//for ss
	//HAL_PIXEL_FORMAT_YCbCr_420_888, 4160, 3120, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_21M) || defined(CONFIG_CAMERA_SUPPORT_16M) || defined(CONFIG_CAMERA_SUPPORT_13M) || defined (CONFIG_CAMERA_SUPPORT_8M)
	...
	{HAL_PIXEL_FORMAT_BLOB, 320, 240, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT}, //for CTS
	...
	{HAL_PIXEL_FORMAT_BLOB, 176, 144, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#elif defined(CONFIG_CAMERA_SUPPORT_13M)
	{HAL_PIXEL_FORMAT_BLOB, 4128, 3104, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},//for ss
//	{HAL_PIXEL_FORMAT_BLOB, 3104, 4128, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},//for ss
...
/*
	...
	*/
	...
	{HAL_PIXEL_FORMAT_BLOB, 1920, 1080, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},//for cts
	{HAL_PIXEL_FORMAT_BLOB, 2048, 1536, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},//for ss
	{HAL_PIXEL_FORMAT_BLOB, 2048, 1152, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},//for ss
	{HAL_PIXEL_FORMAT_BLOB, 1280, 720, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},//for cts
#endif
#ifdef CONFIG_FRONT_CAMERA_SUPPORT_5M
	{HAL_PIXEL_FORMAT_BLOB, 2592, 1944, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_BLOB, 2576, 1932, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},//for ss
...
#endif
#if defined(CONFIG_CAMERA_SUPPORT_13M)
         {HAL_PIXEL_FORMAT_YCbCr_420_888, 4128, 3104, 33331760L},//for ss
 //        {HAL_PIXEL_FORMAT_YCbCr_420_888, 3104, 4128, 33331760L},//for ss
//       {HAL_PIXEL_FORMAT_YCbCr_420_888, 4160, 3120, 33331760L},
	...
	{HAL_PIXEL_FORMAT_BLOB, 1280, 720, 33331760L},
#elif defined(CONFIG_CAMERA_SUPPORT_13M)
	{HAL_PIXEL_FORMAT_BLOB, 4128, 3104, 33331760L},//for ss
//	{HAL_PIXEL_FORMAT_BLOB, 3104, 4128, 33331760L},//for ss
...
#endif
#if defined(CONFIG_CAMERA_SUPPORT_13M)
         {HAL_PIXEL_FORMAT_YCbCr_420_888, 4128, 3104, 0L},//for ss
//         {HAL_PIXEL_FORMAT_YCbCr_420_888, 3104, 4128, 0L},//for ss
//	{HAL_PIXEL_FORMAT_YCbCr_420_888, 4160, 3120, 0L},
	...
	{HAL_PIXEL_FORMAT_BLOB, 1280, 960, 33331760L},
	{HAL_PIXEL_FORMAT_BLOB, 1280, 720, 33331760L},
	{HAL_PIXEL_FORMAT_BLOB, 720, 480, 33331760L},//for cts
#elif defined(CONFIG_CAMERA_SUPPORT_16M)
	{HAL_PIXEL_FORMAT_BLOB, 4608, 3456, 33331760L},
	{HAL_PIXEL_FORMAT_BLOB, 3264, 2448, 33331760L},
	{HAL_PIXEL_FORMAT_BLOB, 3264, 1836, 33331760L},//for ss
...
/*
	...
	*/
	...
	{HAL_PIXEL_FORMAT_BLOB, 2048, 1536, 33331760L},//for ss
	{HAL_PIXEL_FORMAT_BLOB, 2048, 1152, 33331760L},//for ss
	{HAL_PIXEL_FORMAT_BLOB, 1920, 1080, 33331760L},//for cts
	{HAL_PIXEL_FORMAT_BLOB, 1280, 720, 33331760L},//for cts
