...
int32_t jpeg_stream_size = ((5344 * 4016 + (2*1024-1)) & ~(2*1024-1));
...
const int32_t kavailable_back_stream_configurations[CAMERA_SETTINGS_CONFIG_ARRAYSIZE][4] = {
	...
	*/
#if defined(CONFIG_CAMERA_SUPPORT_21M)
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 5344, 4016, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
...
#if defined(CONFIG_CAMERA_SUPPORT_21M)
	{HAL_PIXEL_FORMAT_BLOB, 5344, 4016, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
...
#if defined(CONFIG_CAMERA_SUPPORT_21M)
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 5344, 4016, 33331760L},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_16M)
...
#if defined(CONFIG_CAMERA_SUPPORT_21M)
	{HAL_PIXEL_FORMAT_BLOB, 5344, 4016, 33331760L},
...
const int64_t kavailable_back_stall_durations[CAMERA_SETTINGS_CONFIG_ARRAYSIZE][4] = {
	...
	*/
#if defined(CONFIG_CAMERA_SUPPORT_21M)
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 5344, 4016, 0L},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_16M)
