...
#define alRnBRT_ERR_BUFFER_SIZE_TOO_SMALL    (alRnBRT_ERR_MODULE+0x00000003) //462851
...
#define alRnBRT_ERR_INVALID_EXPOSURE_INFO    (alRnBRT_ERR_MODULE+0x00000006) //462854
#define alRnBRT_ERR_INVALID_IMG_RATIO        (alRnBRT_ERR_MODULE+0x00000007) //462855
#define alRnBRT_ERR_INVALID_DEPTH_IMG_RATIO  (alRnBRT_ERR_MODULE+0x00000008) //462856
#define alRnBRT_ERR_INVALID_F_NUMBER         (alRnBRT_ERR_MODULE+0x00000009) //462857
#define alRnBRT_ERR_INVALID_BLUR_STRENGTH    (alRnBRT_ERR_MODULE+0x0000000a) //462858
#define alRnBRT_ERR_INVALID_COORDINATE       (alRnBRT_ERR_MODULE+0x0000000b) //462859
#define alRnBRT_ERR_UNREGISTERED_DEPTH_MAP   (alRnBRT_ERR_MODULE+0x0000000c) //462860
...
extern "C" {
    ...
    alRnBRT_ERR_CODE alRnBRT_ReFocus(unsigned char *a_pucOutYCCNV21, unsigned char *a_pucInYCCNV21Buf, unsigned char *a_puwInDisparityBuf,
