...
### adapter ###
include $(CLEAR_VARS)
LOCAL_SRC_FILES := src/sprd_mfsr_adapter.cpp
LOCAL_MODULE := libsprdmfsradapter
LOCAL_MODULE_TAGS := optional
LOCAL_CFLAGS := -O3 -fno-strict-aliasing -fPIC -fvisibility=hidden
LOCAL_SHARED_LIBRARIES := libcutils liblog libsprd_mfsr libsprdcamalgassist
...
LOCAL_CFLAGS += -DALIGN_INPUT_MODE=2
