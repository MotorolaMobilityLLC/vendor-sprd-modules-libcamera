...
FAAPI(int)
FaFaceAlign(FA_ALIGN_HANDLE hFA, const FA_IMAGE *grayImage,
            const FA_FACEINFO *face, FA_SHAPE *shape);

/* Track face landmarks based on previous landamrks*/
FAAPI(int)
FaFaceTrack(FA_ALIGN_HANDLE hFA, const FA_IMAGE *grayImage,
            const FA_SHAPE *preShape, FA_SHAPE *curShape);
