...
else ifeq ($(strip $(TARGET_CAMERA_SENSOR_CCT)),"sensorHub")
LOCAL_CFLAGS += -DTARGET_CAMERA_SENSOR_CCT_SENSORHUB
endif
...
ifeq ($(strip $(TARGET_BOARD_BOKEH_CALIBRATION_VERSION)),2)
	LOCAL_CFLAGS += -DBOKEH_CALIBRATION_VERSION2
else ifeq ($(strip $(TARGET_BOARD_BOKEH_CALIBRATION_VERSION)),3)
	LOCAL_CFLAGS += -DBOKEH_CALIBRATION_VERSION3
else
	LOCAL_CFLAGS += -DBOKEH_CALIBRATION_VERSION1
endif

ifeq ($(strip $(TARGET_BOARD_OZ_CALIBRATION_VERSION)),2)
	LOCAL_CFLAGS += -DOZ_CALIBRATION_VERSION2
else
	LOCAL_CFLAGS += -DOZ_CALIBRATION_VERSION1
endif
...
ifeq ($(strip $(TARGET_BOARD_GC5035_MIRROR_NORMAL)),true)
LOCAL_CFLAGS += -DGC5035_MIRROR_NORMAL
else ifeq ($(strip $(TARGET_BOARD_GC5035_MIRROR_H)),true)
LOCAL_CFLAGS += -DGC5035_MIRROR_H
else ifeq ($(strip $(TARGET_BOARD_GC5035_MIRROR_V)),true)
LOCAL_CFLAGS += -DGC5035_MIRROR_V
else ifeq ($(strip $(TARGET_BOARD_GC5035_MIRROR_HV)),true)
LOCAL_CFLAGS += -DGC5035_MIRROR_HV
endif

ifeq ($(strip $(TARGET_BOARD_ID2_FOR_OCCLUSION)),true)
LOCAL_CFLAGS += -DID2_FOR_OCCLUSION
endif
...
ifeq ($(strip $(TARGET_BOARD_OV13855_DGAIN_SUPPORT)),true)
LOCAL_CFLAGS += -DOV13855_DGAIN_SUPPORT
endif
...
ifeq ($(strip $(TARGET_BOARD_SPRD_CALLBACK_HIGH_FPS_MODE)),true)
LOCAL_CFLAGS += -DSPRD_CALLBACK_HIGH_FPS_MODE
endif
...
LOCAL_CFLAGS += -DCONFIG_SPRD_HDR_LIB_VERSION_3
endif
endif
...
LOCAL_CFLAGS += -DCONFIG_CAMERA_IMAGE_FLIP
endif
...
else ifeq ($(strip $(TARGET_BOARD_PLATFORM)),ums9230)
LOCAL_CFLAGS += -DPLATFORM_ID=$(LOCAL_PLATFORM_ID_SHARKL6)
else ifneq ($(filter $(strip $(TARGET_BOARD_PLATFORM)),ums9520 ums9620),)
LOCAL_CFLAGS += -DPLATFORM_ID=$(LOCAL_PLATFORM_ID_SHARKL6P)
else
LOCAL_CFLAGS += -DPLATFORM_ID=$(LOCAL_PLATFORM_ID_GENERIC)
endif
##check whether set PRIVATE_17
ifeq ($(strip $(TARGET_BOARD_CAMERA_GRALLOC1_USAGE_PRIVATE_17)),true)
LOCAL_CFLAGS += -DCONFIG_CAMERA_USAGE_PRIVATE_17
endif ## CAMERA_GRALLOC1_USAGE_PRIVATE_17

ifeq ($(strip $(TARGET_BOARD_YUVSENSOR_SUPPORT)),true)
LOCAL_CFLAGS += -DCONFIG_YUV_SUPPORT
endif
