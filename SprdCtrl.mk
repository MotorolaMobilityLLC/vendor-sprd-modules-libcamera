...
LOCAL_CFLAGS += -DCONFIG_CAMERA_SUPPORT_SIZE_21M
else ifeq ($(strip $(CAMERA_SUPPORT_SIZE)),20M)
LOCAL_CFLAGS += -DCONFIG_CAMERA_SUPPORT_SIZE_20M
else ifeq ($(strip $(CAMERA_SUPPORT_SIZE)),16M)
LOCAL_CFLAGS += -DCONFIG_CAMERA_SUPPORT_SIZE_16M
else ifeq ($(strip $(CAMERA_SUPPORT_SIZE)),13M)
LOCAL_CFLAGS += -DCONFIG_CAMERA_SUPPORT_SIZE_13M
else ifeq ($(strip $(CAMERA_SUPPORT_SIZE)),12M)
LOCAL_CFLAGS += -DCONFIG_CAMERA_SUPPORT_SIZE_12M
else ifeq ($(strip $(CAMERA_SUPPORT_SIZE)),8M)
LOCAL_CFLAGS += -DCONFIG_CAMERA_SUPPORT_SIZE_8M
else ifeq ($(strip $(CAMERA_SUPPORT_SIZE)),5M)
LOCAL_CFLAGS += -DCONFIG_CAMERA_SUPPORT_SIZE_5M
else ifeq ($(strip $CAMERA_SUPPORT_SIZE)),3M)
LOCAL_CFLAGS += -DCONFIG_CAMERA_SUPPORT_SIZE_3M
else ifeq ($(strip $(CAMERA_SUPPORT_SIZE)),2M_1080P)
LOCAL_CFLAGS += -DCONFIG_CAMERA_SUPPORT_SIZE_2M_1080P
else ifeq ($(strip $(CAMERA_SUPPORT_SIZE)),2M)
LOCAL_CFLAGS += -DCONFIG_CAMERA_SUPPORT_SIZE_2M
else ifeq ($(strip $(CAMERA_SUPPORT_SIZE)),0M3)
LOCAL_CFLAGS += -DCONFIG_CAMERA_SUPPORT_SIZE_0M3
endif

ifeq ($(strip $(BACK_EXT_CAMERA_SUPPORT_SIZE)),21M)
LOCAL_CFLAGS += -DCONFIG_BACK_EXT_CAMERA_SUPPORT_SIZE_21M
else ifeq ($(strip $(BACK_EXT_CAMERA_SUPPORT_SIZE)),20M)
LOCAL_CFLAGS += -DCONFIG_BACK_EXT_CAMERA_SUPPORT_SIZE_20M
else ifeq ($(strip $(BACK_EXT_CAMERA_SUPPORT_SIZE)),16M)
LOCAL_CFLAGS += -DCONFIG_BACK_EXT_CAMERA_SUPPORT_SIZE_16M
else ifeq ($(strip $(BACK_EXT_CAMERA_SUPPORT_SIZE)),13M)
LOCAL_CFLAGS += -DCONFIG_BACK_EXT_CAMERA_SUPPORT_SIZE_13M
else ifeq ($(strip $(BACK_EXT_CAMERA_SUPPORT_SIZE)),12M)
LOCAL_CFLAGS += -DCONFIG_BACK_EXT_CAMERA_SUPPORT_SIZE_12M
else ifeq ($(strip $(BACK_EXT_CAMERA_SUPPORT_SIZE)),8M)
LOCAL_CFLAGS += -DCONFIG_BACK_EXT_CAMERA_SUPPORT_SIZE_8M
...
LOCAL_CFLAGS += -DCONFIG_BACK_EXT_CAMERA_SUPPORT_SIZE_3M
...
LOCAL_CFLAGS += -DCONFIG_BACK_EXT2_CAMERA_SUPPORT_SIZE_21M
else ifeq ($(strip $(BACK_EXT2_CAMERA_SUPPORT_SIZE)),20M)
LOCAL_CFLAGS += -DCONFIG_BACK_EXT2_CAMERA_SUPPORT_SIZE_20M
else ifeq ($(strip $(BACK_EXT2_CAMERA_SUPPORT_SIZE)),16M)
LOCAL_CFLAGS += -DCONFIG_BACK_EXT2_CAMERA_SUPPORT_SIZE_16M
else ifeq ($(strip $(BACK_EXT2_CAMERA_SUPPORT_SIZE)),13M)
LOCAL_CFLAGS += -DCONFIG_BACK_EXT2_CAMERA_SUPPORT_SIZE_13M
else ifeq ($(strip $(BACK_EXT2_CAMERA_SUPPORT_SIZE)),12M)
LOCAL_CFLAGS += -DCONFIG_BACK_EXT2_CAMERA_SUPPORT_SIZE_12M
else ifeq ($(strip $(BACK_EXT2_CAMERA_SUPPORT_SIZE)),8M)
LOCAL_CFLAGS += -DCONFIG_BACK_EXT2_CAMERA_SUPPORT_SIZE_8M
else ifeq ($(strip $(BACK_EXT2_CAMERA_SUPPORT_SIZE)),5M)
LOCAL_CFLAGS += -DCONFIG_BACK_EXT2_CAMERA_SUPPORT_SIZE_5M
else ifeq ($(strip $(BACK_EXT2_CAMERA_SUPPORT_SIZE)),3M)
LOCAL_CFLAGS += -DCONFIG_BACK_EXT2_CAMERA_SUPPORT_SIZE_3M
else ifeq ($(strip $(BACK_EXT2_CAMERA_SUPPORT_SIZE)),2M_1080P)
LOCAL_CFLAGS += -DCONFIG_BACK_EXT2_CAMERA_SUPPORT_SIZE_2M_1080P
else ifeq ($(strip $(BACK_EXT2_CAMERA_SUPPORT_SIZE)),2M)
LOCAL_CFLAGS += -DCONFIG_BACK_EXT2_CAMERA_SUPPORT_SIZE_2M
else ifeq ($(strip $(BACK_EXT2_CAMERA_SUPPORT_SIZE)),0M3)
LOCAL_CFLAGS += -DCONFIG_BACK_EXT2_CAMERA_SUPPORT_SIZE_0M3
endif

ifeq ($(strip $(FRONT_CAMERA_SUPPORT_SIZE)),21M)
LOCAL_CFLAGS += -DCONFIG_FRONT_CAMERA_SUPPORT_SIZE_21M
else ifeq ($(strip $(FRONT_CAMERA_SUPPORT_SIZE)),20M)
LOCAL_CFLAGS += -DCONFIG_FRONT_CAMERA_SUPPORT_SIZE_20M
else ifeq ($(strip $(FRONT_CAMERA_SUPPORT_SIZE)),16M)
LOCAL_CFLAGS += -DCONFIG_FRONT_CAMERA_SUPPORT_SIZE_16M
else ifeq ($(strip $(FRONT_CAMERA_SUPPORT_SIZE)),13M)
LOCAL_CFLAGS += -DCONFIG_FRONT_CAMERA_SUPPORT_SIZE_13M
else ifeq ($(strip $(FRONT_CAMERA_SUPPORT_SIZE)),12M)
LOCAL_CFLAGS += -DCONFIG_FRONT_CAMERA_SUPPORT_SIZE_12M
else ifeq ($(strip $(FRONT_CAMERA_SUPPORT_SIZE)),8M)
LOCAL_CFLAGS += -DCONFIG_FRONT_CAMERA_SUPPORT_SIZE_8M
else ifeq ($(strip $(FRONT_CAMERA_SUPPORT_SIZE)),5M)
LOCAL_CFLAGS += -DCONFIG_FRONT_CAMERA_SUPPORT_SIZE_5M
else ifeq ($(strip $(FRONT_CAMERA_SUPPORT_SIZE)),3M)
LOCAL_CFLAGS += -DCONFIG_FRONT_CAMERA_SUPPORT_SIZE_3M
else ifeq ($(strip $(FRONT_CAMERA_SUPPORT_SIZE)),2M_1080P)
LOCAL_CFLAGS += -DCONFIG_FRONT_CAMERA_SUPPORT_SIZE_2M_1080P
else ifeq ($(strip $(FRONT_CAMERA_SUPPORT_SIZE)),2M)
LOCAL_CFLAGS += -DCONFIG_FRONT_CAMERA_SUPPORT_SIZE_2M
else ifeq ($(strip $(FRONT_CAMERA_SUPPORT_SIZE)),0M3)
LOCAL_CFLAGS += -DCONFIG_FRONT_CAMERA_SUPPORT_SIZE_0M3
endif

ifeq ($(strip $(FRONT_EXT_CAMERA_SUPPORT_SIZE)),21M)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT_CAMERA_SUPPORT_SIZE_21M
else ifeq ($(strip $(FRONT_EXT_CAMERA_SUPPORT_SIZE)),20M)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT_CAMERA_SUPPORT_SIZE_20M
else ifeq ($(strip $(FRONT_EXT_CAMERA_SUPPORT_SIZE)),16M)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT_CAMERA_SUPPORT_SIZE_16M
else ifeq ($(strip $(FRONT_EXT_CAMERA_SUPPORT_SIZE)),13M)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT_CAMERA_SUPPORT_SIZE_13M
else ifeq ($(strip $(FRONT_EXT_CAMERA_SUPPORT_SIZE)),12M)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT_CAMERA_SUPPORT_SIZE_12M
else ifeq ($(strip $(FRONT_EXT_CAMERA_SUPPORT_SIZE)),8M)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT_CAMERA_SUPPORT_SIZE_8M
else ifeq ($(strip $(FRONT_EXT_CAMERA_SUPPORT_SIZE)),5M)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT_CAMERA_SUPPORT_SIZE_5M
else ifeq ($(strip $(FRONT_EXT_CAMERA_SUPPORT_SIZE)),3M)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT_CAMERA_SUPPORT_SIZE_3M
else ifeq ($(strip $(FRONT_EXT_CAMERA_SUPPORT_SIZE)),2M_1080P)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT_CAMERA_SUPPORT_SIZE_2M_1080P
else ifeq ($(strip $(FRONT_EXT_CAMERA_SUPPORT_SIZE)),2M)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT_CAMERA_SUPPORT_SIZE_2M
else ifeq ($(strip $(FRONT_EXT_CAMERA_SUPPORT_SIZE)),0M3)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT_CAMERA_SUPPORT_SIZE_0M3
endif

ifeq ($(strip $(FRONT_EXT2_CAMERA_SUPPORT_SIZE)),21M)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT2_CAMERA_SUPPORT_SIZE_21M
else ifeq ($(strip $(FRONT_EXT2_CAMERA_SUPPORT_SIZE)),20M)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT2_CAMERA_SUPPORT_SIZE_20M
else ifeq ($(strip $(FRONT_EXT2_CAMERA_SUPPORT_SIZE)),16M)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT2_CAMERA_SUPPORT_SIZE_16M
else ifeq ($(strip $(FRONT_EXT2_CAMERA_SUPPORT_SIZE)),13M)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT2_CAMERA_SUPPORT_SIZE_13M
else ifeq ($(strip $(FRONT_EXT2_CAMERA_SUPPORT_SIZE)),12M)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT2_CAMERA_SUPPORT_SIZE_12M
else ifeq ($(strip $(FRONT_EXT2_CAMERA_SUPPORT_SIZE)),8M)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT2_CAMERA_SUPPORT_SIZE_8M
else ifeq ($(strip $(FRONT_EXT2_CAMERA_SUPPORT_SIZE)),5M)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT2_CAMERA_SUPPORT_SIZE_5M
else ifeq ($(strip $(FRONT_EXT2_CAMERA_SUPPORT_SIZE)),3M)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT2_CAMERA_SUPPORT_SIZE_3M
else ifeq ($(strip $(FRONT_EXT2_CAMERA_SUPPORT_SIZE)),2M_1080P)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT2_CAMERA_SUPPORT_SIZE_2M_1080P
else ifeq ($(strip $(FRONT_EXT2_CAMERA_SUPPORT_SIZE)),2M)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT2_CAMERA_SUPPORT_SIZE_2M
else ifeq ($(strip $(FRONT_EXT2_CAMERA_SUPPORT_SIZE)),0M3)
LOCAL_CFLAGS += -DCONFIG_FRONT_EXT2_CAMERA_SUPPORT_SIZE_0M3
endif
