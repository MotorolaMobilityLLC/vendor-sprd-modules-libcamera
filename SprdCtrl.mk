...
ifeq ($(strip $(TARGET_BOARD_PLATFORM)),sc9850kh)
LOCAL_CFLAGS += -DCONFIG_CAMERA_SKIP_STREAM
endif
...
LOCAL_CFLAGS += -DCONFIG_CAMERA_POWERHINT_LOWPOWER_BINDCORE
endif
endif
...
ifeq ($(strip $(TARGET_BOARD_CAMERA_MEET_JPG_ALIGNMENT)),true)
