...
ifeq ($(strip $(TARGET_BOARD_SENSOR_MAIN2_SUPPORT)),true)
LOCAL_CFLAGS += -DCONFIG_DCAM_SENSOR_MAIN2_SUPPORT
endif

ifeq ($(strip $(TARGET_BOARD_SENSOR_SUB2_SUPPORT)),true)
LOCAL_CFLAGS += -DCONFIG_DCAM_SENSOR_SUB2_SUPPORT
endif
