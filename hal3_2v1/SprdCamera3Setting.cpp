...
int32_t jpeg_stream_size =
    (2592 * HEIGHT_5M * 3 / 2 + sizeof(camera3_jpeg_blob_t));
...
const int32_t
    kavailable_back_stream_configurations[CAMERA_SETTINGS_CONFIG_ARRAYSIZE][4] =
        {
// Implementation-Defined
#if defined(CONFIG_CAMERA_SUPPORT_21M)
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 5312, 3984,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_16M)
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 4608, 3456,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_13M)
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 4160, 3120,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_4K_RECORD)
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 3840, 2160,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_21M) ||                                      \
    defined(CONFIG_CAMERA_SUPPORT_16M) ||                                      \
    defined(CONFIG_CAMERA_SUPPORT_13M) || defined(CONFIG_CAMERA_SUPPORT_8M)
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 3264, 2448,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 3264, HEIGHT_6M,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 2592, HEIGHT_5M,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            ...
            // ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1280, 960,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1280, 720,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 960, 720,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 864, 480,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 720, 544,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 720, 480,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 640, 480,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 640, 360,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 624, 352,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 480, 640,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 480, 480,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 352, 288,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 320, 240,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 288, 352,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 240, 320,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 176, 144,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},

            {HAL_PIXEL_FORMAT_YV12, 1920, HEIGHT_2M,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YV12, 1280, 960,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YV12, 1280, 720,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YV12, 864, 480,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YV12, 720, 544,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YV12, 720, 480,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YV12, 640, 480,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YV12, 352, 288,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YV12, 320, 240,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YV12, 176, 144,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},

// YUV_420_888
#if defined(CONFIG_CAMERA_SUPPORT_21M)
            {HAL_PIXEL_FORMAT_YCbCr_420_888, 5312, 3984,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_16M)
            {HAL_PIXEL_FORMAT_YCbCr_420_888, 4608, 3456,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_13M)
            {HAL_PIXEL_FORMAT_YCbCr_420_888, 4160, 3120,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_4K_RECORD)
    ...
    defined(CONFIG_CAMERA_SUPPORT_16M) ||                                      \
    defined(CONFIG_CAMERA_SUPPORT_13M) || defined(CONFIG_CAMERA_SUPPORT_8M)
            {HAL_PIXEL_FORMAT_YCbCr_420_888, 3264, 2448,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YCbCr_420_888, 3264, HEIGHT_6M,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
            {HAL_PIXEL_FORMAT_YCbCr_420_888, 2592, HEIGHT_5M,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            ...
            // ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YCbCr_420_888, 1280, 960,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YCbCr_420_888, 1280, 720,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YCbCr_420_888, 960, 720,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YCbCr_420_888, 864, 480,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YCbCr_420_888, 720, 544,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YCbCr_420_888, 720, 480,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YCbCr_420_888, 640, 480,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YCbCr_420_888, 480, 480,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YCbCr_420_888, 352, 288,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YCbCr_420_888, 320, 240,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_YCbCr_420_888, 176, 144,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},

// JPEG
#if defined(CONFIG_CAMERA_SUPPORT_21M)
            {HAL_PIXEL_FORMAT_BLOB, 5312, 3984,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_16M)
            {HAL_PIXEL_FORMAT_BLOB, 4608, 3456,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_13M)
            {HAL_PIXEL_FORMAT_BLOB, 4160, 3120,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_4K_RECORD)
    ...
    defined(CONFIG_CAMERA_SUPPORT_16M) ||                                      \
    defined(CONFIG_CAMERA_SUPPORT_13M) || defined(CONFIG_CAMERA_SUPPORT_8M)
            {HAL_PIXEL_FORMAT_BLOB, 3264, 2448,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_BLOB, 3264, HEIGHT_6M,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
            {HAL_PIXEL_FORMAT_BLOB, 2592, HEIGHT_5M,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            ...
            // ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_BLOB, 1280, 960,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_BLOB, 1280, 720,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_BLOB, 960, 720,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_BLOB, 720, 480,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_BLOB, 640, 480,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_BLOB, 480, 480,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_BLOB, 352, 288,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_BLOB, 320, 240,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
            {HAL_PIXEL_FORMAT_BLOB, 176, 144,
             ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
};

const int32_t kavailable_front_stream_configurations
...
const int32_t kavailable_back_ext_stream_configurations
    [CAMERA_SETTINGS_CONFIG_ARRAYSIZE][4] = {
        // Implementation-Defined
        //	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1920, HEIGHT_2M,
        // ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
        ...
        //	{HAL_PIXEL_FORMAT_YV12, 1600, 1200,
        // ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
        {HAL_PIXEL_FORMAT_YV12, 1280, 960,
         ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
        {HAL_PIXEL_FORMAT_YV12, 1280, 720,
         ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
        {HAL_PIXEL_FORMAT_YV12, 800, 600,
         ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
        {HAL_PIXEL_FORMAT_YV12, 640, 480,
         ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
        ...
        {HAL_PIXEL_FORMAT_YCbCr_420_888, 1280, 720,
         ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
        {HAL_PIXEL_FORMAT_YCbCr_420_888, 800, 600,
         ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
        {HAL_PIXEL_FORMAT_YCbCr_420_888, 640, 480,
         ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
        {HAL_PIXEL_FORMAT_YCbCr_420_888, 320, 240,
...
const int64_t
    kavailable_back_min_frame_durations[CAMERA_SETTINGS_CONFIG_ARRAYSIZE][4] = {
#if defined(CONFIG_CAMERA_SUPPORT_21M)
    ...
    defined(CONFIG_CAMERA_SUPPORT_13M) || defined(CONFIG_CAMERA_SUPPORT_8M)
        ...
        {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 3264, HEIGHT_6M, 33331760L},
#endif
        {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 2592, HEIGHT_5M, 33331760L},
        ...
        {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1920, HEIGHT_2M, 33331760L},
        //	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1600, 1200,
        // 33331760L},
        ...
        {HAL_PIXEL_FORMAT_YV12, 1920, HEIGHT_2M, 33331760L},
    ...
    defined(CONFIG_CAMERA_SUPPORT_13M) || defined(CONFIG_CAMERA_SUPPORT_8M)
        ...
        {HAL_PIXEL_FORMAT_YCbCr_420_888, 3264, HEIGHT_6M, 33331760L},
#endif
        {HAL_PIXEL_FORMAT_YCbCr_420_888, 2592, HEIGHT_5M, 33331760L},
        {HAL_PIXEL_FORMAT_YCbCr_420_888, 2048, 1536, 33331760L},
        {HAL_PIXEL_FORMAT_YCbCr_420_888, 1920, 1920, 33331760L},
        {HAL_PIXEL_FORMAT_YCbCr_420_888, 1920, HEIGHT_2M, 33331760L},
    ...
    defined(CONFIG_CAMERA_SUPPORT_13M) || defined(CONFIG_CAMERA_SUPPORT_8M)
        ...
        {HAL_PIXEL_FORMAT_BLOB, 3264, HEIGHT_6M, 33331760L},
#endif
        {HAL_PIXEL_FORMAT_BLOB, 2592, HEIGHT_5M, 33331760L},
        ...
        {HAL_PIXEL_FORMAT_BLOB, 1920, HEIGHT_2M, 33331760L},
...
const int64_t
    kavailable_front_min_frame_durations[CAMERA_SETTINGS_CONFIG_ARRAYSIZE][4] =
        {
#if defined(CONFIG_FRONT_CAMERA_SUPPORT_8M)
            {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 3264, 2448, 33331760L},
#endif
...
const int64_t kavailable_back_ext_min_frame_durations
    [CAMERA_SETTINGS_CONFIG_ARRAYSIZE][4] = {
        //	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1920, HEIGHT_2M,
        // 33331760L},
        //	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1600, 1200,
...
const int64_t
    kavailable_back_stall_durations[CAMERA_SETTINGS_CONFIG_ARRAYSIZE][4] = {
#if defined(CONFIG_CAMERA_SUPPORT_21M)
    ...
    defined(CONFIG_CAMERA_SUPPORT_13M) || defined(CONFIG_CAMERA_SUPPORT_8M)
        ...
        {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 3264, HEIGHT_6M, 0L},
#endif
        ...
        {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1920, HEIGHT_2M, 0L},
        ...
        {HAL_PIXEL_FORMAT_YCbCr_420_888, 3264, HEIGHT_6M, 0L},
        {HAL_PIXEL_FORMAT_YCbCr_420_888, 2592, HEIGHT_5M, 0L},
        {HAL_PIXEL_FORMAT_YCbCr_420_888, 2048, 1536, 0L},
        {HAL_PIXEL_FORMAT_YCbCr_420_888, 1920, 1920, 0L},
        {HAL_PIXEL_FORMAT_YCbCr_420_888, 1920, HEIGHT_2M, 0L},
...
const int64_t
    kavailable_front_stall_durations[CAMERA_SETTINGS_CONFIG_ARRAYSIZE][4] = {
        {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 3264, 2448, 0L},
        {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 2592, HEIGHT_5M, 0L},
        {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 2048, 1536, 0L},
        {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1920, 1920, 0L},
        //	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1600, 1200, 0L},
        {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1280, 960, 0L},
...
const int64_t
    kavailable_back_ext_stall_durations[CAMERA_SETTINGS_CONFIG_ARRAYSIZE][4] = {
        //	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1920, HEIGHT_2M, 0L},
        //	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1600, 1200, 0L},
        {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1280, 960, 0L},
        {HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1280, 720, 0L},
...
const int32_t kavailable_back_pixer_size[2] = {BACK_SENSOR_ORIG_WIDTH,
                                               BACK_SENSOR_ORIG_HEIGHT};
const int32_t kavailable_front_pixer_size[2] = {FRONT_SENSOR_ORIG_WIDTH,
                                                FRONT_SENSOR_ORIG_HEIGHT};
const int32_t kavailable_back_ext_pixer_size[2] = {BACK_EXT_SENSOR_ORIG_WIDTH,
                                                   BACK_EXT_SENSOR_ORIG_WIDTH};
const int32_t kavailable_front_ext_pixer_size[2] = {FRONT_SENSOR_ORIG_WIDTH,
                                                    FRONT_SENSOR_ORIG_HEIGHT};

const int32_t kavailable_back_active_size[4] = {0, 0, BACK_SENSOR_ORIG_WIDTH,
                                                BACK_SENSOR_ORIG_HEIGHT};
const int32_t kavailable_front_active_size[4] = {0, 0, FRONT_SENSOR_ORIG_WIDTH,
                                                 FRONT_SENSOR_ORIG_HEIGHT};
...
// lens_info
    ...
    if (cameraId == 0) {
        memcpy(s_setting[cameraId].sensor_InfoInfo.pixer_array_size,
               kavailable_back_pixer_size, sizeof(kavailable_back_pixer_size));
        memcpy(s_setting[cameraId].sensor_InfoInfo.active_array_size,
               kavailable_back_active_size,
               sizeof(kavailable_back_active_size));
    } else if (cameraId == 1) {
        memcpy(s_setting[cameraId].sensor_InfoInfo.pixer_array_size,
               kavailable_front_pixer_size,
               sizeof(kavailable_front_pixer_size));
        memcpy(s_setting[cameraId].sensor_InfoInfo.active_array_size,
               kavailable_front_active_size,
               sizeof(kavailable_front_active_size));
    }
#ifdef CONFIG_DCAM_SENSOR2_SUPPORT
    else if (cameraId == 2) {
        memcpy(s_setting[cameraId].sensor_InfoInfo.pixer_array_size,
               kavailable_back_ext_pixer_size,
               sizeof(kavailable_back_ext_pixer_size));
        memcpy(s_setting[cameraId].sensor_InfoInfo.active_array_size,
               kavailable_back_ext_active_size,
               sizeof(kavailable_back_ext_active_size));
    }
#endif
#ifdef CONFIG_DCAM_SENSOR3_SUPPORT
    else if (cameraId == 3) {
        memcpy(s_setting[cameraId].sensor_InfoInfo.pixer_array_size,
               kavailable_front_ext_pixer_size,
               sizeof(kavailable_front_ext_pixer_size));
        memcpy(s_setting[cameraId].sensor_InfoInfo.active_array_size,
               kavailable_front_ext_active_size,
               sizeof(kavailable_front_ext_active_size));
    }
#endif
    ...
    s_setting[cameraId].sensor_InfoInfo.timestamp_source = 0;
    ...
    if (cameraId == 0) {
        memcpy(s_setting[cameraId].scalerInfo.min_frame_durations,
               kavailable_back_min_frame_durations,
               sizeof(kavailable_back_min_frame_durations));
        memcpy(s_setting[cameraId].scalerInfo.stall_durations,
               kavailable_back_stall_durations,
               sizeof(kavailable_back_stall_durations));
        memcpy(s_setting[cameraId].scalerInfo.available_stream_configurations,
               kavailable_back_stream_configurations,
               sizeof(kavailable_back_stream_configurations));
    } else if (cameraId == 1) {
        memcpy(s_setting[cameraId].scalerInfo.min_frame_durations,
               kavailable_front_min_frame_durations,
               sizeof(kavailable_front_min_frame_durations));
        memcpy(s_setting[cameraId].scalerInfo.stall_durations,
               kavailable_front_stall_durations,
               sizeof(kavailable_front_stall_durations));
        memcpy(s_setting[cameraId].scalerInfo.available_stream_configurations,
               kavailable_front_stream_configurations,
               sizeof(kavailable_front_stream_configurations));
    }
#ifdef CONFIG_DCAM_SENSOR2_SUPPORT
    else if (cameraId == 2) {
        memcpy(s_setting[cameraId].scalerInfo.min_frame_durations,
               kavailable_back_ext_min_frame_durations,
               sizeof(kavailable_back_ext_min_frame_durations));
        memcpy(s_setting[cameraId].scalerInfo.stall_durations,
               kavailable_back_ext_stall_durations,
               sizeof(kavailable_back_ext_stall_durations));
        memcpy(s_setting[cameraId].scalerInfo.available_stream_configurations,
               kavailable_back_ext_stream_configurations,
               sizeof(kavailable_back_ext_stream_configurations));
    }
#endif
#ifdef CONFIG_DCAM_SENSOR3_SUPPORT
    else if (cameraId == 3) {
