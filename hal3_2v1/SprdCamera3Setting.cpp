...
const int32_t kavailable_fps_ranges_back[] = {5,  15, 5,  20, 5,  24, 5,
                                              30, 15, 15, 24, 24, 30, 30};
const int32_t kavailable_fps_ranges_front[] = {5,  15, 5,  30, 15,
                                               15, 15, 30, 30, 30};
...
const int32_t kavailable_request_keys[] = {
    ...
    ANDROID_SENSOR_SENSITIVITY, ANDROID_BLACK_LEVEL_LOCK, ANDROID_TONEMAP_MODE,
    ANDROID_COLOR_CORRECTION_GAINS, ANDROID_COLOR_CORRECTION_TRANSFORM,
    ANDROID_SHADING_MODE, ANDROID_EDGE_MODE, ANDROID_NOISE_REDUCTION_MODE};
