...
int32_t jpeg_stream_size = (2592 * HEIGHT_5M * 3 / 2 + sizeof(camera3_jpeg_blob_t));
#elif defined(CONFIG_CAMERA_SUPPORT_3M)
int32_t jpeg_stream_size = (2048 * 1536 * 3 / 2 + sizeof(camera3_jpeg_blob_t));
#else
int32_t jpeg_stream_size = (1920 * HEIGHT_2M * 3 / 2 + sizeof(camera3_jpeg_blob_t));
#endif

const int32_t kjpegThumbnailSizes[CAMERA_SETTINGS_THUMBNAILSIZE_ARRAYSIZE] = {0, 0, 256, 144, 320, 240, 432, 288};
...
// Implementation-Defined
	...
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 3264, HEIGHT_6M, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 2592, HEIGHT_5M, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	...
	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1920, HEIGHT_2M, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
//	{HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, 1600, 1200, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	...
	{HAL_PIXEL_FORMAT_YV12, 1920, HEIGHT_2M, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
...
// YUV_420_888
...
#endif
#if defined(CONFIG_CAMERA_SUPPORT_4K_RECORD)
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 3840, 2160, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
#if defined(CONFIG_CAMERA_SUPPORT_21M) || \
    defined(CONFIG_CAMERA_SUPPORT_16M) || \
    defined(CONFIG_CAMERA_SUPPORT_13M) || \
	...
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 3264, HEIGHT_6M, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 2592, HEIGHT_5M, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	...
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 1920, HEIGHT_2M, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
...
// JPEG
	...
	{HAL_PIXEL_FORMAT_BLOB, 3264, HEIGHT_6M, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
	{HAL_PIXEL_FORMAT_BLOB, 2592, HEIGHT_5M, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	...
	{HAL_PIXEL_FORMAT_BLOB, 1920, HEIGHT_2M, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
...
// YUV_420_888
	...
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 2592, HEIGHT_5M, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 2560, 1440, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 2048, 1536, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 1920, 1920, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 1920, HEIGHT_2M, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
//	{HAL_PIXEL_FORMAT_YCbCr_420_888, 1600, 1200, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
...
//SPRD
	...
	if (frame_settings.exists(ANDROID_SPRD_METERING_MODE)) {
		...
		HAL_LOGI("metering mod is %d, need update %d", s_setting[mCameraId].sprddefInfo.am_mode, UpdateAE);
	...
	if (frame_settings.exists(ANDROID_CONTROL_AF_REGIONS) && frame_settings.exists(ANDROID_SCALER_CROP_REGION)) {
		...
		if (frame_settings.find(ANDROID_CONTROL_AF_REGIONS).count == 5) {
			...
			if (err_flag == true) {
				...
				if (s_setting[mCameraId].controlInfo.af_regions[0] != af_area[0] ||
				s_setting[mCameraId].controlInfo.af_regions[1] != af_area[1] ||
				s_setting[mCameraId].controlInfo.af_regions[2] != af_area[2] ||
				s_setting[mCameraId].controlInfo.af_regions[3] != af_area[3]) {
					UpdateAF = true;
				}
				if(UpdateAF == true){
					for (i=0; i<5; i++)
