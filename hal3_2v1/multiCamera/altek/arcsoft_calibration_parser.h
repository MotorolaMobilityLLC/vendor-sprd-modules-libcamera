...
MRESULT Arc_CaliData_ParseDualCamData(MHandle hHandle, void *pDualCamData, int nBufSize, int caliType, void *pParam);
MRESULT Arc_CaliData_ParseOTPData(MHandle hHandle, void *pOTPData, int nBufSize, int otpType, void *pParam);
MRESULT Arc_CaliData_GetArcParam(MHandle hHandle, void *pArcParam, int bufSize); /// buf size in bytes
