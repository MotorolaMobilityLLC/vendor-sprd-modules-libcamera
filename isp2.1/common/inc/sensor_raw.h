...
#include "../../ae/sprd/ae/inc/ae_common.h"
...
struct sensor_pdaf_correction_level {
	cmr_u16 flat_th;
	cmr_u16 hot_pixel_th[3];
	cmr_u16 dead_pixel_th[3];
	cmr_u16 phase_map_corr_eb;
	cmr_u8 pdaf_grid;	//0:1/32, 1:1/64
	cmr_u8 gfilter_flag;
	cmr_u8 flat_smt_index;
	cmr_u8 txt_smt_index;
	cmr_u16 phase_l_gain_map[128];
	cmr_u16 phase_r_gain_map[128];
...
struct sensor_rgb_afm_level {
	cmr_u8 afm_skip_num;
	cmr_u8 touch_mode;
	cmr_u8 oflow_protect_en;
	cmr_u8 data_update_sel;
	cmr_u32 afm_mode;
