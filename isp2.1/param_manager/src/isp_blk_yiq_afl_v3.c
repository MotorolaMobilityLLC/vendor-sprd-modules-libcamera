 ...
 isp_s32 _pm_yiq_afl_init_v3(void *dst_afl_param, void *src_afl_param, void* param1, void* param_ptr2)
{
	...
	dst_ptr->cur.start_col = src_ptr->afl_x_st;
	dst_ptr->cur.end_col = src_ptr->afl_x_ed;
	dst_ptr->cur.step_x_start_region= src_ptr->afl_x_st_region;
	dst_ptr->cur.step_x_end_region= src_ptr->afl_x_ed_region;
	dst_ptr->cur.step_x_region = src_ptr->afl_step_region.x;
	dst_ptr->cur.step_y_region = src_ptr->afl_step_region.y;
