 ...
 isp_u32 _pm_uv_div_convert_param(void *dst_param, isp_u32 strength_level, isp_u32 mode_flag, isp_u32 scene_flag)
{
	...
	if (SENSOR_MULTI_MODE_FLAG != dst_ptr->nr_mode_setting) {
		...
		cce_uvdiv_param = (struct sensor_cce_uvdiv_level *)((isp_u8 *)dst_ptr->param_ptr + total_offset_units * dst_ptr->level_num * sizeof(struct sensor_cce_uvdiv_level));
	}
...
isp_s32 _pm_uv_div_set_param_v1(void *uv_div_param, isp_u32 cmd, void *param_ptr0, void *param_ptr1)
{
	...
	ISP_LOGI("ISP_SMART: cmd=%d, update=%d, cur_idx=%d", cmd, header_ptr->is_update,
					dst_ptr->cur_level);
