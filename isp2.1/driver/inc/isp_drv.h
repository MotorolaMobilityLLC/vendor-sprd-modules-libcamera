...
/*ISP Hardware Device*/
isp_s32 isp_dev_open(cmr_s32 fd, isp_handle *handle);
...
isp_s32 isp_dev_set_statis_buf(isp_handle handle, struct isp_statis_buf_input *param);
...
isp_s32 isp_u_post_blc_block(isp_handle handle, void *block_info);
isp_s32 isp_u_ynr_block(isp_handle handle, void *block_info);
isp_s32 isp_u_noise_filter_block(isp_handle handle, void *block_info);
