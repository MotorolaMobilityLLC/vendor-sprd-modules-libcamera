...
#ifndef _ISP_AF_SPRD_CTRL_H_
#define _ISP_AF_SPRD_CTRL_H_
...
struct afsprd_lib_ops {
	af_alg_handle_t (*af_init)(struct af_alg_init_param *init_param,
							struct af_alg_init_result *result);
	int32_t (*af_deinit)(af_alg_handle_t handle);
	int32_t (*af_calculation)(af_alg_handle_t handle,
							struct af_alg_calc_param *alg_calc_in,
							struct af_alg_result *alg_calc_result);
	uint32_t (*af_ioctrl)(af_alg_handle_t handle, enum af_alg_cmd cmd,
