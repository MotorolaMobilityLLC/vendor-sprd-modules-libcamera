...
**---------------------------------------------------------------------------** 
$HeadURL: http://alcs-w98/chassis/svn/_chassis_/Projects/AlStd/trunk/Result/PC/AB00_Unix/Public/Include/AlTypStd.h $ 
$LastChangedDate:: 2014-08-12 18:28:00 #$ 
$LastChangedRevision: 1843 $ 
$LastChangedBy: s-koba $ 
**-------------------------------------------------------------------------** 
...
**------------------------------------------------------------------------*//** 
Acutelogic standard type definition for Unix
...
**----------------------------------------------------------*/
#ifndef AL_PLATFORM
    #define AL_PLATFORM  (AL_PLATFORM_AB00)
#else
    #if AL_PLATFORM!=AL_PLATFORM_AB00
...
/*============================================================================**
 ...
 Other Core dependenient Macro for x86
...
/*============================================================================**
 ...
 Standard typedef for x86

**============================================================================*/
/*----------------------------------------------------------**
  integer
**----------------------------------------------------------*/
typedef cmr_s8	SI_08;        /**<8bit signed integer*/
typedef cmr_u8	UI_08;        /**<8bit unsigned integer*/
typedef cmr_s16	SI_16;        /**<16bit signed integer*/
typedef cmr_u16	UI_16;        /**<16bit unsigned integer*/
typedef cmr_s32	SI_32;        /**<32bit signed integer*/
typedef cmr_u32	UI_32;        /**<32bit unsigned integer*/
/*----------------------------------------------------------**
   fixed point
**----------------------------------------------------------*/
