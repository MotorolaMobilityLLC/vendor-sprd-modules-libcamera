...
#define JPG_GET_IOVA _IOWR(SPRD_JPG_IOCTL_MAGIC, 11, struct jpg_iommu_map)	
#define JPG_FREE_IOVA _IOW(SPRD_JPG_IOCTL_MAGIC, 12, struct jpg_iommu_map)
#define JPG_GET_IOMMU_STATUS _IO(SPRD_JPG_IOCTL_MAGIC, 13)


typedef struct jpg_iommu_map {
int fd;
size_t size;
unsigned int iova;
