 ...
 */
    ...
    // configure function processCaptureRequest
        ...
        // configure 1
        {
            ...
            2,
            {
                ...
                // stream 0
                {
                    ...
                    0,
                    {0, 1, 2, 0},
                    {PREVIEW_STREAM_HAL_BUFFER, PREVIEW_STREAM_HAL_BUFFER, PREVIEW_STREAM_HAL_BUFFER,
                     0},
                },
                ...
                // stream 1
                {
                    ...
                    0,
                    {0, 1, 2, 0},
                    {CALLBACK_STREAM_HAL_BUFFER, CALLBACK_STREAM_HAL_BUFFER, CALLBACK_STREAM_HAL_BUFFER,
                     0},
                },
        ...
        // configure 1
        {
            ...
            3,
            {
                ...
                // stream 2
                {
                    ...
                    0,
                    {0, 1, 2, 0},
                    {VIDEO_STREAM_HAL_BUFFER, VIDEO_STREAM_HAL_BUFFER, VIDEO_STREAM_HAL_BUFFER,
                    0},
                },
