...
enum isp_pm_ai_scene_type {
	...
	ISP_PM_AI_SCENE_OVERCAST,
	ISP_PM_AI_SCENE_CAR,
	ISP_PM_AI_SCENE_BICYCLE,
	ISP_PM_AI_SCENE_WATERAREA,
	ISP_PM_AI_SCENE_WATERFALL,
	ISP_PM_AI_SCENE_AUTUMNLEAF,
	ISP_PM_AI_SCENE_OTHERBUILDING,
	ISP_PM_AI_SCENE_MAX
};
...
enum ai_scene{
	...
	AI_SECNE_PRO_OVERCAST,//13
	AI_SECNE_PRO_CAR,//14
	AI_SECNE_PRO_BICYCLE,//15
	AI_SECNE_PRO_BEACH,//16
	AI_SECNE_PRO_WATERAREA,//17
	AI_SECNE_PRO_WATERFALL,//18
	AI_SECNE_PRO_AUTUMNLEAF,//19
	AI_SECNE_PRO_OTHERBUILDING,
	AI_SCENE_PRO_MAX
};
