...
enum isp_pm_blk_cmd {
	...
	ISP_PM_BLK_CNR_H_BASE = (ISP_PM_BLK_GTM_BASE + 0x100),
	ISP_PM_BLK_CNR_H_LEVEL_INFO,

	ISP_PM_BLK_POST_CNR_H_BASE = (ISP_PM_BLK_CNR_H_BASE + 0x100),
	ISP_PM_BLK_POST_CNR_H_LEVEL_INFO,

	ISP_PM_BLK_AI_SCENE_BASE= (ISP_PM_BLK_POST_CNR_H_BASE + 0x100),
