...
cmr_s32 _pm_ai_pro_init(void *dst_ai_param, void *src_ai_param, void *param1, void *param2)
{
	...
	for (i = 0;i < AI_SCENE_MAX;i++){
		...
		for (j = 0;j < 8;j++){
			...
			ISP_LOGV("ratio_old_gradient_offset[j] %d ratio_new_pyramid_offset[j] %d, ee_pos_r[j].ee_r1_cfg_offset%d,%d,%d,%d,%d,%d,%d\n",
		dst_ptr->isp_ai_ee[i].ratio_old_gradient_offset[j], dst_ptr->isp_ai_ee[i].ratio_new_pyramid_offset[j],
	...
	case ISP_PM_BLK_SMART_SETTING:
		{
			...
			if (ISP_SMART_AI_BCHS == block_result->smart_id) {
				...
				if (dst_ptr->ee_cur.ee_enable){
					...
					dst_ptr->ee_cur.ratio_old_gradient_offset = 0;
					dst_ptr->ee_cur.ratio_new_pyramid_offset = 0;
					dst_ptr->ee_cur.ee_gain_hv1.ee_r1_cfg_offset = 0;
					dst_ptr->ee_cur.ee_gain_hv1.ee_r2_cfg_offset = 0;
					dst_ptr->ee_cur.ee_gain_hv1.ee_r3_cfg_offset = 0;
					dst_ptr->ee_cur.ee_gain_hv2.ee_r1_cfg_offset = 0;
					dst_ptr->ee_cur.ee_gain_hv2.ee_r2_cfg_offset = 0;
					dst_ptr->ee_cur.ee_gain_hv2.ee_r3_cfg_offset = 0;
					dst_ptr->ee_cur.ee_gain_diag1.ee_r1_cfg_offset = 0;
					dst_ptr->ee_cur.ee_gain_diag1.ee_r2_cfg_offset = 0;
					dst_ptr->ee_cur.ee_gain_diag1.ee_r3_cfg_offset = 0;
					dst_ptr->ee_cur.ee_gain_diag2.ee_r1_cfg_offset = 0;
					dst_ptr->ee_cur.ee_gain_diag2.ee_r2_cfg_offset = 0;
					dst_ptr->ee_cur.ee_gain_diag2.ee_r3_cfg_offset = 0;
					dst_ptr->ee_cur.ee_pos_r.ee_r1_cfg_offset = 0;
					dst_ptr->ee_cur.ee_pos_r.ee_r2_cfg_offset = 0;
					dst_ptr->ee_cur.ee_pos_r.ee_r3_cfg_offset = 0;
					dst_ptr->ee_cur.ee_pos_c.ee_c1_cfg_offset = 0;
					dst_ptr->ee_cur.ee_pos_c.ee_c2_cfg_offset = 0;
					dst_ptr->ee_cur.ee_pos_c.ee_c3_cfg_offset = 0;
					dst_ptr->ee_cur.ee_neg_r.ee_r1_cfg_offset = 0;
					dst_ptr->ee_cur.ee_neg_r.ee_r2_cfg_offset = 0;
					dst_ptr->ee_cur.ee_neg_r.ee_r3_cfg_offset = 0;
					dst_ptr->ee_cur.ee_neg_c.ee_c1_cfg_offset = 0;
					dst_ptr->ee_cur.ee_neg_c.ee_c2_cfg_offset = 0;
					dst_ptr->ee_cur.ee_neg_c.ee_c3_cfg_offset = 0;
				}
				ISP_LOGV("ratio_old_gradient_offset %d , %d,%d, %d,  %d,%d ,%d,%d , ee_pos_r.ee_r1_cfg_offset %d,%d, %d,  %d,%d ,%d,ee_neg_r.ee_r1_cfg_offset%d,%d,%d\n",
					dst_ptr->ee_cur.ratio_old_gradient_offset, dst_ptr->ee_cur.ratio_new_pyramid_offset,
					dst_ptr->ee_cur.ee_gain_hv1.ee_r1_cfg_offset,dst_ptr->ee_cur.ee_gain_hv1.ee_r2_cfg_offset,
					dst_ptr->ee_cur.ee_gain_hv1.ee_r3_cfg_offset,dst_ptr->ee_cur.ee_gain_hv2.ee_r1_cfg_offset,
					dst_ptr->ee_cur.ee_gain_hv2.ee_r2_cfg_offset,dst_ptr->ee_cur.ee_gain_hv2.ee_r3_cfg_offset,
					dst_ptr->ee_cur.ee_pos_r.ee_r1_cfg_offset,dst_ptr->ee_cur.ee_pos_r.ee_r2_cfg_offset,
					dst_ptr->ee_cur.ee_pos_r.ee_r3_cfg_offset,dst_ptr->ee_cur.ee_pos_c.ee_c1_cfg_offset,
					dst_ptr->ee_cur.ee_pos_c.ee_c2_cfg_offset,dst_ptr->ee_cur.ee_pos_c.ee_c3_cfg_offset,
					dst_ptr->ee_cur.ee_neg_r.ee_r1_cfg_offset,dst_ptr->ee_cur.ee_neg_r.ee_r2_cfg_offset,
					dst_ptr->ee_cur.ee_neg_r.ee_r3_cfg_offset);
			}
