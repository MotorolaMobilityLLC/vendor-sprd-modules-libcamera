...
cmr_s32 _pm_ai_pro_init(void *dst_ai_param, void *src_ai_param, void *param1, void *param2)
{
	...
	for (i = 0;i < AI_SCENE_MAX;i++){
		...
		for (j = 0;j < 8;j++){
			...
			dst_ptr->isp_ai_bchs[i].ai_hue_v1.theta_offset[j] = src_ptr->sensor_ai_bchs[i].ai_hue.hue_theta_offset[j] ;
			...
			ISP_LOGV("ee_pos_r[j].ee_r1_cfg_offset%d,%d,%d,%d,%d,%d,%d\n",
		dst_ptr->isp_ai_ee[i].ee_pos_r[j].ee_r1_cfg_offset,dst_ptr->isp_ai_ee[i].ee_pos_r[j].ee_r1_cfg_offset,dst_ptr->isp_ai_ee[i].ee_pos_r[j].ee_r2_cfg_offset,
		dst_ptr->isp_ai_ee[i].ee_pos_r[j].ee_r3_cfg_offset,dst_ptr->isp_ai_ee[i].ee_neg_r[j].ee_r1_cfg_offset,dst_ptr->isp_ai_ee[i].ee_neg_r[j].ee_r2_cfg_offset,dst_ptr->isp_ai_ee[i].ee_neg_r[j].ee_r3_cfg_offset);
		}
		for (j = 0;j < 360;j++){
	...
	case ISP_PM_BLK_SMART_SETTING:
		{
			...
			if (ISP_SMART_AI_BCHS == block_result->smart_id) {
				...
				ISP_LOGV("ISP_SMART_AI_BCHS ai_scene_id %d", block_result->ai_scene_id);
				...
				dst_ptr->bchs_cur.ai_hue.hue_adj_ai_eb = dst_ptr->isp_ai_bchs[ai_scene].ai_hue_v1.hue_adj_ai_eb ;
				...
				ISP_LOGV("b %d",dst_ptr->bchs_cur.ai_brightness.brightness_adj_factor_offset);
				...
				if (dst_ptr->bchs_cur.ai_hue_v1.hue_adj_ai_eb){
					dst3 = &dst_ptr->bchs_cur.ai_hue_v1.theta_offset;
					src3[0]= (void *)&dst_ptr->isp_ai_bchs[ai_scene].ai_hue_v1.theta_offset[bv_value->value[0]];
					src3[1]= (void *)&dst_ptr->isp_ai_bchs[ai_scene].ai_hue_v1.theta_offset[bv_value->value[1]];
					isp_interp_data((void *)dst3, src3 , weight , data_num , ISP_INTERP_UINT16);

				}else{
					dst_ptr->bchs_cur.ai_hue_v1.theta_offset = 0;
				}
				...
				ISP_LOGV("SMART: w (%d %d) v (%d %d); weight (%d %d)\n",
				...
				ISP_LOGV("ISP_SMART_AI_EE  ai_scene_id %d", block_result->ai_scene_id);
				switch (block_result->ai_scene_id) {
				case ISP_PM_AI_SCENE_DEFAULT:
					ai_scene = AI_SECNE_PM_PRO_DEFAULT;
					break;
				...
				if (dst_ptr->hsv_cur.hue_adj_ai_eb){
					for (i = 0; i < 360; i++){
						...
						ISP_LOGV("dst_ptr->hsv_cur.hue_table_item_offset[i] %d,%d",dst_ptr->hsv_cur.hue_table_item_offset[i],dst_ptr->hsv_cur.saturation_table_item_offset[i]);
					}
				}else{
					for (i = 0; i < 360; i++){
						dst_ptr->hsv_cur.hue_table_item_offset[i] = 0;
						dst_ptr->hsv_cur.saturation_table_item_offset[i] = 0;
					}
				}

				if (dst_ptr->ee_cur.ee_enable){
					dst_ptr->ee_cur_v1.ee_gain_hv1.ee_r1_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_gain_hv1[level].ee_r1_cfg_offset;
					dst_ptr->ee_cur_v1.ee_gain_hv1.ee_r2_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_gain_hv1[level].ee_r2_cfg_offset;
					dst_ptr->ee_cur_v1.ee_gain_hv1.ee_r3_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_gain_hv1[level].ee_r3_cfg_offset;
					dst_ptr->ee_cur_v1.ee_gain_hv2.ee_r1_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_gain_hv2[level].ee_r1_cfg_offset;
					dst_ptr->ee_cur_v1.ee_gain_hv2.ee_r2_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_gain_hv2[level].ee_r2_cfg_offset;
					dst_ptr->ee_cur_v1.ee_gain_hv2.ee_r3_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_gain_hv2[level].ee_r3_cfg_offset;
					dst_ptr->ee_cur_v1.ee_gain_diag1.ee_r1_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_gain_diag1[level].ee_r1_cfg_offset;
					dst_ptr->ee_cur_v1.ee_gain_diag1.ee_r2_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_gain_diag1[level].ee_r2_cfg_offset;
					dst_ptr->ee_cur_v1.ee_gain_diag1.ee_r3_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_gain_diag1[level].ee_r3_cfg_offset;
					dst_ptr->ee_cur_v1.ee_gain_diag2.ee_r1_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_gain_diag2[level].ee_r1_cfg_offset;
					dst_ptr->ee_cur_v1.ee_gain_diag2.ee_r2_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_gain_diag2[level].ee_r2_cfg_offset;
					dst_ptr->ee_cur_v1.ee_gain_diag2.ee_r3_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_gain_diag2[level].ee_r3_cfg_offset;
					dst_ptr->ee_cur_v1.ee_pos_r.ee_r1_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_pos_r[level].ee_r1_cfg_offset;
					dst_ptr->ee_cur_v1.ee_pos_r.ee_r2_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_pos_r[level].ee_r2_cfg_offset;
					dst_ptr->ee_cur_v1.ee_pos_r.ee_r3_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_pos_r[level].ee_r3_cfg_offset;
					dst_ptr->ee_cur_v1.ee_pos_c.ee_c1_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_pos_c[level].ee_c1_cfg_offset;
					dst_ptr->ee_cur_v1.ee_pos_c.ee_c2_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_pos_c[level].ee_c2_cfg_offset;
					dst_ptr->ee_cur_v1.ee_pos_c.ee_c3_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_pos_c[level].ee_c3_cfg_offset;
					dst_ptr->ee_cur_v1.ee_neg_r.ee_r1_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_neg_r[level].ee_r1_cfg_offset;
					dst_ptr->ee_cur_v1.ee_neg_r.ee_r2_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_neg_r[level].ee_r2_cfg_offset;
					dst_ptr->ee_cur_v1.ee_neg_r.ee_r3_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_neg_r[level].ee_r3_cfg_offset;
					dst_ptr->ee_cur_v1.ee_neg_c.ee_c1_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_neg_c[level].ee_c1_cfg_offset;
					dst_ptr->ee_cur_v1.ee_neg_c.ee_c2_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_neg_c[level].ee_c2_cfg_offset;
					dst_ptr->ee_cur_v1.ee_neg_c.ee_c3_cfg_offset = dst_ptr->isp_ai_ee[ai_scene].ee_neg_c[level].ee_c3_cfg_offset;
				}else{
					dst_ptr->ee_cur_v1.ee_gain_hv1.ee_r1_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_gain_hv1.ee_r2_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_gain_hv1.ee_r3_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_gain_hv2.ee_r1_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_gain_hv2.ee_r2_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_gain_hv2.ee_r3_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_gain_diag1.ee_r1_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_gain_diag1.ee_r2_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_gain_diag1.ee_r3_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_gain_diag2.ee_r1_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_gain_diag2.ee_r2_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_gain_diag2.ee_r3_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_pos_r.ee_r1_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_pos_r.ee_r2_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_pos_r.ee_r3_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_pos_c.ee_c1_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_pos_c.ee_c2_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_pos_c.ee_c3_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_neg_r.ee_r1_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_neg_r.ee_r2_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_neg_r.ee_r3_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_neg_c.ee_c1_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_neg_c.ee_c2_cfg_offset = 0;
					dst_ptr->ee_cur_v1.ee_neg_c.ee_c3_cfg_offset = 0;
				}
				ISP_LOGV("dst_ptr->ee_cur.ee_gain_hv1.ee_r1_cfg_offset%d, %d,  %d,%d ,%d,%d , ee_pos_r.ee_r1_cfg_offset %d,%d, %d,  %d,%d ,%d,ee_neg_r.ee_r1_cfg_offset%d,%d,%d\n",
					dst_ptr->ee_cur_v1.ee_gain_hv1.ee_r1_cfg_offset,dst_ptr->ee_cur.ee_gain_hv1.ee_r2_cfg_offset,
					dst_ptr->ee_cur_v1.ee_gain_hv1.ee_r3_cfg_offset,dst_ptr->ee_cur.ee_gain_hv2.ee_r1_cfg_offset,
					dst_ptr->ee_cur_v1.ee_gain_hv2.ee_r2_cfg_offset,dst_ptr->ee_cur.ee_gain_hv2.ee_r3_cfg_offset,
					dst_ptr->ee_cur_v1.ee_pos_r.ee_r1_cfg_offset,dst_ptr->ee_cur.ee_pos_r.ee_r2_cfg_offset,
					dst_ptr->ee_cur_v1.ee_pos_r.ee_r3_cfg_offset,dst_ptr->ee_cur.ee_pos_c.ee_c1_cfg_offset,
					dst_ptr->ee_cur_v1.ee_pos_c.ee_c2_cfg_offset,dst_ptr->ee_cur.ee_pos_c.ee_c3_cfg_offset,
					dst_ptr->ee_cur_v1.ee_neg_r.ee_r1_cfg_offset,dst_ptr->ee_cur.ee_neg_r.ee_r2_cfg_offset,
					dst_ptr->ee_cur_v1.ee_neg_r.ee_r3_cfg_offset);
			}
...
cmr_s32 _pm_ai_pro_get_param(void *ai_param, cmr_u32 cmd, void *rtn_param0, void *rtn_param1)
{
	...
	case ISP_PM_BLK_AI_SCENE_EE_PARAM:
		param_data_ptr->data_ptr = &ai_ptr->ee_cur_v1;
		param_data_ptr->data_size = sizeof(ai_ptr->ee_cur_v1);
		*update_flag = ISP_ZERO;
		break;
