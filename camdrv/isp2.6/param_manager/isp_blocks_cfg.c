...
struct isp_block_cfg s_blk_cfgs[] = {
	...
	{ISP_BLK_3DNR_CAP, array_offset(struct isp_context, nr3d), sizeof(struct isp_nr3d_param), &s_3dnr_ops}, /* TBD */
...
//	{ISP_BLK_UVDIV, array_offset(struct isp_context, uvd), sizeof(struct isp_cce_uvdiv_param), &s_uvdiv_ops},
