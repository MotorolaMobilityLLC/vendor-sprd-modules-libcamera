...
struct isp_block_operations s_bpc_v0_ops = { _pm_bpc_v0_init, _pm_bpc_v0_set_param, _pm_bpc_v0_get_param, PNULL, PNULL };
...
struct isp_block_operations s_nlm_v0_ops = { _pm_nlm_v0_init, _pm_nlm_v0_set_param, _pm_nlm_v0_get_param, _pm_common_rest, _pm_nlm_v0_deinit };
...
struct isp_block_operations s_posterize_v0_ops = { _pm_posterize_v0_init, _pm_posterize_v0_set_param, _pm_posterize_v0_get_param, PNULL, PNULL };
struct isp_block_operations s_uvdiv_ops = { _pm_uv_div_init, _pm_uv_div_set_param, _pm_uv_div_get_param, PNULL, PNULL };
struct isp_block_operations s_uvdiv_v0_ops = { _pm_uv_div_v0_init, _pm_uv_div_v0_set_param, _pm_uv_div_v0_get_param, PNULL, PNULL };
...
struct isp_block_operations s_ynr_v0_ops = { _pm_ynr_v0_init, _pm_ynr_v0_set_param, _pm_ynr_v0_get_param, PNULL, PNULL };
...
struct isp_block_operations s_cnr2_v0_ops = { _pm_cnr2_v0_init, _pm_cnr2_v0_set_param, _pm_cnr2_v0_get_param, PNULL, PNULL };
...
struct isp_block_cfg s_blk_cfgs[] = {
	...
	{DCAM_BLK_BPC, array_offset(struct isp_context, bpc), sizeof(struct isp_bpc_param), &s_bpc_v0_ops},
...
#else
	{ISP_BLK_POSTERIZE, array_offset(struct isp_context, posterize), sizeof(struct isp_posterize_param), &s_posterize_v0_ops},
#endif
	...
	{DCAM_BLK_NLM, array_offset(struct isp_context, nlm), sizeof(struct isp_nlm_param), &s_nlm_v0_ops},
	{ISP_BLK_UVDIV, array_offset(struct isp_context, uvd), sizeof(struct isp_uvdiv_param), &s_uvdiv_v0_ops},
	...
	{ISP_BLK_YNR, array_offset(struct isp_context, ynr), sizeof(struct isp_ynr_param), &s_ynr_v0_ops},
	...
	{ISP_BLK_CNR2, array_offset(struct isp_context, cnr2), sizeof(struct isp_cnr2_param), &s_cnr2_v0_ops},
