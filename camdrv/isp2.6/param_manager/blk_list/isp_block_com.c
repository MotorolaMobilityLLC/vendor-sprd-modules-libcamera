...
#define ISP_NR_BOKEH_MODE_BIT (0x01 << ISP_SCENEMODE_BOKEH)
#define ISP_NR_PROFESSION_MODE_BIT (0x01 << ISP_SCENEMODE_PROFESSION)
#define ISP_NR_BEAUTYFACE_MODE_BIT (0x01 << ISP_SCENEMODE_BEAUTYFACE)
#define ISP_NR_DELAYVIDEO_MODE_BIT (0x01 << ISP_SCENEMODE_DELAYVIDEO)
#define ISP_NR_CONTINUOUSPICTURE_MODE_BIT (0x01 << ISP_SCENEMODE_CONTINUOUSPICTURE)
#define ISP_NR_FILTER_MODE_BIT (0x01 << ISP_SCENEMODE_FILTER)
#define ISP_NR_FLASH_MODE_BIT (0x01 << ISP_SCENEMODE_FLASH)
#define ISP_NR_ZOOM_MODE_BIT (0x01 << ISP_SCENEMODE_ZOOM)
#define ISP_NR_THIRDPARTY_MODE_BIT (0x01 << ISP_SCENEMODE_THIRDPARTY)
#define ISP_NR_INTERVAL_MODE_BIT (0x01 << ISP_SCENEMODE_INTERVAL)
#define ISP_NR_FACEBOOK_MODE_BIT (0x01 << ISP_SCENEMODE_FACEBOOK)
#define ISP_NR_MESSENGER_MODE_BIT (0x01 << ISP_SCENEMODE_MESSENGER)
#define ISP_NR_QQ_MODE_BIT (0x01 << ISP_SCENEMODE_QQ)
#define ISP_NR_SNAPCHAT_MODE_BIT (0x01 << ISP_SCENEMODE_SNAPCHAT)
#define ISP_NR_WHATAPPS_MODE_BIT (0x01 << ISP_SCENEMODE_WHATAPPS)
#define ISP_NR_WECHAT_MODE_BIT (0x01 << ISP_SCENEMODE_WECHAT)
...
cmr_u32 scene_mode_matrix[MAX_SCENEMODE_NUM] = {
	...
	ISP_NR_HDR_MODE_BIT,
	ISP_NR_BOKEH_MODE_BIT,
	ISP_NR_PROFESSION_MODE_BIT,
	ISP_NR_BEAUTYFACE_MODE_BIT,
	ISP_NR_DELAYVIDEO_MODE_BIT,
	ISP_NR_CONTINUOUSPICTURE_MODE_BIT,
	ISP_NR_FILTER_MODE_BIT,
	ISP_NR_FLASH_MODE_BIT,
	ISP_NR_ZOOM_MODE_BIT,
	ISP_NR_THIRDPARTY_MODE_BIT,
	ISP_NR_INTERVAL_MODE_BIT,
	ISP_NR_FACEBOOK_MODE_BIT,
	ISP_NR_MESSENGER_MODE_BIT,
	ISP_NR_QQ_MODE_BIT,
	ISP_NR_SNAPCHAT_MODE_BIT,
	ISP_NR_WHATAPPS_MODE_BIT,
	ISP_NR_WECHAT_MODE_BIT,
};
