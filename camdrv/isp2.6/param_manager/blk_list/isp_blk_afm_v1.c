	...
	cmr_u32 strength_level, cmr_u32 mode_flag, cmr_u32 scene_flag)
{
	...
	if (rgb_afm_param != NULL) {
		...
		dst_ptr->cur.afm_enhanced_lum.afm_gamma_en = rgb_afm_param[strength_level].afm_enhanced.afm_enhanced_lum.gamma_en;
		dst_ptr->cur.afm_enhanced_lum.afm_hist_en = rgb_afm_param[strength_level].afm_enhanced.afm_enhanced_lum.hist_en;
		dst_ptr->cur.afm_enhanced_lum.afm_scale_en = rgb_afm_param[strength_level].afm_enhanced.afm_enhanced_lum.scale_en;
		dst_ptr->cur.afm_enhanced_lum.afm_scale_hx = rgb_afm_param[strength_level].afm_enhanced.afm_enhanced_lum.scale_hx;
		dst_ptr->cur.afm_enhanced_lum.afm_scale_vx = rgb_afm_param[strength_level].afm_enhanced.afm_enhanced_lum.scale_vx;
		dst_ptr->cur.afm_enhanced_lum.afm_max_lum_th = rgb_afm_param[strength_level].afm_enhanced.afm_enhanced_lum.max_lum_th;
		dst_ptr->cur.afm_enhanced_lum.afm_max_lum_num_th = rgb_afm_param[strength_level].afm_enhanced.afm_enhanced_lum.max_lum_num_th;

		for(j = 0; j< RGB_AFM_GAMMA_POINT_NUM; j++) {
			dst_ptr->cur.afm_enhanced_lum.afm_gamma_curve[j]= rgb_afm_param[strength_level].afm_enhanced.afm_enhanced_lum.gamma_curve[j];
		}
	}
	return rtn;
}
