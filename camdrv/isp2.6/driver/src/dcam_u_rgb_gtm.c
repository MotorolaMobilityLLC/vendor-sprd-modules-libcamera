...
#define LOG_TAG "dcam_u_rgb_gtm"

#include "isp_drv.h"

cmr_s32 dcam_u_rgb_gtm_block(void *handle, void *block_info)
{
	cmr_s32 ret = 0;
	...
	param.sub_block = DCAM_BLOCK_RGB_GTM;
	param.property = DCAM_PRO_RGB_GTM_BLOCK;
