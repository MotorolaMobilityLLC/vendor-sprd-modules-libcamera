...
#define LOG_TAG "dcam_u_rgb_gain"
...
cmr_s32 dcam_u_rgb_gain_block(cmr_handle handle, void *block_info)
{
	...
	param.sub_block = DCAM_BLOCK_RGBG;
	param.property = DCAM_PRO_GAIN_BLOCK;
...
cmr_s32 dcam_u_rgb_dither_block(cmr_handle handle, void *block_info)
{
	...
	file = (struct isp_file *)(handle);
	param.scene_id = block_param->scene_id;
	param.sub_block = DCAM_BLOCK_RGBG_DITHER;
	param.property = DCAM_PRO_GAIN_DITHER_BLOCK;
	param.property_param = block_param->block_info;
