 ...
 */
#define LOG_TAG "isp_blk_3dnr_cap"
...
cmr_s32 _pm_3d_nr_cap_init(void *dst_3d_nr_param, void *src_3d_nr_param, void *param1, void *param_ptr2)
{
	cmr_s32 rtn = ISP_SUCCESS;
...
cmr_s32 _pm_3d_nr_cap_set_param(void *nr_3d_param, cmr_u32 cmd, void *param_ptr0, void *param_ptr1)
{
	cmr_s32 rtn = ISP_SUCCESS;
...
cmr_s32 _pm_3d_nr_cap_get_param(void *nr_3d_param, cmr_u32 cmd, void *rtn_param0, void *rtn_param1)
{
	cmr_s32 rtn = ISP_SUCCESS;
	...
	param_data_ptr->id = DCAM_BLK_3DNR_CAP;
