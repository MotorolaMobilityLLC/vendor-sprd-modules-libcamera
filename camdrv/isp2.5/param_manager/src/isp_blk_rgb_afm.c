...
cmr_u32 _pm_rgb_afm_convert_param(void *dst_param, cmr_u32 strength_level, cmr_u32 mode_flag, cmr_u32 scene_flag)
{
	...
	if (rgb_afm_param != NULL) {
		...
		dst_ptr->cur.win.x = rgb_afm_param[strength_level].win_range[0].start_x;
		dst_ptr->cur.win.y = rgb_afm_param[strength_level].win_range[0].start_y;
		dst_ptr->cur.win.w = rgb_afm_param[strength_level].win_range[0].end_x - rgb_afm_param[strength_level].win_range[0].start_x;
		dst_ptr->cur.win.h = rgb_afm_param[strength_level].win_range[0].end_y - rgb_afm_param[strength_level].win_range[0].start_y;*/
		for (i=0; i<10; i++)
