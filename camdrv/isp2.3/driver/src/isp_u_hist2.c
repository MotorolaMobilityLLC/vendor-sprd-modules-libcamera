...
cmr_s32 isp_u_hist2_block(void *handle, void *param_ptr)
{
	...
	param.property_param = hist2_ptr->block_info;
...
cmr_s32 isp_u_hist2_mode(cmr_handle handle, void *param_ptr)
{
	...
	param.scene_id = hist2_ptr->scene_id;
	param.sub_block = ISP_BLOCK_HIST2;
	param.property = ISP_PRO_HIST2_MODE;
	param.property_param = &hist2_ptr->mode;
...
cmr_s32 isp_u_hist2_roi(cmr_handle handle, void *param_ptr)
{
	...
	param.scene_id = hist2_ptr->scene_id;
        param.sub_block = ISP_BLOCK_HIST2;
        param.property = ISP_PRO_HIST2_ROI;
        param.property_param = hist2_ptr->hist2_roi;
