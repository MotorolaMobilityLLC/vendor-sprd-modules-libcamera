...
cmr_s32 _pm_dcam_lsc_otp_active(struct sensor_2d_lsc_param * lsc_ptr, struct isp_cali_lsc_info * cali_lsc_ptr)
{
	cmr_s32 rtn = ISP_SUCCESS;
	...
	case ISP_PM_BLK_LSC_OTP:
		{
			...
			rtn = _pm_dcam_lsc_otp_active(lsc_ptr, cali_lsc_ptr);
