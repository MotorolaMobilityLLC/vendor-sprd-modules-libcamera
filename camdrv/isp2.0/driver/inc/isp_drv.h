...
isp_s32 isp_dev_mem_free(isp_handle handle);
...
isp_s32 isp_u_2d_lsc_transaddr(isp_handle handle,isp_s32 fd);;
...
isp_s32 isp_u_anti_flicker_transaddr(isp_handle handle, isp_u32 fd);
...
isp_s32 isp_set_store_proc_param_v1(isp_handle isp_handler);
isp_s32 isp_set_store_next_param_v1(isp_handle isp_handler);
