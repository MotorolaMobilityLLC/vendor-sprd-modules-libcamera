...
enum {
	ISP_BLK_PRE_WAVELET_TYPE = 0x00,
	ISP_BLK_BPC_TYPE,
	ISP_BLK_BL_NR_TYPE,
	ISP_BLK_GRGB_TYPE,
	ISP_BLK_NLM_TYPE,
	ISP_BLK_NLM_VST_TYPE,
	ISP_BLK_NLM_IVST_TYPE,
	ISP_BLK_NLM_FLAT_OFFSET_TYPE,
	ISP_BLK_CFA_TYPE,
	ISP_BLK_RGB_PRECDN_TYPE,
	ISP_BLK_YUV_PRECDN_TYPE,
	ISP_BLK_PREF_TYPE,
	ISP_BLK_UV_CDN_TYPE,
	ISP_BLK_EDGE_TYPE,
	ISP_BLK_UV_POSTCDN_TYPE,
	ISP_BLK_IIRCNR_IIR_TYPE,
	ISP_BLK_IIRCNR_YRANDOM_TYPE,
	ISP_BLK_UVDIV_TYPE,
	ISP_BLK_YIQ_AFM_TYPE,
	ISP_BLK_TYPE_MAX
};
...
struct sensor_raw_ioctrl {
	...
	isp_int (*read_i2c_seq)(uint16_t slave_addr, uint8_t *cmd, uint16_t wr_cnt, uint16_t rd_cnt);
