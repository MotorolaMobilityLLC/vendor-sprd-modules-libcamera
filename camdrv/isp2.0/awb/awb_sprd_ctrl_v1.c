...
static uint32_t s_awb_init_cur_ct = 0;
static struct awb_ctrl_gain init_awb_cur_gain;
...
awb_ctrl_handle_t awb_sprd_ctrl_v1_init(struct awb_ctrl_init_param * param, struct awb_ctrl_init_result * result)
{
	...
	cxt->cur_ct = result->ct;
       ...
       if (s_awb_init_cur_ct ==  0) {
		...
		cxt->output_gain.r = init_awb_cur_gain.r;
		cxt->output_gain.g = init_awb_cur_gain.g;
		cxt->output_gain.b = init_awb_cur_gain.b;
...
uint32_t awb_sprd_ctrl_v1_calculation(awb_ctrl_handle_t handle, struct awb_ctrl_calc_param * param, struct awb_ctrl_calc_result * result)
{
	...
	s_awb_init_cur_ct = result->ct;
       init_awb_cur_gain.r = result->gain.r;
       init_awb_cur_gain.g = result->gain.g;
       init_awb_cur_gain.b = result->gain.b;
