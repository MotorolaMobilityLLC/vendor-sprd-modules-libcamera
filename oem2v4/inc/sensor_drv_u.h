...
// LOCAL cmr_int sensor_otp_module_deinit(struct sensor_drv_context *
// sensor_cxt);
...
// unsigned long param);
// unsigned long sensor_ic_write_ae_value(cmr_handle sns_module_handle, unsigned
// long param);
// unsigned long sensor_ic_read_aec_info(cmr_handle sns_module_handle, unsigned
// long param);
// unsigned long sensor_ic_read_aec_info(cmr_handle sns_module_handle, unsigned
// long param);
