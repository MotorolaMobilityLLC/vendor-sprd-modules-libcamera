...
uint32_t write_file_bin_u8(const char *file, void *data_buf,
                           uint32_t data_size) {
    FILE *fp = NULL;
    uint32_t write_bytes = 0;
...
uint32_t read_file_txt_s32(const char *file, void *data_buf,
                           uint32_t buf_size) {
    FILE *fp = NULL;
    int file_len = 0;
...
uint32_t write_file_txt_s32(const char *file, void *data_buf,
                            uint32_t data_size) {
    FILE *fp = NULL;
    uint32_t write_bytes = 0;
    uint32_t i = 0;
