...
static cmr_int ioctrl_set_flash_calibration(cmr_handle handle, void *param){
...
static oem_ops_t oem_module_ops = {
	...
	.camera_request_snapshot = camera_request_snapshot,
	...
	.camera_get_sensor_trim2 = camera_get_sensor_trim2,
