...
#define 	ENB1_IGNORE_ZERO_STEP_FIRST		0x20
#define 	ENB1_FINE_SCAN					0x10
...
//#define 	STATE_CAF_ 					 	0x40
#define 	STATE_CAF_WAIT_LOCK 			0x20
#define 	STATE_CAF_SCAN_FINISH			0x10
...
//#define 	STATUS1_CAF_ 				  	0x08
//#define 	STATUS1_CAF_					0x04
...
typedef struct AFDATA{
	...
	WORD	wDyFailRatioCAF[3][2][2];				// Out/Ind/Dak Fine/First Filter1/Filter2
...
//	BYTE	bSoftLand_Dly2;				//
	...
	// CAF
	WORD	wCAFDnTh[2][3];			// F1/F2, 
	WORD	wCAFUpTh[2][3];			// F1/F2, 
	WORD	wCAFNoCntFvRatio[3][2][2];
	WORD	wCAFStableTh[3][2][2];	// Out/Ind/Dak, F1/F2, Lock  	0.01%  
									// Out/Ind/Dak, F1/F2, Unlock	0.01%
	WORD	wCAFStableLum[3][2];	// Out/Ind/Dak, F1/F2
                                    // Out/Ind/Dak, F1/F2
	BYTE	bCAFLumTh[2][3][2];		// Normal/FD Out/Ind/Dak Lock
									// Normal/FD Out/Ind/Dak Unlock
	...
	BYTE	bCAFDivPos;				// Out/Ind/Dak		Min / Pos0 / Pos1 / Pos2 / Max
	...
	BYTE	bRecordMoveValue[5];
	BYTE	bRecordMoveValueTouch[5];
