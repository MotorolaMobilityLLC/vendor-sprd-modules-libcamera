...
#define PTR_IS_VALID(param) (((param) != NULL) && ((((long)param)&0xffffffff) != 0))
...
static isp_s32 _pm_pre_wavelet_init_v1(void *dst_pwd, void *src_pwd, void* param1, void* param2)
{
	...
	dst_ptr->cur.lum_shink_level = src_ptr->strength_level;
	dst_ptr->cur_level = src_ptr->strength_level;
	...
	rtn = _pm_pwd_convert_param(dst_ptr, src_ptr->strength_level);
	if (ISP_SUCCESS != rtn) {
...
static isp_s32 _pm_pre_wavelet_set_param_v1(void *pwd_param, isp_u32 cmd, void* param_ptr0, void* param_ptr1)
{
	...
	case ISP_PM_BLK_SMART_SETTING:
	{
		...
		if (cur_level != pwd_param_ptr->cur_level) {
...
static isp_s32 _pm_2d_lsc_init(void * dst_lnc_param,void * src_lnc_param,void * param1,void * param2)
{
	...
	if (PTR_IS_VALID(dst_lnc_ptr->final_lsc_param.data_ptr)\
...
static isp_s32 _pm_2d_lsc_otp_active(struct sensor_2d_lsc_param *lsc_ptr, struct isp_cali_lsc_info *cali_lsc_ptr)
{
	...
	if (!PTR_IS_VALID( lsc_ptr) || !PTR_IS_VALID(cali_lsc_ptr)) {
...
static isp_s32 _pm_bpc_init_v1(void *dst_bpc_param, void *src_bpc_param, void* param1, void* param2)
{
	...
	dst_ptr->cur.bypass =  header_ptr->bypass;
	dst_ptr->cur.level = src_ptr->strength_level;
	dst_ptr->cur_level = src_ptr->strength_level;
	...
	rtn=_pm_bpc_convert_param(dst_ptr, src_ptr->strength_level);
	if (ISP_SUCCESS != rtn) {
...
static isp_s32 _pm_bpc_set_param_v1(void *bpc_param, isp_u32 cmd, void* param_ptr0, void* param_ptr1)
{
	...
	case ISP_PM_BLK_SMART_SETTING:
	{
		...
		if (cur_level != bpc_ptr->cur_level) {
...
static isp_s32 _pm_bl_nr_init_v1(void *dst_bdn_param, void *src_bdn_param, void* param1, void* param2)
{
	...
	memset((void*)&dst_ptr->cur,0x00,sizeof(dst_ptr->cur));
	dst_ptr->cur.bypass =  header_ptr->bypass;
	dst_ptr->cur.ran_level = src_ptr->strength_level;
	dst_ptr->cur.dis_level = src_ptr->strength_level;
	...
	rtn=_pm_bl_nr_convert_param(dst_ptr, src_ptr->strength_level);
	if (ISP_SUCCESS != rtn) {
...
static isp_s32 _pm_bl_nr_set_param_v1(void *bdn_param, isp_u32 cmd, void* param_ptr0, void* param_ptr1)
{
	...
	case ISP_PM_BLK_SMART_SETTING:
	{
		...
		if (cur_level[0] != bdn_ptr->cur.ran_level || cur_level[1] != bdn_ptr->cur.dis_level) {
...
static isp_s32 _pm_grgb_init_v1(void *dst_grgb_param, void *src_grgb_param, void* param1, void* param2)
{
	...
	rtn = _pm_grgb_convert_param(dst_ptr,src_ptr->strength_level);
...
static isp_s32 _pm_grgb_set_param_v1(void *grgb_param, isp_u32 cmd, void* param_ptr0, void* param_ptr1)
{
	...
	case ISP_PM_BLK_SMART_SETTING:
	{
		...
		cur_level = (isp_u32)block_result->component[0].fix_data[0];
		if(cur_level != dst_ptr->cur_level){
...
static isp_u32 _pm_nlm_convert_param(void *dst_nlm_param, isp_u32 strength_level)
{
	...
	if (PTR_IS_VALID(nlm_param)) {
		...
		if (PTR_IS_VALID(flat_offset_level)) {
...
static isp_s32 _pm_nlm_init(void *dst_nlm_param, void *src_nlm_param, void* param1, void* param_ptr2)
{
	...
	if (!PTR_IS_VALID(dst_nlm_ptr->vst_map.data_ptr)) {
	...
	if (!PTR_IS_VALID(dst_nlm_ptr->ivst_map.data_ptr)) {
	...
	if (!PTR_IS_VALID(dst_nlm_ptr->nlm_map.data_ptr)) {
	...
	dst_nlm_ptr->cur.strength_level = src_nlm_ptr->strength_level;
	dst_nlm_ptr->nlm_level = src_nlm_ptr->strength_level;
	...
	rtn = _pm_nlm_convert_param(dst_nlm_ptr,src_nlm_ptr->strength_level);
	if (ISP_SUCCESS != rtn) {
...
static isp_s32 _pm_nlm_set_param(void *nlm_param, isp_u32 cmd, void *param_ptr0, void *param_ptr1)
{
	...
	case ISP_PM_BLK_SMART_SETTING:
	{
		...
		if (nlm_level != nlm_ptr->nlm_level) {
...
static isp_s32 _pm_nlm_deinit(void* nlm_param)
{
	...
	if (PTR_IS_VALID(nlm_ptr->vst_map.data_ptr)) {
		free(nlm_ptr->vst_map.data_ptr);
		nlm_ptr->vst_map.data_ptr = PNULL;
		nlm_ptr->vst_map.size = 0;
	}

	if (PTR_IS_VALID(nlm_ptr->ivst_map.data_ptr)) {
...
static isp_s32 _pm_cfa_init_v1(void *dst_cfae_param, void *src_cfae_param, void* param1, void* param_ptr2)
{
	...
	dst_cfae_ptr->cur_level = src_cfae_ptr->strength_level;
	...
	rtn = _pm_cfa_convert_param(dst_cfae_ptr,src_cfae_ptr->strength_level);
	if (ISP_SUCCESS != rtn) {
...
static isp_s32 _pm_cfa_set_param_v1(void *cfae_param, isp_u32 cmd, void *param_ptr0, void *param_ptr1)
{
	...
	case ISP_PM_BLK_SMART_SETTING:
	{
		...
		if (cur_level != cfae_ptr->cur_level) {
...
static isp_s32 _pm_frgb_gamc_init(void *dst_gamc_param, void *src_gamc_param, void* param1, void* param_ptr2)
{
	...
	for (j = 0; j < ISP_PINGPANG_FRGB_GAMC_NUM; j++) {
		if (j < ISP_PINGPANG_FRGB_GAMC_NUM - 1) {
...
static isp_s32 _pm_frgb_gamc_set_param(void *gamc_param, isp_u32 cmd, void *param_ptr0, void *param_ptr1)
{
	...
	case ISP_PM_BLK_GAMMA:
	{
		...
		for (i = 0; i < ISP_PINGPANG_FRGB_GAMC_NUM; i++) {
			if (i < ISP_PINGPANG_FRGB_GAMC_NUM - 1) {
				gamc_ptr->cur.nodes[i].node_x = (gamc_ptr->curve_tab[gamma_idx].points[i*2].x + gamc_ptr->curve_tab[gamma_idx].points[i*2+1].x) >> 1;
				gamc_ptr->cur.nodes[i].node_y = (gamc_ptr->curve_tab[gamma_idx].points[i*2].y + gamc_ptr->curve_tab[gamma_idx].points[i*2+1].y) >> 1;
			} else {
				gamc_ptr->cur.nodes[i].node_x = gamc_ptr->curve_tab[gamma_idx].points[i*2 -1].x;
				gamc_ptr->cur.nodes[i].node_y = gamc_ptr->curve_tab[gamma_idx].points[i*2 -1].y;
			}
		}
	}
	...
	case ISP_PM_BLK_SMART_SETTING:
	{
		...
		if (gamc_value.value[0] != gamc_ptr->cur_idx.x0
			...
			if (ISP_SUCCESS == rtn) {
				...
				for (i = 0; i < ISP_PINGPANG_FRGB_GAMC_NUM; i++) {
					if (i < ISP_PINGPANG_FRGB_GAMC_NUM - 1) {
						gamc_ptr->cur.nodes[i].node_x = (gamc_ptr->final_curve.points[i*2].x + gamc_ptr->final_curve.points[i*2+1].x) >> 1;
						gamc_ptr->cur.nodes[i].node_y = (gamc_ptr->final_curve.points[i*2].y + gamc_ptr->final_curve.points[i*2+1].y) >> 1;
					} else {
						gamc_ptr->cur.nodes[i].node_x = gamc_ptr->final_curve.points[i*2 -1].x;
						gamc_ptr->cur.nodes[i].node_y = gamc_ptr->final_curve.points[i*2 -1].y;
					}
				}
			}
		}
...
static isp_s32 _pm_ctm_init(void *dst_ctm_param, void *src_ctm_param, void* param1, void* param_ptr2)
{
	...
	if ((PTR_IS_VALID( dst_ctm_ptr->final_map.data_ptr))\
...
static isp_s32 _pm_ctm_deinit(void* ctm_param)
{
	...
	if (PTR_IS_VALID( ctm_ptr->final_map.data_ptr)) {
...
static isp_s32 _pm_hsv_init(void *dst_hsv_param, void *src_hsv_param, void* param1, void* param2)
{
	...
	if (!PTR_IS_VALID( dst_hsv_ptr->final_map.data_ptr)) {
...
static isp_s32 _pm_hsv_deinit(void* hsv_param)
{
	...
	if (PTR_IS_VALID( hsv_ptr->final_map.data_ptr)) {
...
static isp_s32 _pm_rgb_pre_cdn_init_v1(void *dst_pre_cdn_param, void *src_pre_cdn_param, void* param1, void* param2)
{
	...
	rtn=_pm_rgb_precdn_convert_param(dst_ptr, src_ptr->strength_level);
	if (ISP_SUCCESS != rtn) {
...
static isp_s32 _pm_rgb_pre_cdn_set_param_v1(void *pre_cdn_param, isp_u32 cmd, void* param_ptr0, void* param_ptr1)
{
	...
	case ISP_PM_BLK_SMART_SETTING:
	{
		...
		if (cur_level != dst_pre_cdn_ptr->cur_level) {
...
static isp_s32 _pm_yiq_afm_init(void *dst_yiq_afm_param, void *src_yiq_afm_param, void *param1, void *param2)
{
	...
	dst_yiq_afm_ptr->cur_level = src_yiq_afm_ptr->strength_level;
	...
	for (i = 0; i < 11; i++) {
       ...
       rtn =  _pm_yiq_afm_convert_param(dst_yiq_afm_ptr,src_yiq_afm_ptr->strength_level);
...
static isp_s32 _pm_yiq_afm_set_param(void *yiq_afm_param, isp_u32 cmd, void *param_ptr0, void *param_ptr1)
{
	...
	case ISP_PM_BLK_SMART_SETTING:
	{
		...
		if (cur_level != yiq_afm_ptr->cur_level) {
...
static isp_u32 _pm_yuv_precdn_convert_param(void *dst_precdn_param, isp_u32 strength_level)
{
	...
	strength_level = PM_CLIP(strength_level, 0, SENSOR_SMART_LEVEL_NUM - 1);
	if (PTR_IS_VALID(yuv_precdn_param)) {
...
static isp_s32 _pm_yuv_precdn_init(void *dst_precdn_param, void *src_precdn_param, void *param1, void *param2)
{
	...
	dst_precdn_ptr->cur.level = src_precdn_ptr->strength_level;
	dst_precdn_ptr->cur_level = src_precdn_ptr->strength_level;

	dst_precdn_ptr->yuv_precdn_ptr = src_precdn_ptr->param_ptr;
	rtn = _pm_yuv_precdn_convert_param(dst_precdn_ptr,src_precdn_ptr->strength_level);
	if (ISP_SUCCESS != rtn) {
...
static isp_s32 _pm_yuv_precdn_set_param(void *precdn_param, isp_u32 cmd, void *param_ptr0, void *param_ptr1)
{
	...
	case ISP_PM_BLK_SMART_SETTING:
	{
		...
		if (cur_level != precdn_ptr->cur_level) {
...
static isp_s32 _pm_prfy_init(void *dst_prfy_param, void *src_prfy_param, void *param1, void *param2)
{
	...
	dst_prfy_ptr->cur_level = src_prfy_ptr->strength_level;
	dst_prfy_ptr->prfy_ptr = src_prfy_ptr->param_ptr;

	rtn = _pm_prfy_convert_param(dst_prfy_ptr,src_prfy_ptr->strength_level);
	if (ISP_SUCCESS != rtn) {
...
static isp_s32 _pm_prfy_set_param(void *prfy_param, isp_u32 cmd, void *param_ptr0, void *param_ptr1)
{
	...
	case ISP_PM_BLK_SMART_SETTING:
	{
		...
		if (cur_level != prfy_ptr->cur_level) {
...
static isp_s32 _pm_uv_cdn_init_v1(void *dst_cdn_param, void *src_cdn_param, void *param1, void *param2)
{
	...
	dst_cdn_ptr->cur.level = src_cdn_ptr->strength_level;
	...
	rtn = _pm_uv_cdn_convert_param(dst_cdn_ptr,src_cdn_ptr->strength_level);
	if (ISP_SUCCESS != rtn) {
...
static isp_s32 _pm_uv_cdn_set_param_v1(void *cdn_param, isp_u32 cmd, void *param_ptr0, void *param_ptr1)
{
	...
	case ISP_PM_BLK_SMART_SETTING:
	{
		...
		if (cur_level != cdn_ptr->cur_level) {
...
static isp_s32 _pm_saturation_set_param_v1(void *csa_param, isp_u32 cmd, void *param_ptr0, void *param_ptr1)
{
	...
	case ISP_PM_BLK_SMART_SETTING:
	{
		...
		cur_level = (isp_u32)block_result->component[0].fix_data[0];
		csa_ptr->cur.factor_u = cur_level;
		csa_ptr->cur.factor_v = cur_level;
	}
	break;
...
static isp_s32 _pm_uv_postcdn_init(void *dst_postcdn_param, void *src_postcdn_param, void *param1, void *param_ptr2)
{
	...
	dst_postcdn_ptr->cur.level = src_postcdn_ptr->strength_level;
	dst_postcdn_ptr->cur_level = src_postcdn_ptr->strength_level;
	...
	rtn = _pm_uv_postcdn_convert_param(dst_postcdn_ptr,src_postcdn_ptr->strength_level);
	if (ISP_SUCCESS != rtn) {
...
static isp_s32 _pm_uv_postcdn_set_param(void *postcdn_param, isp_u32 cmd, void *param_ptr0, void *param_ptr1)
{
	...
	case ISP_PM_BLK_SMART_SETTING:
	{
		...
		if (cur_level != postcdn_ptr->cur_level) {
...
static isp_s32 _pm_edge_init_v1(void *dst_edge_param, void *src_edge_param, void *param1, void *param2)
{
	...
	dst_edge_ptr->cur.ee_level = src_edge_ptr->strength_level + src_edge_ptr->tab[src_edge_ptr->cur_idx];
	...
	rtn = _pm_edge_convert_param(dst_edge_ptr,dst_edge_ptr->cur.ee_level);
	if (ISP_SUCCESS != rtn) {
...
static isp_s32 _pm_edge_set_param_v1(void *edge_param, isp_u32 cmd, void *param_ptr0, void *param_ptr1)
{
	...
	case ISP_PM_BLK_SMART_SETTING:
	{
		...
		if (level != edge_ptr->level) {
			edge_ptr->cur.ee_level = level + edge_ptr->tab[edge_ptr->cur_idx];
...
static isp_s32 _pm_iircnr_iir_init(void *dst_iircnr_param, void *src_iircnr_param, void *param1, void *param_ptr2)
{
	...
	dst_iircnr_ptr->cur.iirnr_level = src_iir_nr_ptr->strength_level;
	dst_iircnr_ptr->cur_level = src_iir_nr_ptr->strength_level;
	...
	dst_iircnr_ptr->cur.factor = src_iir_nr_ptr->iircnr_level.iircnr_middle_factor;
        ...
        rtn=_pm_iircnr_iir_convert_param(dst_iircnr_ptr, src_iir_nr_ptr->strength_level);
	 if (ISP_SUCCESS != rtn) {
...
static isp_s32 _pm_iircnr_iir_set_param(void *iircnr_param, isp_u32 cmd, void *param_ptr0, void *param_ptr1)
{
	...
	case ISP_PM_BLK_SMART_SETTING:
	{
		...
		if (cur_level != iircnr_ptr->cur_level) {
...
static isp_u32 _pm_iir_yrandom_convert_param(void *dst_iir_yrandom_param, isp_u32 strength_level)
{
	...
	strength_level = PM_CLIP(strength_level, 0, SENSOR_SMART_LEVEL_NUM - 1);
	if (PTR_IS_VALID(iir_yrandom_param)) {
...
static isp_s32 _pm_iircnr_yrandom_init(void *dst_iircnr_param, void *src_iircnr_param, void *param1, void *param_ptr2)
{
	...
	dst_iir_yrandom_ptr->cur_level = src_iir_yrandom_ptr->strength_level;
	...
	rtn = _pm_iir_yrandom_convert_param(dst_iir_yrandom_ptr,src_iir_yrandom_ptr->strength_level);
...
static isp_u32 _pm_uv_div_convert_param(void *dst_param, isp_u32 strength_level)
{
	...
	strength_level = PM_CLIP(strength_level, 0, SENSOR_SMART_LEVEL_NUM - 1);
	if (PTR_IS_VALID(cce_uvdiv_param)) {
...
static isp_s32 _pm_uv_div_init_v1(void *dst_uv_div_param, void *src_uv_div_param, void *param1, void *param_ptr2)
{
...
#ifdef CONFIG_USE_ALC_AWB
	uvdiv_header_ptr->bypass = 1;
#endif

	dst_uvdiv_ptr->cur.uvdiv_bypass = uvdiv_header_ptr->bypass;
	dst_uvdiv_ptr->cur.level = src_uvdiv_ptr->strength_level;
	dst_uvdiv_ptr->cur_level = src_uvdiv_ptr->strength_level;
	...
	rtn =_pm_uv_div_convert_param(dst_uvdiv_ptr, src_uvdiv_ptr->strength_level);
	 if (ISP_SUCCESS != rtn) {
...
static isp_s32 _pm_uv_div_set_param_v1(void *uv_div_param, isp_u32 cmd, void *param_ptr0, void *param_ptr1)
{
	...
	case ISP_PM_BLK_SMART_SETTING:
	{
		...
		if (cur_idx != uvdiv_ptr->cur_level) {
