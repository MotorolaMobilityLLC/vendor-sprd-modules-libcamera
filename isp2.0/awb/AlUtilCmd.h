...
**---------------------------------------------------------------------------**
$HeadURL: http://localhost:50120/chassis/svn/_chassis_/Projects/AlUtil/branches/DV/forAndroid/Src/Public/Core/Include/AlUtilCmd.h $
$LastChangedDate:: 2014-06-18 09:27:45 #$
$LastChangedRevision: 1840 $
$LastChangedBy: seino $
**------------------------------------------------------------------------*//**
コマンド定義ヘッダ
